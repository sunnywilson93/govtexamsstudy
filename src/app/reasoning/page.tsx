...
export default function ReasoningPage() {
  return (
    <SubjectHubPage
      ...
      subjectColor="#8b5cf6"
      description="Master reasoning and logic with interactive animated visualizers and concept sheets. Each topic covers exam shortcuts and step-by-step animated practice problems."
      sections={SECTIONS}
    />
  )
}
