...
export default function EconomicsPage() {
  return (
    <SubjectHubPage
      ...
      subjectColor="#14b8a6"
      description="Complete Indian Economy study material covering Banking, Fiscal Policy, Trade, Planning, and Government Schemes with notes, revision tricks, and practice questions."
      sections={SECTIONS}
