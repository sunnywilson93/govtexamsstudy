...
const TOPIC_DATA: Record<string, TopicData> = {
  ...
  'vedic-period': {
    ...
    label: 'Vedic Period',
    description: 'Vedic Period for UPSC, SSC & banking exams. Early and Later Vedic society, polity, literature with notes, revision, and practice questions.',
  },
  'buddhism-jainism': {
    ...
    description: 'Buddhism and Jainism for government exams. Founders, teachings, councils, sects with notes, revision, and practice questions.',
  },
  mahajanapadas: {
    ...
    description: 'Mahajanapadas for UPSC & SSC. 16 kingdoms, Haryanka to Nanda dynasties with notes, revision, and practice questions.',
  },
  'maurya-empire': {
    ...
    description: 'Maurya Empire for government exams. Chandragupta, Arthashastra, Ashoka edicts, Dhamma with notes, revision, and practice questions.',
  },
  'post-maurya': {
    ...
    description: 'Post-Maurya Period for UPSC & SSC. Sungas, Kanvas, Satavahanas, Indo-Greeks, Kushanas with notes, revision, and practice questions.',
  },
  'sangam-age': {
    ...
    label: 'Sangam Age',
    description: 'Sangam Age for government exams. Tamil kingdoms, Sangam literature, Roman trade with notes, revision, and practice questions.',
  },
  'gupta-empire': {
    ...
    description: 'Gupta Empire for UPSC & SSC. Science, literature, art, Nalanda with notes, revision, and practice questions.',
  },
  'south-indian-dynasties': {
    ...
    description: 'South Indian Dynasties for government exams. Chalukyas, Pallavas, Rashtrakutas, Cholas with notes, revision, and practice questions.',
  },
  'prehistoric-india': {
    ...
    description: 'Prehistoric India for UPSC & SSC. Palaeolithic, Mesolithic, Neolithic, Chalcolithic ages with notes, revision, and practice questions.',
  },
  'philosophical-schools': {
    ...
    description: 'Six Schools of Indian Philosophy for government exams. Nyaya, Vaisheshika, Samkhya, Yoga, Mimamsa, Vedanta with notes, revision, and practice questions.',
  },
  'chola-dynasty': {
    ...
    label: 'Chola Dynasty',
    description: 'Chola Dynasty for UPSC & SSC. Rajaraja I, Rajendra I, naval power, temple architecture with notes, revision, and practice questions.',
  },
  'pallava-dynasty': {
    ...
    description: 'Pallava Dynasty for government exams. Mahabalipuram, Kanchipuram, rock-cut architecture with notes, revision, and practice questions.',
  },
  'delhi-sultanate': {
    ...
    description: 'Delhi Sultanate for UPSC & SSC. Five dynasties, administration, economy with notes, revision, and practice questions.',
  },
  'vijayanagara-bahmani': {
    ...
    description: 'Vijayanagara and Bahmani for government exams. Krishnadevaraya, Hampi, Deccan sultanates with notes, revision, and practice questions.',
  },
  'bhakti-sufi': {
    ...
    description: 'Bhakti and Sufi Movements for UPSC & SSC. Saints, Sufi orders, philosophy, social impact with notes, revision, and practice questions.',
  },
  'mughal-empire': {
    ...
    label: 'Mughal Empire',
    description: 'Mughal Empire for government exams. Babur to Aurangzeb, Mansabdari, revenue, culture with notes, revision, and practice questions.',
  },
  'maratha-empire': {
    ...
    description: 'Maratha Empire for UPSC & SSC. Shivaji, Peshwas, Ashtapradhan, Panipat III with notes, revision, and practice questions.',
  },
  'medieval-kingdoms': {
    ...
    description: 'Medieval Kingdoms for government exams. Rajputs, Sikhs, Ahom kingdom with notes, revision, and practice questions.',
  },
  'rajput-kingdoms': {
    ...
    description: 'Rajput Kingdoms for UPSC & SSC. Pratiharas, Chahamanas, Rajput polity, resistance to invasions with notes, revision, and practice questions.',
  },
  // Modern India
  'european-companies': {
    ...
    description: 'European Trading Companies for UPSC & SSC. Portuguese, Dutch, French, EIC, Carnatic Wars with notes, revision, and practice questions.',
  },
  'british-expansion': {
    ...
    description: 'British Conquest for government exams. Plassey, Buxar, Subsidiary Alliance, Doctrine of Lapse with notes, revision, and practice questions.',
  },
  'governor-generals': {
    ...
    description: 'Governor-Generals & Viceroys for UPSC & SSC. Warren Hastings to Mountbatten with notes, revision, and practice questions.',
  },
  'british-economic-policies': {
    ...
    description: 'British Economic Policies for government exams. Drain of Wealth, land revenue systems with notes, revision, and practice questions.',
  },
  'revolt-1857': {
    ...
    description: 'Revolt of 1857 for UPSC & SSC. Causes, centres, leaders, consequences with notes, revision, and practice questions.',
  },
  'reform-movements': {
    ...
    description: 'Reform Movements for government exams. Brahmo Samaj, Arya Samaj, widow remarriage with notes, revision, and practice questions.',
  },
  'congress-national-movement': {
    ...
    description: 'Indian National Congress for UPSC & SSC. Moderates, Extremists, Swadeshi with notes, revision, and practice questions.',
  },
  'gandhian-movements': {
    ...
    description: 'Gandhian Movements for government exams. NCM, CDM, Quit India, Satyagraha with notes, revision, and practice questions.',
  },
  'revolutionary-movement': {
    ...
    description: 'Revolutionary Movement for UPSC & SSC. Ghadar, HSRA, INA, Subhas Chandra Bose with notes, revision, and practice questions.',
  },
  'constitutional-development': {
    ...
    description: 'Constitutional Development for government exams. Regulating Act to GoI Act 1935 with notes, revision, and practice questions.',
  },
  'tribal-peasant-movements': {
    ...
    description: 'Tribal & Peasant Movements for UPSC & SSC. Santhal, Munda, Indigo, Moplah with notes, revision, and practice questions.',
  },
  'anglo-wars': {
    ...
    description: 'Anglo Wars for UPSC & SSC. Anglo-Mysore, Anglo-Maratha, Anglo-Sikh wars with causes, treaties, and practice questions.',
  },
  'land-revenue-systems': {
    ...
    description: 'Land Revenue Systems for government exams. Permanent Settlement, Ryotwari, Mahalwari with notes, revision, and practice questions.',
  },
  'press-education-british': {
    ...
    description: 'Press & Education under British for UPSC & SSC. Vernacular Press Act, Wood Despatch with notes, revision, and practice questions.',
  },
  'caste-reform-movements': {
    ...
    description: 'Caste Reform Movements for government exams. Jyotirao Phule, Ambedkar, Periyar, SNDP with notes, revision, and practice questions.',
  },
  'womens-movements': {
    ...
    description: "Women's Movements for UPSC & SSC. Sati abolition, widow remarriage, women's organizations with notes, revision, and practice questions.",
  },
  // Post-Independence
  'independence-partition': {
    ...
    description: 'Independence & Partition for government exams. Cabinet Mission, Mountbatten Plan with notes, revision, and practice questions.',
  },
  'princely-states': {
    ...
    description: 'Princely States integration for UPSC & SSC. Sardar Patel, Hyderabad, Kashmir with notes, revision, and practice questions.',
  },
  'nation-building': {
    ...
    description: 'Nation Building for government exams. Five Year Plans, Green Revolution, LPG 1991 with notes, revision, and practice questions.',
  },
  'wars-foreign-policy': {
    ...
    description: 'Wars & Foreign Policy for UPSC & SSC. 1962, 1965, 1971, Non-Alignment with notes, revision, and practice questions.',
  },
  'post-independence-consolidation': {
    ...
    description: 'Post-Independence Consolidation for government exams. Constitution, FYPs, linguistic states, 1962 war with notes, revision, and practice questions.',
  },
  'non-aligned-movement': {
    ...
    description: 'NAM & Foreign Policy for UPSC & SSC. Panchsheel, Belgrade, Bandung, Indo-Soviet Treaty with notes, revision, and practice questions.',
  },
  'green-white-revolution': {
    ...
    description: 'Agricultural Revolutions for government exams. Green, White, Blue, Yellow revolutions with notes, revision, and practice questions.',
  },
  // Art & Culture
  'indian-architecture': {
    ...
    description: 'Indian Architecture for UPSC & SSC. Nagara, Dravida, Indo-Islamic, Colonial with notes, revision, and practice questions.',
  },
  'paintings-sculpture': {
    ...
    description: 'Indian Paintings & Sculpture for government exams. Cave art, miniatures, Gandhara, Mathura with notes, revision, and practice questions.',
  },
  'music-dance': {
    ...
    description: 'Music, Dance & Theatre for UPSC & SSC. Classical forms, folk dances with notes, revision, and practice questions.',
  },
  'indian-literature': {
    ...
    description: 'Indian Literature for government exams. Vedic, Sangam, six schools with notes, revision, and practice questions.',
  },
  'heritage-sites': {
    ...
    description: 'UNESCO Heritage Sites in India for UPSC & SSC. Key sites, significance with notes, revision, and practice questions.',
  },
  'indian-cinema-theatre': {
    ...
    description: 'Indian Cinema & Theatre for government exams. Phalke, Satyajit Ray, Natyashastra, folk theatre with notes, revision, and practice questions.',
  },
  'fairs-festivals': {
    ...
    description: 'Indian Fairs & Festivals for UPSC & SSC. Kumbh Mela, harvest festivals, tribal festivals with notes, revision, and practice questions.',
  },
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title,
    description,
    keywords: [`${data.label}`, `${data.label} UPSC`, `${data.label} notes`, 'Indian History', 'history for UPSC', 'SSC CGL history', `${data.label} Practice`],
    openGraph: {
      title,
      description,
      type: 'article',
