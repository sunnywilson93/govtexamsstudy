...
export const delhiSultanateConcept: HistoryConcept = {
  ...
  notes: [
    ...
    {
      section: "Sayyid & Lodi Dynasties (1414-1526)",
      content:
    ...
    {
      section: "Administration & Revenue System",
      content:
    ...
    {
      section: "Economy, Society & Cultural Contributions",
      content:
