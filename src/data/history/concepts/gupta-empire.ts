...
export const guptaEmpireConcept: HistoryConcept = {
  topic: "gupta-empire",
  title: "Gupta Empire & Golden Age",
  description:
    "The Gupta Empire (c. 320-550 CE) earned the label \\u2018Golden Age of India\\u2019 for breakthroughs in science (Aryabhata, zero, decimal system), literature (Kalidasa), art (Sarnath Buddha, Ajanta paintings), and temple architecture. Exams test Allahabad Pillar Inscription details, Navaratna-work pairings, Chandragupta II\\u2019s Shaka conquest, and the Iron Pillar\\u2019s metallurgical significance. Comparing Mauryan centralized administration with the Gupta feudal land-grant system (Agrahara/Devagrahara) is a favourite Mains question. Huna invasions, Nalanda University, and Fa-Hien\\u2019s travel account also appear frequently.",
  ...
  notes: [
    {
      section: "Origins & Chandragupta I",
      content:
        "Sri Gupta (c. 240-280 CE) founded the dynasty in eastern Uttar Pradesh or Bengal; his son Ghatotkacha (c. 280-319 CE) continued as a minor chief. Chandragupta I (c. 319-335 CE) transformed the family\\u2019s fortunes by marrying Kumaradevi of the Lichchhavi clan, a powerful republican clan of Vaishali, which gave the Guptas legitimacy and access to north Bihar. He adopted the title Maharajadhiraja (King of Kings) and issued gold coins depicting both king and queen \\u2014 among the few ancient Indian coins showing a queen, underscoring the Lichchhavi alliance\\u2019s importance. He launched the Gupta Era (319-320 CE) and ruled from Pataliputra (modern Patna), reviving the old Mauryan capital.",
    },
    {
      section: "Samudragupta — The Conqueror",
      content:
        "Samudragupta (c. 335-375 CE) was the Gupta dynasty\\u2019s greatest military commander. The Allahabad Pillar Inscription (Prayag Prashasti), composed by court poet Harishena, records three conquest categories: (1) Aryavarta \\u2014 he \\u2018violently exterminated\\u2019 (prasamhara) 9 North Indian kings including Naga, Vakataka, and Kota rulers; (2) Dakshinapatha \\u2014 he defeated 12 southern kings but reinstated them as tributaries under the grahana-moksha-anugraha (capture, release, favour) policy; (3) frontier kingdoms (Samatata, Kamarupa, Nepal, Kartripura) that submitted voluntarily. The Shakas, Kushanas, and Sri Lanka\\u2019s ruler sent embassies. He performed the Ashvamedha yajna, held the title Kaviraja (King of Poets), and minted coins showing himself playing the veena. V.A. Smith called him the \\u2018Napoleon of India.\\u2019 He also received a Buddhist mission from Meghavarna of Sri Lanka seeking permission to build a monastery at Bodh Gaya.",
    },
    {
      section: "Ramagupta Episode",
      content:
    ...
    {
      section: "Chandragupta II (Vikramaditya)",
      content:
    ...
    {
      section: "Navaratnas (Nine Gems) of Chandragupta II",
      content:
    ...
    {
      section: "Kumaragupta I & Skandagupta",
      content:
    ...
    {
      section: "Science, Mathematics & Astronomy",
      content:
    ...
    {
      section: "Cave Art: Ajanta & Ellora",
      content:
    ...
    {
      section: "Social Structure & Daily Life",
      content:
