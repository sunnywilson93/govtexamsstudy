...
export const tribalPeasantMovementsConcept: HistoryConcept = {
  topic: "tribal-peasant-movements",
  title: "Tribal & Peasant Movements",
  description:
    "Peasants and tribal communities revolted repeatedly against colonial land-revenue systems, oppressive landlords, and moneylenders \\u2014 from the 1770s Sanyasi-Fakir Revolt through the 1946-51 Telangana uprising. Birsa Munda\\'s Ulgulan, the Santhal Hool, the Indigo Revolt, Champaran Satyagraha, and Bardoli exposed how Forest Acts destroyed tribal economies and how Permanent Settlement, Ryotwari, and Mahalwari crushed rural India. UPSC Prelims regularly asks movement-leader-region matching; SSC/RRB tests the Deccan Riots Commission, Chotanagpur Tenancy Act, and the tinkathia system.",
  period: "Modern India",
  keyDates: [
    {
      year: "1770s-1800s",
  ...
  notes: [
    {
      section: "Causes of Tribal & Peasant Uprisings",
      content:
        "Colonial land revenue systems (Permanent Settlement, Ryotwari, Mahalwari) uprooted traditional land relations and created new exploitative intermediaries. Peasants paid heavy, inflexible cash revenue regardless of harvest conditions. Moneylenders (mahajans/sahukars) charged 50\\u2013100% interest and used fraudulent accounting to trap families in perpetual debt, while the Civil Procedure Code let courts attach and sell land for debt recovery. The British forced peasants to grow indigo, opium, and cotton instead of food crops, destroying food security. Forest Acts (1865, 1878, 1927) criminalized tribal access to forests for grazing, gathering, and shifting cultivation (jhum/podu). Tribals faced a separate assault: dikus (outsiders \\u2014 moneylenders, contractors, missionaries) destroyed communal landholding systems (Khuntkatti among Mundas, Wilkis among Bhils), missionary activity threatened cultural identity, and the introduction of private property replaced collective ownership, enabling wholesale land alienation.",
    },
    {
      section: "Early Tribal Revolts (Pre-1857)",
      content:
        "Tribal communities resisted colonial intrusion from the earliest decades. Pahariyas revolted (1778) in the Rajmahal Hills when the British settled Santhals and plainspeople on their lands. The Chuar Revolt (1799) saw tribal landlords and peasants in Midnapore (Bengal) rise against revenue demands. Kols and Hos of Chotanagpur (Ranchi, Singhbhum) launched the Kol Insurrection (1831-32) after authorities transferred their lands to dikus and imposed forced labor (bethi); the revolt spread to Hazaribagh and Palamau before Captain Wilkinson suppressed it. Bhils of Khandesh (Maharashtra) fought repeatedly (1818-31) against revenue and forest laws. Tirot Singh led the Khasis of Meghalaya (1829-33) against British road construction through their territory. Chakra Bisoi mobilized the Khonds of Odisha (1837-56) against the suppression of Meriah (human sacrifice). Every expansion of British territory triggered tribal resistance almost immediately.",
    },
    {
      section: "Santhal Rebellion (1855-56)",
      content:
        "The Santhal Rebellion (also called Hool) ranks among the largest tribal uprisings in Indian history. The Santhals of the Rajmahal Hills (present-day Jharkhand/Bihar) revolted against zamindars (dikus \\u2014 outsiders), mahajans (moneylenders), and British colonial officers. The British had settled Santhals in the Damin-i-Koh area to clear forests for cultivation, but moneylenders and zamindars soon trapped them in cycles of debt and bonded labor (kamia system). Leaders Sidhu and Kanhu Murmu proclaimed the end of Company rule and declared themselves rulers, invoking divine sanction from their deity Thakur. About 10,000 Santhals armed with bows, arrows, and axes fought the British in guerrilla style. Women participated actively \\u2014 Phulo and Jhano Murmu (sisters of Sidhu-Kanhu) were warrior leaders. The British crushed the rebellion under martial law, deploying elephants and artillery against bow-wielding tribals \\u2014 about 10,000\\u201315,000 Santhals were killed. The British created the separate Santhal Pargana district (1856) with special regulations to protect Santhals from outside exploitation. The rebellion is commemorated as Hool Divas on 30 June. Karl Marx commented on the rebellion in his writings.",
    },
    {
      section: "Indigo Revolt (1859-60)",
      content:
    ...
    {
      section: "Deccan Riots (1875) & Agrarian Legislation",
      content:
    ...
    {
      section: "Munda Rebellion / Ulgulan (1899-1900)",
      content:
    ...
    {
      section: "Alluri Sitarama Raju & Rampa Rebellion (1922-24)",
      content:
    ...
    {
      section: "Peasant Movements in the Gandhian Era",
      content:
    ...
    {
      section: "Tebhaga Movement (1946-47)",
      content:
    ...
    {
      section: "Telangana Movement (1946-51)",
      content:
    ...
    {
      section: "Punnapra-Vayalar Uprising (1946)",
      content:
    ...
    {
      section: "Other Significant Tribal Movements",
      content:
    ...
    {
      section: "Colonial Agrarian Structure & Revenue Systems",
      content:
    ...
    {
      section: "Peasant Movements & the National Movement",
      content:
