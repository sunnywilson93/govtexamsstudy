...
export const womensMovementsConcept: HistoryConcept = {
  topic: "womens-movements",
  title: "Women's Reform Movements",
  description:
    "India\\'s women\\'s movements span Raja Ram Mohan Roy\\'s sati abolition campaign (1829) through Savitribai Phule\\'s first girls\\' school (1848), Vidyasagar\\'s Widow Remarriage Act (1856), mass participation in Civil Disobedience, and Captain Lakshmi Sahgal\\'s Rani of Jhansi Regiment in the INA. Post-independence, the Hindu Code Bills, 73rd/74th Amendments, and the 2005 equal-coparcenary amendment transformed women\\'s legal status. UPSC Prelims tests reformer-legislation matching and chronological ordering of reform Acts; SSC/RRB asks \\'firsts\\' in women\\'s political participation (first woman Congress president, first woman governor, first woman CM).",
  period: "Modern India",
  keyDates: [
    {
      year: "1829",
  ...
  notes: [
    {
      section: "Early Reform — Sati Abolition",
      content:
        "Sati \\u2014 a widow\\'s immolation on her husband\\'s pyre \\u2014 was practiced mainly in Bengal, Rajputana, and central India. Though largely an upper-caste phenomenon, it became the starkest symbol of women\\'s oppression. Raja Ram Mohan Roy (1772-1833), founder of the Brahmo Sabha (1828), led the abolition campaign on two fronts: he proved from the Vedas, Upanishads, and Manusmriti that the highest scriptures did not sanction sati, and he published humanitarian tracts in Bengali and English, including Conference between an Advocate for and an Opponent of the Practice of Burning Widows Alive (1818). Lord William Bentinck enacted the Bengal Sati Regulation (Regulation XVII) on 4 December 1829, criminalizing sati. The Dharma Sabha under Radhakant Deb petitioned the Privy Council to overturn the ban but failed (1832). The regulation initially covered only Bengal before extending to Madras and Bombay (both 1830). In some princely states (e.g., Jaipur) sati persisted into the 20th century; the last known case \\u2014 Roop Kanwar at Deorala, Rajasthan (1987) \\u2014 triggered the Commission of Sati (Prevention) Act, 1987.",
    },
    {
      section: "Widow Remarriage Campaign",
      content:
        "Abolishing sati did not end widows\\' suffering \\u2014 they still faced enforced celibacy, tonsure, white clothing, fasting, social ostracism, and virtual imprisonment. Ishwar Chandra Vidyasagar (1820-1891) attacked this head-on. He extracted scriptural support from the Parasara Smriti (a Dharmashastra text that explicitly permits widow remarriage in the Kali Yuga) and gathered 25,000 petition signatures \\u2014 overcoming a larger orthodox counter-petition \\u2014 to push the Hindu Widows\\' Remarriage Act (Act XV, 1856) through under Lord Dalhousie (Lord Canning was Governor-General by the time it was finalized). Vidyasagar organized the first widow remarriage in Calcutta on 7 December 1856; his own son married a widow. Social ostracism persisted, and only 25 widow remarriages occurred in the first decade. Vidyasagar spent much of his personal wealth educating girls and supporting destitute women. He also campaigned against polygamy (common among Kulin Brahmins in Bengal) and child marriage; his Bahubivah (1871) marshalled arguments against plural marriage.",
    },
    {
      section: "Women's Education Pioneers",
      content:
        "Women\\'s education proved the most transformative reform. Savitribai Phule (1831-1897), India\\'s first female teacher, opened the first school for girls (including lower-caste girls) in Pune in 1848 with Jyotirao Phule. Hostile crowds threw stones and cow dung at her on her walk to school; she persisted. By 1851 the Phules ran 18 girls\\' schools and a shelter for pregnant rape victims and abandoned children. Savitribai also wrote poetry on caste oppression. Pandita Ramabai Saraswati (1858-1922) earned the title \\'Pandita\\' from the University of Calcutta for her Sanskrit scholarship \\u2014 the first woman so honored. She founded the Arya Mahila Samaj (1882), Sharada Sadan (1889, Bombay \\u2014 a residential school for child-widows), and the Mukti Mission (Kedgaon, near Pune). Her The High-Caste Hindu Woman (1887, published in the US) exposed Indian women\\'s oppression to a Western audience. Dhondo Keshav Karve (1858-1962) founded SNDT Women\\'s University in Pune (1916) \\u2014 India\\'s first women\\'s university \\u2014 and received the Bharat Ratna in 1958. Begum Rokeya Sakhawat Hossain (1880-1932) pioneered Muslim women\\'s education, founding Sakhawat Memorial Girls\\' School (1911, Calcutta) and authoring Sultana\\'s Dream (1905) and Padmarag (1924). The Bethune School (Calcutta, 1849, founded by J.E.D. Bethune) became Asia\\'s first women\\'s college when upgraded in 1879.",
    },
    {
      section: "Legal Reforms — Age of Consent & Child Marriage",
      content:
    ...
    {
      section: "Women's Organizations & Suffrage Movement",
      content:
    ...
    {
      section: "Women in the Non-Cooperation & Civil Disobedience Movements",
      content:
    ...
    {
      section: "Women in the Quit India & INA Movements",
      content:
    ...
    {
      section: "Women in the Constituent Assembly & Constitution",
      content:
    ...
    {
      section: "Post-Independence Legal Reforms",
      content:
    ...
    {
      section: "The Devadasi System & Its Abolition",
      content:
    ...
    {
      section: "Post-Independence Women's Movement & Feminist Waves",
      content:
    ...
    {
      section: "Key Women Reformers — Quick Reference",
      content:
    ...
    {
      section: "Women & the Caste Question",
      content:
