...
export const indusValleyConcept: HistoryConcept = {
  topic: "indus-valley",
  title: "Indus Valley Civilization",
  description:
    "The Indus Valley (Harappan) Civilization flourished across northwestern South Asia from c. 3300 BCE to 1300 BCE, covering 1.3 million sq km \\u2014 larger than contemporary Egypt and Mesopotamia combined. UPSC Prelims draws 1\\u20132 questions almost every year on Harappan sites, artifacts, and unique features. SSC and RRB papers regularly test site-discovery pairs, the Great Bath, Lothal\\u2019s dockyard, and the undeciphered script. Dholavira\\u2019s UNESCO inscription (2021) and the Rakhigarhi DNA study (2019) have added fresh exam-relevant dimensions.",
  ...
  notes: [
    {
      section: "Discovery & Phases of the Civilization",
      content:
        "Daya Ram Sahni identified Harappa in 1921 and R.D. Banerji discovered Mohenjo-daro in 1922, both working under Sir John Marshall of the Archaeological Survey of India. Three major phases define the civilization: (1) Early/Pre-Harappan (c. 3300\\u20132600 BCE) \\u2014 settlements and agriculture developed at Kot Diji, Amri, and Mehrgarh (Balochistan, c. 7000 BCE \\u2014 the earliest known Neolithic site in South Asia); (2) Mature Harappan (c. 2600\\u20131900 BCE) \\u2014 full urbanization with standardized weights, script, seals, and long-distance trade; (3) Late Harappan (c. 1900\\u20131300 BCE) \\u2014 gradual deurbanization, trade-network collapse, and eventual abandonment. Over 1,400 sites have been identified, roughly 925 of them in India.",
    },
    {
      section: "Major Sites — Locations and Key Discoveries",
      content:
        "Pakistan sites: Harappa (Ravi, Punjab \\u2014 granaries with working floors, coffin burials, R-37 cemetery) and Mohenjo-daro (Indus, Sindh \\u2014 Great Bath, Great Granary, Dancing Girl, Pashupati Seal, Priest King bust, maximum seals recovered). Indian sites: Rakhigarhi (Haryana \\u2014 largest Indian site; the 2019 DNA study pointed to indigenous origin), Dholavira (Gujarat \\u2014 unique three-part city division, 16 water-harvesting reservoirs, Harappan signboard, stadium-like structure; UNESCO World Heritage 2021), Lothal (Gujarat \\u2014 dockyard, fire altars, rice husk, double burial, bead factory, Persian Gulf seal), Kalibangan (Rajasthan \\u2014 earliest ploughed field, fire altars, earliest earthquake evidence, decorated bricks), Banawali (Haryana \\u2014 oval settlement, barley, toy plough, radial streets), Surkotada (Gujarat \\u2014 horse bones, oval fortification), Ropar (Punjab \\u2014 first Harappan site excavated in independent India, dog burial). Boundary sites: Alamgirpur (UP \\u2014 easternmost), Manda (Jammu \\u2014 northernmost), Daimabad (Maharashtra \\u2014 southernmost), Sutkagen-dor (Balochistan \\u2014 westernmost).",
    },
    {
      section: "Town Planning & Architecture",
      content:
        "Harappan builders laid cities on a grid with streets intersecting at right angles and divided each settlement into an upper citadel (west, elevated, fortified) and a lower town (east, larger, residential). They used standardized baked bricks in the ratio 4:2:1 (length:breadth:height). The Great Bath at Mohenjo-daro (12m x 7m x 2.4m) \\u2014 waterproofed with bitumen and flanked by changing rooms \\u2014 likely served ritualistic purification. Covered drains ran along main streets with manholes for cleaning and individual house connections; no other Bronze Age civilization matched this sanitation. Houses surrounded courtyards and contained bathrooms, wells (700+ at Mohenjo-daro alone), and staircases (indicating multi-storey structures). The Great Granary at Harappa (two rows of six granaries near the river) and at Mohenjo-daro (citadel, with air ducts and loading platforms) provided centralized storage. Dholavira alone had a three-part division: citadel, middle town, and lower town.",
    },
    {
      section: "Agriculture, Animals and Food Production",
      content:
    ...
    {
      section: "Economy, Trade and Crafts",
      content:
    ...
    {
      section: "Religion, Beliefs and Burial Practices",
      content:
    ...
    {
      section: "Script, Seals and Communication",
      content:
    ...
    {
      section: "Harappan Art and Craftsmanship",
      content:
    ...
    {
      section: "The Ghaggar-Hakra/Saraswati Debate",
      content:
    ...
    {
      section: "Decline Theories and Post-Harappan Developments",
      content:
    ...
    {
      section: "Comparison with Contemporary Civilizations",
      content:
    ...
    {
      section: "Key Archaeological Finds — Exam Essentials",
      content:
