...
export const postMauryaConcept: HistoryConcept = {
  topic: "post-maurya",
  ...
  notes: [
    ...
    {
      section: "Kushana Empire — Rise & Administration",
      content:
    ...
    {
      section: "Gandhara & Mathura Schools of Art",
      content:
    ...
    {
      section: "Satavahana Society & Administration",
      content:
    ...
    {
      section: "Indo-Roman Trade & Maritime Commerce",
      content:
    ...
    {
      section: "Successor States & Transition to Guptas",
      content:
