...
export const rajputKingdomsConcept: HistoryConcept = {
  topic: "rajput-kingdoms",
  ...
  keyDates: [
    {
      year: "c. 730 CE",
      event: "Nagabhata I of the Pratihara dynasty repels the Arab invasion of Junaid at the borders of Rajputana — credited as the first major Rajput resistance to Islamic expansion",
    },
    {
      year: "c. 836-885 CE",
      event: "Mihira Bhoja (Pratihara dynasty) — greatest Pratihara ruler; controls Kannauj, expands from Gujarat to Bengal; Arab traveller Sulaiman calls him the greatest enemy of Islam",
    },
    {
      year: "c. 950-1050 CE",
      event: "Chandella dynasty at its zenith — construction of the Khajuraho temples; Dhanga and Vidyadhara are prominent rulers",
    },
    {
      year: "1018 CE",
      event: "Mahmud of Ghazni attacks Kannauj; Pratihara power collapses; Rajput kingdoms fragment into smaller states",
    },
    {
      year: "c. 1010-1055 CE",
      event: "Bhoja Paramara of Malwa — greatest Paramara ruler; patron of learning, founded Bhojshala at Dhar; authored texts on architecture, astronomy, yoga",
    },
    {
      year: "1191 CE",
      event: "First Battle of Tarain — Prithviraj III (Chahamana/Chauhan) defeats Muhammad of Ghor",
    },
    {
      year: "1192 CE",
      event: "Second Battle of Tarain — Muhammad of Ghor defeats Prithviraj III; marks the beginning of Muslim rule in North India",
    },
    {
      year: "1194 CE",
      event: "Battle of Chandawar — Muhammad of Ghor defeats Jayachandra (Gahadavala dynasty) of Kannauj; Gahadavala power ends",
    },
    {
      year: "c. 1200-1300 CE",
      event: "Rajput kingdoms reduced to smaller principalities in Rajputana, Bundelkhand, and hill states; adapt as vassals or resistance fighters",
    },
  ],
  notes: [
    {
      section: "Origin Theories & Clan Structure",
      content:
    ...
    {
      section: "Gurjara-Pratiharas — The Imperial Rajputs",
      content:
    ...
    {
      section: "Chahamanas (Chauhans) & Prithviraj III",
      content:
    ...
    {
      section: "Chandellas of Bundelkhand & Khajuraho",
      content:
    ...
    {
      section: "Paramaras, Solankis & Other Rajput Kingdoms",
      content:
    ...
    {
      section: "Rajput Military System & Feudalism",
      content:
    ...
    {
      section: "Art, Architecture & Cultural Contributions",
      content:
  ...
  examTags: ["UPSC Prelims", "UPSC Mains", "SSC CGL", "RRB NTPC", "CDS", "UPPSC", "RPSC"],
  examRelevance:
