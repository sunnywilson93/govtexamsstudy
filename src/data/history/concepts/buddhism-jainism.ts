...
export const buddhismJainismConcept: HistoryConcept = {
  topic: "buddhism-jainism",
  title: "Buddhism & Jainism",
  description:
    "Buddhism and Jainism arose in the 6th century BCE as heterodox (Nastika) reactions to Vedic ritualism and Brahmanical orthodoxy. Exams test Buddhist Councils (who presided, where, what resulted), Hinayana vs Mahayana differences, Jain concepts like Anekantavada and Syadvada, and comparison traps such as Buddhist Triratna vs Jain Triratna. Both traditions preached ahimsa, rejected Vedic authority, and opened paths to liberation across all social classes.",
  ...
  notes: [
    {
      section: "Life of Buddha & Core Teachings",
      content:
        "Siddhartha Gautama was born into the Shakya clan at Lumbini (c. 563 BCE) to Suddhodana and Mayadevi. Mayadevi died seven days after his birth; his stepmother Mahaprajapati Gautami raised him. He married Yashodhara and fathered a son, Rahula. At 29 he renounced home life (Mahabhinishkramana) after witnessing four sights \\u2014 an old man, a sick man, a corpse, and an ascetic. He attained Enlightenment at 35 at Bodh Gaya and delivered his first sermon (Dharmachakrapravartana) at the Deer Park in Sarnath to five ascetics. Core teachings: Four Noble Truths (dukkha, samudaya, nirodha, magga), the Middle Path, Dependent Origination (pratityasamutpada), and the Three Marks of Existence (anicca, dukkha, anatta).",
    },
    {
      section: "Buddhist Councils & Scriptures",
      content:
        "Four Buddhist Councils shaped the tradition. The First (c. 483 BCE) met at Saptaparni Cave, Rajgriha, under Mahakassapa with Ajatashatru as patron; Ananda compiled the Sutta Pitaka and Upali the Vinaya Pitaka. The Second (c. 383 BCE) at Vaishali under Sabakami produced the first major schism: Sthaviravadins (orthodox) split from Mahasanghikas (liberal) over monastic rules. The Third (c. 250 BCE) at Pataliputra under Moggaliputta Tissa, patronized by Ashoka, compiled the Abhidhamma Pitaka, expelled heretics, and dispatched missionaries to Sri Lanka (Mahinda and Sanghamitta), Central Asia, and Southeast Asia. The Fourth (c. 72 CE) at Kundalvana, Kashmir, under Vasumitra (vice-chair Ashvaghosha), patronized by Kanishka, formally divided Buddhism into Hinayana and Mahayana. The Tripitaka \\u2014 Vinaya (monastic rules), Sutta (discourses), Abhidhamma (philosophy) \\u2014 forms the canonical Pali literature.",
    },
    {
      section: "Buddhist Sects: Hinayana, Mahayana & Vajrayana",
      content:
    ...
    {
      section: "Life of Mahavira & Jain Teachings",
      content:
    ...
    {
      section: "Buddhist Art and Architecture",
      content:
    ...
    {
      section: "Jain Art, Architecture and Temples",
      content:
    ...
    {
      section: "The Eightfold Path — Detailed Breakdown",
      content:
    ...
    {
      section: "Jain Ethics and the Concept of Karma",
      content:
    ...
    {
      section: "Buddhist Universities and Centers of Learning",
      content:
    ...
    {
      section: "Decline of Buddhism in India and Its Causes",
      content:
    ...
    {
      section: "Buddhism and Jainism in Tamil Nadu and South India",
      content:
    ...
    {
      section: "Dependent Origination and Buddhist Metaphysics",
      content:
