...
export const angloWarsConcept: HistoryConcept = {
  topic: "anglo-wars",
  title: "Anglo-Mysore, Anglo-Maratha & Anglo-Sikh Wars",
  description:
    "Three sets of wars let the East India Company crush India\\u2019s last major powers: Mysore (1767-1799), the Maratha Confederacy (1775-1818), and the Sikh Empire (1845-1849). Exams test treaty-Governor-General pairs, the Subsidiary Alliance mechanism, and Tipu Sultan\\u2019s military innovations such as Mysorean rockets. The Treaty of Mangalore (1784) stands out as the last occasion an Indian ruler dictated terms to the Company, while the Punjab annexation (1849) completed British territorial expansion across the subcontinent.",
  period: "Modern India",
  keyDates: [
    {
      year: "1767-1769",
      event: "First Anglo-Mysore War — Hyder Ali defeats the British; Treaty of Madras (1769) restores status quo with mutual defence clause",
    },
    {
      year: "1780-1784",
      event: "Second Anglo-Mysore War — Hyder Ali initially successful; dies 1782; Treaty of Mangalore (1784) between Tipu Sultan and British restores status quo",
    },
    {
      year: "1790-1792",
      event: "Third Anglo-Mysore War — Cornwallis defeats Tipu Sultan; Treaty of Seringapatam (1792) — Tipu loses half his territory and pays 3.3 crore rupees",
    },
    {
      year: "1799",
      event: "Fourth Anglo-Mysore War — Siege of Seringapatam; Tipu Sultan killed defending his capital (May 4, 1799); Mysore annexed, Wodeyar dynasty restored as vassal",
    },
    {
      year: "1775-1782",
      event: "First Anglo-Maratha War — Treaty of Salbai (1782) restores Madhav Rao Narayan as Peshwa; British gain Salsette; 20-year peace",
    },
    {
      year: "1802",
      event: "Treaty of Bassein — Peshwa Baji Rao II accepts Subsidiary Alliance after defeat at Poona by Holkar; triggers Second Anglo-Maratha War",
    },
    {
      year: "1803-1805",
      event: "Second Anglo-Maratha War — Wellesley defeats Scindia (Assaye, Laswari), Bhonsle (Argaon); Subsidiary Alliance imposed on Peshwa",
    },
    {
      year: "1817-1818",
      event: "Third Anglo-Maratha War — final defeat of Peshwa Baji Rao II (Khadki, Koregaon), Holkar, Bhonsle; Maratha Confederacy dissolved; Peshwa pensioned at Bithur",
    },
    {
      year: "1839",
      event: "Death of Maharaja Ranjit Singh triggers political instability in the Sikh Empire; rapid succession of rulers and growing power of the Khalsa army",
    },
    {
      year: "1845-1846",
      event: "First Anglo-Sikh War — Battles of Mudki, Ferozeshah, Sobraon; Treaty of Lahore (1846) — Sikhs cede Jalandhar Doab, pay 1.5 crore; Kashmir sold to Gulab Singh",
    },
    {
      year: "1846",
      event: "Treaty of Amritsar — Kashmir sold to Gulab Singh for 75 lakh rupees; Treaty of Bhyrowal establishes Council of Regency under British supervision",
    },
    {
      year: "1848-1849",
      event: "Second Anglo-Sikh War — Battles of Chilianwala, Gujarat; Punjab annexed by Dalhousie (March 29, 1849); Koh-i-Noor diamond taken to Britain",
    },
    {
      year: "1780",
      event: "Battle of Pollilur — Hyder Ali inflicts one of the worst defeats on the British in India; Colonel Baillie's force virtually annihilated",
    },
    {
      year: "1779",
      event: "Convention of Wadgaon — humiliating British surrender near Pune to Mahadji Scindia's forces during the First Anglo-Maratha War",
    },
  ],
  notes: [
    {
      section: "First & Second Anglo-Mysore Wars",
      content:
        "Hyder Ali seized power from the Wodeyar dynasty, defeated the British in the First Anglo-Mysore War (1767-1769), marched to the gates of Madras, and forced the Treaty of Madras (1769) with its mutual defence clause. When the British broke that clause by refusing to help him against the Marathas, Hyder Ali allied with the Nizam and Marathas and launched the Second Anglo-Mysore War (1780-1784). He annihilated Colonel Baillie\\u2019s force at Pollilur (1780) \\u2014 one of the worst British defeats in India. Hyder Ali died of cancer in 1782; his son Tipu Sultan continued the fight and signed the Treaty of Mangalore (1784), the last treaty in which an Indian power dictated terms to the Company. Warren Hastings criticized the Madras government\\u2019s handling of both wars.",
    },
    {
      section: "Third & Fourth Anglo-Mysore Wars — Fall of Tipu",
      content:
        "Tipu Sultan\\u2019s attack on Travancore (a British ally) triggered the Third Anglo-Mysore War (1790-1792). Cornwallis personally led the campaign, besieged Seringapatam, and forced the Treaty of Seringapatam (1792): Tipu lost half his territory, paid 3.3 crore rupees, and surrendered two sons as hostages. In the Fourth Anglo-Mysore War (1799), Governor-General Wellesley targeted Tipu after intercepting his correspondence with Napoleon in Egypt. Tipu had planted a \\u2018Tree of Liberty\\u2019 at Seringapatam and joined the Jacobin Club. British forces allied with the Nizam and Marathas besieged the capital; Tipu died fighting on May 4, 1799, at the Hoally Gate. The Wodeyar dynasty was restored as a subsidiary ruler. Tipu\\u2019s innovations included Mysorean iron-cased rockets (which later inspired Britain\\u2019s Congreve rocket), a modern coinage system, the Mauludi calendar, and land revenue reform. He styled himself the \\u2018Tiger of Mysore\\u2019 and sat on a tiger-shaped throne.",
    },
    {
      section: "First Anglo-Maratha War (1775-1782)",
      content:
        "The Bombay Council triggered the First Anglo-Maratha War by signing the Treaty of Surat (1775), recognising Raghunath Rao as Peshwa in exchange for Salsette and Bassein. Mahadji Scindia\\u2019s forces surrounded a British column near Pune and imposed the humiliating Convention of Wadgaon (1779). Warren Hastings then dispatched Captain Popham from Bengal, who captured Gwalior (1780). The Treaty of Salbai (1782), negotiated by Mahadji Scindia, restored Madhav Rao Narayan as Peshwa, returned most conquered territories, gave Salsette to the British, and secured 20 years of peace. The five Maratha powers \\u2014 the Peshwa (Pune), Scindia (Gwalior), Holkar (Indore), Bhonsle (Nagpur), and Gaekwad (Baroda) \\u2014 operated as a loose confederacy whose internal rivalries the British would later exploit decisively.",
    },
    {
      section: "Second & Third Anglo-Maratha Wars",
      content:
    ...
    {
      section: "First Anglo-Sikh War (1845-1846)",
      content:
    ...
    {
      section: "Second Anglo-Sikh War & Annexation of Punjab",
      content:
    ...
    {
      section: "Tipu Sultan — Innovations & Legacy",
      content:
    ...
    {
      section: "Hyder Ali — Rise and Military Genius",
      content:
    ...
    {
      section: "Mahadji Scindia and the Maratha Revival",
      content:
    ...
    {
      section: "Maharaja Ranjit Singh and the Sikh Empire",
      content:
    ...
    {
      section: "The Maratha Confederacy — Structure and Internal Rivalries",
      content:
    ...
    {
      section: "Key Battles — Detailed Analysis",
      content:
    ...
    {
      section: "The Role of Indian Allies and Treachery",
      content:
    ...
    {
      section: "Treaties and Their Long-term Consequences",
      content:
    ...
    {
      section: "Impact on Indian State Formation",
      content:
    ...
    {
      section: "Comparative Analysis & Exam Significance",
      content:
  ...
  examTags: ["UPSC Prelims", "UPSC Mains", "SSC CGL", "SSC CHSL", "RRB NTPC", "CDS", "NDA"],
  examRelevance:
