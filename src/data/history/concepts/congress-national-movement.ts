...
export const congressNationalMovementConcept: HistoryConcept = {
  ...
  notes: [
    ...
    {
      section: "Swadeshi Movement (1905-1911)",
      content:
    ...
    {
      section: "Home Rule Movement (1916-18)",
      content:
    ...
    {
      section: "Jallianwala Bagh Massacre (1919)",
      content:
    ...
    {
      section: "Civil Disobedience Movement & Salt March (1930-34)",
      content:
    ...
    {
      section: "Revolutionary Nationalism",
      content:
    ...
    {
      section: "Gandhi-Irwin Pact, Round Table Conferences & Government of India Act 1935",
      content:
    ...
    {
      section: "Congress and Communalism — Partition Background",
      content:
    ...
    {
      section: "Women in the Freedom Movement",
      content:
    ...
    {
      section: "Economic Critique — Drain of Wealth Theory",
      content:
    ...
    {
      section: "Exam-Critical Distinctions",
      content:
