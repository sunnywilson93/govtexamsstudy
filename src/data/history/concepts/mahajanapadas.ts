...
export const mahajanapdasConcept: HistoryConcept = {
  topic: "mahajanapadas",
  title: "Mahajanapadas & Rise of Magadha",
  description:
    "Sixteen Mahajanapadas dominated northern India by the 6th century BCE, and Magadha rose to supremacy through the Haryanka, Shishunaga, and Nanda dynasties before the Mauryas built India\\u2019s first empire. UPSC Prelims frequently targets Mahajanapada-capital pairs, the reasons behind Magadha\\u2019s rise, and Bimbisara\\u2019s matrimonial alliances. SSC and RRB papers test the founding of Pataliputra, the Vajjian republic at Vaishali, and Alexander\\u2019s invasion. Knowing all sixteen states and the three pre-Mauryan dynasties covers the core question pool for this topic.",
  ...
  notes: [
    {
      section: "The Sixteen Mahajanapadas",
      content:
        "The Anguttara Nikaya (Buddhist Pali text) lists sixteen Mahajanapadas with their capitals: Anga (Champa), Magadha (Rajgriha), Vajji/Vriji (Vaishali \\u2014 confederacy of 8 clans including Lichchhavis and Videhas), Malla (Kushinagar & Pava), Kashi (Varanasi), Kosala (Shravasti), Vatsa/Vamsa (Kaushambi), Chedi (Shuktimati), Kuru (Indraprastha), Panchala (Ahichhatra & Kampilya), Matsya (Viratnagar), Shurasena (Mathura), Avanti (Ujjain & Mahishmati \\u2014 divided north and south), Gandhara (Taxila), Kamboja (Rajapura/Hatakas), and Assaka/Asmaka (Potana/Potali \\u2014 the only Mahajanapada south of the Vindhyas). Most operated as monarchies; Vajji (Vaishali) and Malla functioned as republics (gana-sanghas). Four states contended for supremacy: Magadha, Kosala, Vatsa, and Avanti.",
    },
    {
      section: "Social and Economic Context — The Second Urbanization",
      content:
        "The Mahajanapadas arose alongside India\\u2019s \\u2018Second Urbanization\\u2019 (c. 600\\u2013300 BCE), following the Indus Valley\\u2019s first urbanization. Key drivers: (1) Iron technology \\u2014 iron ploughshares (lakha) cut through hard Gangetic alluvium, boosting agricultural surplus; iron axes cleared dense forests for new settlements. (2) Punch-marked coins (primarily silver karshapanas) appeared for the first time, enabling trade and standardized taxation. (3) Long-distance routes developed along the Ganga, linking Taxila to Champa, Rajagriha, and Shravasti. (4) Cities such as Rajagriha, Varanasi, Shravasti, Kaushambi, Champa, and Taxila grew as commerce and craft hubs. Surplus agriculture sustained standing armies and bureaucratic states. Rising Vaishya merchants and craft guilds (shrenis) challenged the old tribal social order, while Buddhism and Jainism drew support from these urban classes by rejecting Brahmanical ritual hegemony.",
    },
    {
      section: "Rise of Magadha — Geographical Advantages",
      content:
    ...
    {
      section: "Haryanka Dynasty (c. 544-412 BCE)",
      content:
    ...
    {
      section: "Shishunaga Dynasty (c. 412-344 BCE)",
      content:
    ...
    {
      section: "Nanda Dynasty (c. 344-321 BCE)",
      content:
    ...
    {
      section: "Republican States (Gana-Sanghas)",
      content:
    ...
    {
      section: "Alexander's Invasion and Its Impact (327-325 BCE)",
      content:
    ...
    {
      section: "Key Mahajanapadas — Kosala, Vatsa and Avanti",
      content:
    ...
    {
      section: "Taxila (Gandhara) — Center of Learning",
      content:
    ...
    {
      section: "Religion and Philosophy in the Mahajanapada Period",
      content:
    ...
    {
      section: "Material Culture and Coinage",
      content:
    ...
    {
      section: "Warfare, Military Organization and Fortifications",
      content:
    ...
    {
      section: "Women, Society and Caste in the Mahajanapada Period",
      content:
    ...
    {
      section: "Trade Routes and Urban Centers",
      content:
    ...
    {
      section: "Sources for the Mahajanapada Period",
      content:
