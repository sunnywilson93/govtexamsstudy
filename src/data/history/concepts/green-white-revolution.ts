...
export const greenWhiteRevolutionConcept: HistoryConcept = {
  topic: "green-white-revolution",
  ...
  keyDates: [
    {
      year: "1946",
      event: "Amul cooperative founded at Anand, Gujarat, by Tribhuvandas Patel with Verghese Kurien — beginning of India's cooperative dairy movement",
    },
    {
      year: "1961",
      event: "National Dairy Development Board (NDDB) established at Anand, Gujarat; Verghese Kurien appointed chairman — lays groundwork for Operation Flood",
    },
    {
      year: "1965-66",
      event: "Severe drought and near-famine conditions; India imports 10 million tonnes of wheat under PL-480 (US food aid); urgency drives adoption of HYV seeds",
    },
    {
      year: "1966-67",
      event: "Green Revolution begins — M.S. Swaminathan introduces Mexican dwarf wheat varieties (developed by Norman Borlaug) in India; New Agricultural Strategy launched",
    },
    {
      year: "1970",
      event: "Operation Flood (White Revolution) Phase I launched by NDDB under Kurien — links rural milk producers to urban consumers; World Food Programme aid used as capital",
    },
    {
      year: "1986",
      event: "Yellow Revolution initiated — Technology Mission on Oilseeds launched to achieve self-sufficiency in edible oils; Sam Pitroda as adviser",
    },
    {
      year: "1991",
      event: "India becomes the world's largest milk producer, overtaking the US — a direct result of Operation Flood; produces over 55 million tonnes",
    },
    {
      year: "2000",
      event: "Second Green Revolution concept — focus on eastern India, rain-fed agriculture, sustainability; Dr. M.S. Swaminathan's Evergreen Revolution concept",
    },
    {
      year: "2016",
      event: "Blue Revolution (Neel Kranti Mission) launched for integrated fisheries development — India becomes second-largest aquaculture producer globally",
    },
  ],
  notes: [
    {
      section: "Green Revolution — Origins & Implementation",
      content:
    ...
    {
      section: "Green Revolution — Impact & Criticism",
      content:
    ...
    {
      section: "White Revolution — Operation Flood",
      content:
    ...
    {
      section: "Blue Revolution — Fisheries",
      content:
    ...
    {
      section: "Yellow, Pink, Golden & Other Revolutions",
      content:
    ...
    {
      section: "Key Personalities & Institutions",
      content:
    ...
    {
      section: "Food Security & Current Challenges",
      content:
  ...
  examTags: ["UPSC Prelims", "UPSC Mains", "SSC CGL", "SSC CHSL", "RRB NTPC", "CDS", "NABARD Grade A"],
  examRelevance:
