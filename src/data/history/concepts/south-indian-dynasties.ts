...
export const southIndianDynastiesConcept: HistoryConcept = {
  topic: "south-indian-dynasties",
  title: "South Indian Dynasties",
  description:
    "The Pallavas, Chalukyas (Badami and Kalyani), Rashtrakutas, and imperial Cholas dominated peninsular India from the 4th to the 13th century CE, pioneering the Dravida, Vesara, and Nagara temple styles, building the Brihadeshwara and Kailasa temples, launching naval expeditions to Southeast Asia, and creating one of the ancient world\\'s most advanced local self-government systems at Uttaramerur. UPSC Prelims frequently asks about the Chola Kudavolai system, Variyam committees, temple architecture classification, and ruler-achievement matching. SSC/RRB papers test Kailasa Temple (Ellora), Rajendra Chola\\'s naval expedition, and Pulakeshin II\\'s defeat of Harsha.",
  ...
  notes: [
    {
      section: "Pallava Dynasty — Origins and Early History (c. 275-600 CE)",
      content:
        "The Pallavas ruled from Kanchipuram (Tamil Nadu) and drove the evolution of South Indian temple architecture. Scholars debate their origin \\u2014 they may descend from Parthian (Pahlava) settlers or from an indigenous dynasty that rose after the Satavahanas. Early Pallava rulers issued land grants in Prakrit, later switching to Sanskrit and Tamil. Simhavishnu (6th century) revived Pallava power and established Vaishnavism as the royal religion; his Vaikuntha Perumal portrayal (Vishnu in various forms) shaped later Pallava iconography. The dynasty fought constantly with the Badami Chalukyas to the west and the Pandyas to the south \\u2014 this tripartite rivalry defined Deccan politics for three centuries. The Pallava Grantha script, derived from Brahmi, gave rise to Old Javanese (Kawi), Khmer, Thai, Burmese, and Sinhalese scripts, making the Pallavas major agents of cultural diffusion to Southeast Asia.",
    },
    {
      section: "Pallava Architecture — Four Evolutionary Stages",
      content:
        "Pallava architecture evolved through four stages: (1) Mahendravarman style (early 7th century) \\u2014 rock-cut cave temples with simple pillars; Mandagapattu is the earliest example; Mahendravarman I, who converted from Jainism to Shaivism under saint Appar (Thirunavukkarasar), pioneered this style. (2) Mamalla style (mid-7th century) \\u2014 monolithic rathas carved from single boulders; the Pancha Rathas at Mamallapuram (named after the Pandavas and Draupadi) and the open-air bas-relief \\'Descent of the Ganga\\' (or \\'Arjuna\\'s Penance\\'), one of the world\\'s largest rock reliefs, define this phase. (3) Rajasimha style (late 7th-early 8th century) \\u2014 structural (built, not carved) temples; the Shore Temple at Mahabalipuram (South India\\'s first structural stone temple, three shrines facing the Bay of Bengal) and the Kailasanatha Temple at Kanchipuram (the largest Pallava temple) belong here. (4) Nandivarman style (8th-9th century) \\u2014 smaller, more ornate works like the Vaikuntha Perumal Temple at Kanchipuram, whose relief panels narrate Pallava history. UNESCO designated the Group of Monuments at Mahabalipuram a World Heritage Site in 1984.",
    },
    {
      section: "Chalukyas of Badami (c. 543-757 CE)",
      content:
    ...
    {
      section: "Chalukya Architecture — Vesara Style and Temple Experiments",
      content:
    ...
    {
      section: "Rashtrakutas (c. 753-982 CE)",
      content:
    ...
    {
      section: "Rashtrakuta Cultural Contributions",
      content:
    ...
    {
      section: "Chalukyas of Kalyani / Western Chalukyas (c. 973-1189 CE)",
      content:
    ...
    {
      section: "Imperial Cholas — Rise and Expansion (c. 850-1070 CE)",
      content:
    ...
    {
      section: "Chola Administration — Local Self-Government",
      content:
    ...
    {
      section: "Chola Revenue System and Economic Organization",
      content:
    ...
    {
      section: "Chola Naval Power and Southeast Asian Connections",
      content:
    ...
    {
      section: "Art, Architecture & Cultural Legacy",
      content:
    ...
    {
      section: "Bhakti Movement and South Indian Dynasties",
      content:
    ...
    {
      section: "Decline and Legacy of the Chola Empire",
      content:
