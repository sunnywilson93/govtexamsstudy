...
export const nonAlignedMovementConcept: HistoryConcept = {
  topic: "non-aligned-movement",
  title: "Non-Aligned Movement & Foreign Policy",
  description:
    "Nehru steered India away from both Cold War blocs and co-founded the Non-Aligned Movement with Tito, Nasser, Nkrumah, and Sukarno at Belgrade in 1961. The Panchsheel Agreement (1954), the Bandung Conference (1955), and the Indo-Soviet Treaty (1971) remain staple questions in UPSC Prelims and SSC exams. Exams also test the evolution from strict non-alignment to post-Cold War multi-alignment, including the India-US nuclear deal and India\\'s simultaneous membership in the Quad and SCO.",
  period: "Post-Independence",
  keyDates: [
    {
      year: "1947",
      event: "Asian Relations Conference (New Delhi, March 1947) — organized by Nehru before independence; delegates from 28 Asian countries; first major pan-Asian gathering",
    },
    {
      year: "1949",
      event: "Conference on Indonesia (New Delhi, January 1949) — Nehru convened a 19-nation conference protesting Dutch military action in Indonesia; demonstrated India's early activist foreign policy",
    },
    {
      year: "1954",
      event: "Panchsheel Agreement (Five Principles of Peaceful Coexistence) signed between India and China regarding trade with Tibet (April 29, 1954)",
    },
    {
      year: "1955",
      event: "Bandung Conference (Asian-African Conference, Indonesia) — 29 nations participate; Nehru, Nasser, Sukarno, Zhou Enlai prominent; 10 principles of Bandung Declaration",
    },
    {
      year: "1956",
      event: "Suez Crisis — India condemns Anglo-French-Israeli invasion of Egypt under Nasser; Nehru's strongest international stance backing decolonization",
    },
    {
      year: "1961",
      event: "First NAM Summit at Belgrade (Yugoslavia, September 1-6, 1961) — 25 member states; Nehru, Tito, Nasser, Nkrumah, Sukarno as founding leaders",
    },
    {
      year: "1962",
      event: "Sino-Indian War undermines Panchsheel; India seeks Western military aid, complicating non-alignment; NAM credibility questioned",
    },
    {
      year: "1964",
      event: "Second NAM Summit at Cairo (October 1964); 47 member states; Nehru had died in May 1964; Nasser plays host; declaration against colonialism and apartheid",
    },
    {
      year: "1971",
      event: "Indo-Soviet Treaty of Peace, Friendship and Cooperation (August 9, 1971) — signed before the Bangladesh Liberation War; critics call it a tilt toward the Soviet bloc",
    },
    {
      year: "1974",
      event: "NIEO Declaration at 6th Special Session of UNGA — NAM and G-77 demand reformed trade terms, sovereignty over natural resources, debt relief, technology transfer",
    },
    {
      year: "1983",
      event: "Seventh NAM Summit held in New Delhi — Indira Gandhi as Chair; 101 member states; peak of Indian leadership in NAM",
    },
    {
      year: "1991",
      event: "Dissolution of the Soviet Union; end of Cold War bipolarity; NAM's relevance questioned; India begins economic liberalization and foreign policy realignment",
    },
    {
      year: "1998",
      event: "Pokhran-II nuclear tests under PM Vajpayee; India declares itself a nuclear weapons state; sanctions imposed by US, Japan; fundamental shift in strategic posture",
    },
    {
      year: "2005-2008",
      event: "India-US Civil Nuclear Deal (123 Agreement) negotiated under PM Manmohan Singh; NSG waiver granted 2008; landmark realignment toward the US",
    },
    {
      year: "2012",
      event: "16th NAM Summit in Tehran; India represented by PM Manmohan Singh; NAM now has 120 member states — the largest grouping of states after the UN",
    },
  ],
  notes: [
    {
      section: "Origins — Panchsheel & Bandung",
      content:
        "Nehru drew on the nationalist movement\\'s anti-imperialism and Gandhi\\'s moral diplomacy to chart an independent path between the US-led NATO bloc and the Soviet-led Warsaw Pact. India and China signed the Panchsheel Agreement (April 29, 1954) as the preamble to a Tibet trade accord, enshrining five principles: (1) mutual respect for territorial integrity and sovereignty, (2) mutual non-aggression, (3) mutual non-interference, (4) equality and mutual benefit, and (5) peaceful co-existence. The Bandung Conference (April 18-24, 1955) gathered 29 Asian-African nations in Indonesia for the first large-scale meeting of newly independent states. Nehru mediated between pro-Western and pro-Communist delegations, and the ten Bandung principles expanded Panchsheel by adding UN Charter support, human rights, racial equality, and abstention from big-power defence pacts.",
    },
    {
      section: "Formation of NAM — Belgrade 1961",
      content:
        "Twenty-five countries formally launched the Non-Aligned Movement at the First Summit in Belgrade, Yugoslavia (September 1-6, 1961), with three observer states. Five leaders drove the founding: Nehru (India), Tito (Yugoslavia), Nasser (Egypt), Nkrumah (Ghana), and Sukarno (Indonesia). The Cairo preparatory meeting (1961) set membership criteria: an independent foreign policy rooted in coexistence, consistent support for independence movements, no membership in Cold War military alliances (NATO, SEATO, CENTO, Warsaw Pact), no military bases granted to great powers in a Cold War context, and bilateral defence agreements only outside Cold War rivalry. The Belgrade Declaration called for disarmament, abolition of colonialism, economic cooperation among developing nations, a restructured international economic order, and self-determination. NAM carried no charter, no permanent secretariat, and no binding decisions; the chairmanship rotated to each summit\\'s host country.",
    },
    {
      section: "India's Role in NAM & International Affairs",
      content:
        "India wielded the strongest voice in NAM during the Nehruvian era, drawing moral authority from leading the world\\'s largest democracy and championing decolonization. V.K. Krishna Menon shaped the Korean War armistice at the UN, and India chaired the Neutral Nations Repatriation Commission (1953). India also chaired the International Control Commissions in Vietnam, Laos, and Cambodia after the 1954 Geneva Accords, condemned the Anglo-French-Israeli invasion of Egypt during the Suez Crisis (1956), deployed troops in the Congo under UN peacekeeping mission ONUC (1960-64), and co-sponsored the Partial Test Ban Treaty initiative. India\\'s own conflicts tested non-alignment: Operation Vijay annexed Portuguese Goa in 1961 (the West criticized the use of force), the 1962 Sino-Indian War forced India to seek Western military aid, and the 1971 Indo-Soviet Treaty was widely read as a tilt toward Moscow during the Bangladesh crisis despite India insisting it remained a friendship accord.",
    },
    {
      section: "NAM & the New International Economic Order",
      content:
    ...
    {
      section: "India-Soviet Relations & the 1971 Treaty",
      content:
    ...
    {
      section: "India & the United Nations System",
      content:
    ...
    {
      section: "Nuclear Policy — From Pokhran to the NSG Waiver",
      content:
    ...
    {
      section: "Post-Cold War — NAM's Relevance & India's Realignment",
      content:
    ...
    {
      section: "India's Key Foreign Policy Doctrines & Events",
      content:
    ...
    {
      section: "India-China Relations: From Panchsheel to Rivalry",
      content:
    ...
    {
      section: "India-Pakistan Relations & Kashmir Question",
      content:
    ...
    {
      section: "India & Regional Organizations",
      content:
    ...
    {
      section: "India's Defence Relationships & Strategic Partnerships",
      content:
    ...
    {
      section: "NAM Summits — Complete Timeline",
      content:
    ...
    {
      section: "India's Neighbourhood Policy & Small-State Relations",
      content:
    ...
    {
      section: "Contemporary Foreign Policy — Multi-Alignment & Strategic Autonomy",
      content:
  ...
  examTags: ["UPSC Prelims", "UPSC Mains", "SSC CGL", "RRB NTPC", "CDS", "NDA", "CAPF"],
  examRelevance:
