...
export const vijayanagaraBahmaniConcept: HistoryConcept = {
  topic: "vijayanagara-bahmani",
  title: "Vijayanagara & Bahmani Kingdoms",
  description:
    "Vijayanagara (1336\\u20131646 CE) and the Bahmani Sultanate (1347\\u20131518 CE) dominated the Deccan as rival powers. Vijayanagara built its magnificent capital at Hampi, administered through the Nayankara and Ayagar systems, and peaked under Krishnadevaraya before the combined Deccan sultanates destroyed Hampi at Talikota (1565). UPSC Prelims tests Krishnadevaraya\\'s reign, the Nayankara system, Hampi\\'s architecture (Vitthala Temple, Lotus Mahal), and foreign travellers\\' accounts (Abdur Razzaq, Domingo Paes). SSC/RRB papers ask dynasty founders, capital cities, Mahmud Gawan, and the five Deccan sultanates.",
  ...
  notes: [
    {
      section: "Vijayanagara Empire — Foundation and Sangama Dynasty (1336-1485)",
      content:
        "Harihara I and Bukka I founded the Vijayanagara Empire in 1336, reportedly inspired by sage Vidyaranya of Sringeri Math. Both had served as treasury officers under the Kakatiya dynasty of Warangal and established a Hindu kingdom on the south bank of the Tungabhadra after Muhammad bin Tughlaq\\'s Delhi Sultanate had devastated the Deccan. The ruins at Hampi mark the capital (\\'City of Victory\\'). The Sangama Dynasty (1336-1485) ruled for nearly 150 years. Bukka I (1356-1377) defeated and annexed the Madurai Sultanate, unifying Tamil country. Devaraya I (1406-1422) inducted Muslim cavalry and archers into the army for the first time. Devaraya II (1424-1446), the ablest Sangama ruler, expanded Muslim recruitment further, patronized Telugu poet Srinatha, and allowed Muslim merchants to build mosques inside the capital. Italian traveler Nicolo Conti described him as commanding a massive army. The dynasty ended when Saluva Narasimha, a powerful Nayaka (military commander), seized power through a coup in 1485.",
    },
    {
      section: "Tuluva Dynasty and Krishnadevaraya (1505-1570)",
      content:
        "The Tuluva Dynasty (1505-1570) produced the empire\\'s greatest phase. Vira Narasimha founded it by usurping the last Saluva ruler. Krishnadevaraya (1509-1529) stands as the most celebrated Vijayanagara king: he defeated Bijapur\\'s Sultan at the Battle of Raichur (1520) and captured the strategic Raichur Doab, conquered the Gajapati kingdom of Odisha and took King Prataparudra prisoner, and repelled multiple Deccan Sultanate invasions. He authored Amuktamalyada in Telugu (statecraft framed through the story of devotee-poet Andal) and patronized the Ashtadiggajas (eight great Telugu poets); Allasani Peddana, the foremost among them, composed Manucharitram. His court hosted Sanskrit and Kannada scholars alongside Telugu luminaries, earning him the titles \\'Abhinava Bhoja\\' and \\'Andhra Bhoja.\\' He maintained friendly relations with the Portuguese (based in Goa from 1510) and allowed them to trade horses. After his death, weaker successors set the stage for the catastrophic defeat at Talikota.",
    },
    {
      section: "Vijayanagara Administration — Nayankara and Ayagar Systems",
      content:
    ...
    {
      section: "Vijayanagara Economy and Trade",
      content:
    ...
    {
      section: "Vijayanagara Art, Architecture & Culture",
      content:
    ...
    {
      section: "Bahmani Sultanate — Foundation and Key Rulers",
      content:
    ...
    {
      section: "Mahmud Gawan — The Great Bahmani Minister",
      content:
    ...
    {
      section: "Five Deccan Sultanates (1518-17th century)",
      content:
    ...
    {
      section: "Battle of Talikota (1565) & Aftermath",
      content:
    ...
    {
      section: "Foreign Travellers' Accounts",
      content:
    ...
    {
      section: "Deccan Sultanate Culture and Architecture",
      content:
    ...
    {
      section: "Vijayanagara — Religious Tolerance and Syncretism",
      content:
    ...
    {
      section: "Aravidu Dynasty and the End of Vijayanagara (1570-1646)",
      content:
