...
export const constitutionalDevelopmentConcept: HistoryConcept = {
  topic: "constitutional-development",
  title: "Constitutional Development in India (1773-1947)",
  description:
    "A series of British Parliamentary Acts shaped India\\u2019s governance from 1773 to 1947, steadily expanding Indian participation from nominated councils through limited franchise to full provincial autonomy. Exams test each Act\\u2019s key provision: Regulating Act (Governor-General of Bengal), Morley-Minto (separate electorates), Montagu-Chelmsford (Dyarchy in provinces), and GoI Act 1935 (provincial autonomy, three lists, Federal Court). The GoI Act 1935 supplied roughly 250 provisions to the Indian Constitution, making it the single most important source.",
  period: "Modern India",
  keyDates: [
    {
      year: "1773",
      event:
        "Regulating Act — first step to regulate the affairs of the East India Company; created the office of Governor-General of Bengal",
    },
    {
      year: "1784",
      event:
        "Pitt's India Act — established dual control: Board of Control (British government) + Court of Directors (Company); separated commercial and political functions",
    },
    {
      year: "1833",
      event:
        "Charter Act of 1833 — Governor-General of Bengal became Governor-General of India; EIC's commercial activities ended; law codification begun",
    },
    {
      year: "1858",
      event:
        "Government of India Act 1858 — transferred power from the EIC to the British Crown; Secretary of State for India created; Governor-General became Viceroy",
    },
    {
      year: "1861",
      event:
        "Indian Councils Act 1861 — introduced nominated Indian members in legislative councils; portfolio system introduced; restored legislative powers to Bombay and Madras presidencies",
    },
    {
      year: "1909",
      event:
        "Indian Councils Act 1909 (Morley-Minto Reforms) — introduced separate electorates for Muslims; expanded legislative councils",
    },
    {
      year: "1919",
      event:
        "Government of India Act 1919 (Montagu-Chelmsford Reforms) — introduced Dyarchy in provinces; created a bicameral legislature at the centre",
    },
    {
      year: "1935",
      event:
        "Government of India Act 1935 — proposed an All-India Federation; introduced provincial autonomy and abolished Dyarchy in provinces; introduced Dyarchy at the centre (never implemented)",
    },
    {
      year: "1947",
      event:
  ...
  notes: [
    {
      section: "Regulating Act (1773) & Pitt's India Act (1784)",
      content:
        "The Regulating Act of 1773 placed the East India Company under parliamentary oversight for the first time. It upgraded the Governor of Bengal to Governor-General of Bengal (Warren Hastings, the first holder), established a Supreme Court at Calcutta in 1774 (Chief Justice: Sir Elijah Impey), assigned a four-member Council, and barred Company servants from private trade or accepting gifts. Pitt\\u2019s India Act (1784) created dual control: a Board of Control (British Government) handled political affairs while the Court of Directors managed commerce. It trimmed the Governor-General\\u2019s Council to 3 members and first labelled Company territories \\u2018British possessions in India.\\u2019 This dual system lasted until 1858.",
    },
    {
      section: "Charter Acts (1793-1853)",
      content:
        "The Charter Act of 1793 extended the Company\\u2019s charter by 20 years and gave the Governor-General overriding powers over provincial Governors. The Charter Act of 1813 ended the Company\\u2019s trade monopoly (except China trade and tea), allocated Rs 1 lakh annually for Indian education, and admitted missionaries. The Charter Act of 1833 \\u2014 the most important Charter Act \\u2014 upgraded the Governor-General of Bengal to Governor-General of India (Lord William Bentinck, the first), ended all Company commercial activities, appointed a Law Commission under Macaulay for codification, and included an unenforced anti-discrimination clause. The Charter Act of 1853, the last in the series, separated legislative and executive functions, introduced open competition for the Indian Civil Service, and let the legislative council function like a mini-parliament.",
    },
    {
      section: "Government of India Act 1858 & Indian Councils Acts",
      content:
        "Government of India Act 1858 (passed after the Revolt of 1857): Transferred the governance of India from the EIC to the British Crown; the Governor-General was now also called the Viceroy (Lord Canning was the first); the Board of Control and Court of Directors were abolished; a Secretary of State for India (a member of the British Cabinet) with a 15-member Council of India was created; Queen Victoria's Proclamation (1 November 1858) promised non-interference in religious matters and equal treatment. Indian Councils Act 1861: Introduced Indians (nominated) into the legislative process for the first time — 3 Indians nominated by the Viceroy; portfolio system introduced (each member of the council was assigned a specific department); restored legislative powers to Bombay and Madras presidencies. Indian Councils Act 1892: Increased the size of legislative councils; introduced indirect election (the word 'election' was avoided — members were recommended by local bodies and chambers of commerce); members could discuss the budget but could not vote on it.",
    },
    {
      section: "Morley-Minto Reforms (1909)",
      content:
        "The Indian Councils Act 1909, known as the Morley-Minto Reforms (Lord Morley was the Secretary of State, Lord Minto was the Viceroy), made significant changes: (1) Enlarged the legislative councils at the centre and provinces; (2) Introduced separate electorates for Muslims (the most controversial provision — Muslims could now vote only for Muslim candidates in reserved constituencies); this 'sowed the seeds of communalism' and is seen as a deliberate 'divide and rule' policy; (3) Satyendra Prasad Sinha became the first Indian member of the Viceroy's Executive Council (as Law Member); (4) Members could move resolutions and ask supplementary questions; (5) However, the Act did not concede responsible government — the government retained control. The Muslim League (founded 1906 at Dhaka) had demanded separate electorates, and the Simla Deputation (1906) led by Aga Khan had met Lord Minto to press this demand.",
    },
    {
      section: "Montagu-Chelmsford Reforms (1919) & Government of India Act 1935",
      content:
        "Government of India Act 1919 (Montagu-Chelmsford Reforms): Based on the Montagu Declaration (August 1917) promising 'progressive realisation of responsible government.' Key provisions: (1) Introduced Dyarchy in provinces — subjects divided into Transferred (education, health, local government — under elected Indian ministers) and Reserved (finance, law and order, police — under the Governor); (2) Created a bicameral legislature at the centre — Council of State (Upper House, 60 members) and Legislative Assembly (Lower House, 144 members); (3) Direct elections introduced for the first time; (4) Communal representation extended to Sikhs; (5) A statutory commission (Simon Commission) to review reforms after 10 years. Government of India Act 1935: The longest Act passed by British Parliament (321 sections, 10 schedules). Key features: (1) Proposed an All-India Federation (including Princely States — never came into being as Princes refused to join); (2) Abolished Dyarchy in provinces, introduced Provincial Autonomy; (3) Introduced Dyarchy at the Centre (never implemented); (4) Three lists — Federal, Provincial, Concurrent; (5) Established a Federal Court; (6) Introduced direct elections and expanded franchise (35 million voters). Elections held in 1937 — Congress formed governments in 8 of 11 provinces.",
    },
    {
  ...
  examRelevance:
    "Constitutional development is one of the most important topics for UPSC Prelims and is tested every year. Questions ask about specific provisions of each Act (e.g., 'Which Act introduced Dyarchy?', 'Which Act created the Federal Court?'), matching Acts with their key features, and the chronological evolution of constitutional provisions. SSC and RRB exams test factual recall — 'When were separate electorates introduced?', 'Who was the first Viceroy?'. Understanding the GoI Act 1935 is essential as it formed the basis of the Indian Constitution.",
}
