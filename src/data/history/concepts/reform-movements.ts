...
export const reformMovementsConcept: HistoryConcept = {
  topic: "reform-movements",
  title: "Social & Religious Reform Movements",
  description:
    "Nineteenth-century reformers abolished sati, opened schools for girls and lower castes, attacked child marriage, and challenged caste discrimination through organizations like the Brahmo Samaj, Arya Samaj, Ramakrishna Mission, and the Aligarh Movement. UPSC Prelims regularly asks match-the-following on founder-organization pairs, key publications (Satyarth Prakash, Gulamgiri, Sambad Kaumudi), and the reformist-versus-revivalist distinction. SSC and RRB papers test direct factual recall on founders, Acts, and years.",
  period: "Modern India",
  keyDates: [
    {
      year: "1828",
  ...
  notes: [
    {
      section: "Brahmo Samaj — Foundation and Splits",
      content:
        "Raja Ram Mohan Roy founded the Brahmo Sabha in 1828 (later Brahmo Samaj), earning the titles \\'Father of the Indian Renaissance\\' and \\'Father of Modern India.\\' He campaigned against sati, child marriage, polygamy, and idolatry while promoting Western education. He co-founded Hindu College (1817, with David Hare and Alexander Duff), established Vedanta College (1825), and published Sambad Kaumudi (Bengali) and Mirat-ul-Akhbar (the first Persian-language newspaper in India). He translated Upanishads and wrote a Bengali grammar. After his death (1833, Bristol, England), Debendranath Tagore (Rabindranath\\'s father) gave the Samaj formal structure and published the Brahmo Dharma. Keshab Chandra Sen split away to form the Brahmo Samaj of India (1866). When Sen married his underage daughter to the minor Maharaja of Cooch Behar \\u2014 violating the movement\\'s own principles \\u2014 Ananda Mohan Bose and Sivanath Sastri formed the Sadharan Brahmo Samaj (1878). The Brahmo Samaj rejected idol worship, caste, and ritual and advocated Upanishad-based monotheism.",
    },
    {
      section: "Arya Samaj — Dayanand and the Vedic Revival",
      content:
        "Swami Dayanand Saraswati (born Mool Shankar, 1824-1883) founded the Arya Samaj in Bombay (1875) and later shifted its headquarters to Lahore. He rallied followers under the motto \\'Go back to the Vedas\\' (Krinvanto Vishvamaryam \\u2014 \\'Make the world noble\\') and rejected post-Vedic scriptures, idol worship, caste by birth, untouchability, child marriage, and pilgrimage. His 14-chapter Satyarth Prakash (The Light of Truth, 1882, first edition 1875) laid out the full philosophy. The Samaj launched the Shuddhi (reconversion/purification) movement to reclaim converts \\u2014 provoking Muslim opposition. It built over 800 DAV (Dayanand Anglo-Vedic) schools and colleges across North India by the early 20th century. After Dayanand\\'s death (1883, possibly poisoned), the movement split: the conservative Mahatma Hansraj group backed Western education through DAV institutions, while the Lala Lajpat Rai-Guru Dutt group championed traditional Gurukul education, founding Gurukul Kangri at Haridwar (1902, Swami Shraddhanand). The Arya Samaj dominated North Indian reform, especially in Punjab, and fed nationalists directly into the freedom movement \\u2014 Lala Lajpat Rai, Swami Shraddhanand, and Bhai Parmanand among them.",
    },
    {
      section: "Ramakrishna Mission & Swami Vivekananda",
      content:
        "Ramakrishna Paramahamsa (1836-86), priest at the Dakshineswar Kali Temple near Calcutta, practiced Hinduism, Islam, and Christianity and concluded that all paths reach the same divine truth (\\'Yato mat, tato path\\'). His foremost disciple Swami Vivekananda (born Narendranath Dutta, 1863-1902) founded the Ramakrishna Mission at Belur Math in 1897. Vivekananda opened his Chicago address at the Parliament of World Religions (11 September 1893) with \\'Sisters and brothers of America\\' and received a standing ovation. He championed practical Vedanta \\u2014 serving the poor as serving God (\\'Daridra Narayan\\') \\u2014 and pushed education, self-reliance, physical strength, and national pride. His works include Raja Yoga, Karma Yoga, Jnana Yoga, and My Master. Subhas Chandra Bose called him \\'the maker of modern India.\\' India celebrates his birthday (12 January) as National Youth Day (since 1985). Sister Nivedita (Margaret Elizabeth Noble, Irish disciple) advanced his educational and nationalist mission.",
    },
    {
      section: "Prarthana Samaj and Maharashtra Reformers",
      content:
    ...
    {
      section: "Theosophical Society and Annie Besant",
      content:
    ...
    {
      section: "Jyotirao Phule and the Anti-Caste Movement",
      content:
    ...
    {
      section: "Islamic Reform Movements — Aligarh and Deoband",
      content:
    ...
    {
      section: "Wahabi and Ahmadiyya Movements",
      content:
    ...
    {
      section: "South Indian Reform Movements",
      content:
    ...
    {
      section: "Sikh Reform — Singh Sabha and Akali Movement",
      content:
    ...
    {
      section: "Legislation Against Social Evils",
      content:
    ...
    {
      section: "Reformist vs Revivalist Approaches",
      content:
    ...
    {
      section: "Impact and Legacy of Reform Movements",
      content:
    ...
    {
      section: "B.R. Ambedkar and the Anti-Untouchability Movement",
      content:
    ...
    {
      section: "Parsi and Christian Reform Movements",
      content:
