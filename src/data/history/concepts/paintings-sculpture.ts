...
export const paintingsSculptureConcept: HistoryConcept = {
  topic: "paintings-sculpture",
  title: "Indian Paintings & Sculpture",
  description:
    "UPSC Prelims tests Gandhara vs Mathura school differences, Ajanta painting technique (fresco-secco), Mughal miniature painter-patron pairs, and Chola Nataraja bronzes almost every year. The tradition spans Bhimbetka rock art (UNESCO 2003) through Gupta masterpieces, Mughal and Rajput miniatures, to the Bengal School and Progressive Artists\\' Group. SSC exams focus on factual recall: Bani Thani (Kishangarh), Bharat Mata (Abanindranath Tagore), Constitution illustrations (Nandalal Bose). Mains GS-I asks candidates to trace the evolution of Indian art and connect it to social and religious change.",
  period: "Art & Culture",
  keyDates: [
    {
      year: "c. 30,000 BCE",
      event: "Bhimbetka rock shelters (Madhya Pradesh) — earliest known rock paintings in India, depicting hunting scenes and daily life",
    },
    {
      year: "c. 3rd century BCE",
      event: "Mauryan court art — polished Chunar sandstone pillars (Ashoka pillars), the Sarnath Lion Capital (national emblem), and Yaksha-Yakshi figures",
    },
    {
      year: "c. 2nd century BCE - 5th century CE",
      event: "Ajanta Cave paintings — finest examples of ancient Indian mural painting, depicting Jataka tales and court scenes",
    },
    {
      year: "c. 1st-3rd century CE",
      event: "Gandhara and Mathura schools of sculpture developed — the first anthropomorphic representations of the Buddha",
    },
    {
      year: "c. 4th-6th century CE",
      event: "Gupta period — 'Golden Age' of Indian art; Sarnath Buddha, Mathura Christ-like standing Buddhas, Deogarh Dashavatara Temple panels",
    },
    {
      year: "7th century CE",
      event: "Pallava sculptures at Mamallapuram — Arjuna's Penance (world's largest open-air rock relief), Five Rathas, Shore Temple",
    },
    {
      year: "9th-12th century",
      event: "Chola bronze sculptures — Nataraja (Shiva as Lord of Dance) and Ardhanariswara among the finest metal sculptures ever produced",
    },
    {
      year: "11th-12th century",
      event: "Pala school of painting in Bengal and Bihar — Buddhist manuscripts on palm leaves; last great Buddhist artistic tradition in India",
    },
    {
      year: "14th-16th century",
      event: "Western Indian (Jain) manuscript painting tradition — angular figures, protruding farther eye, bright colours on palm-leaf and paper manuscripts",
    },
    {
      year: "16th-19th century",
      event: "Mughal miniature painting tradition flourished, alongside Rajasthani (Rajput) and Pahari (Hill) schools",
    },
    {
      year: "17th-18th century",
      event: "Deccan painting schools at Bijapur, Golconda, and Hyderabad — distinct from Mughal style; more ornamental and lyrical",
    },
    {
      year: "1907",
      event: "Abanindranath Tagore founded the Bengal School of Art, rejecting Western academic art in favour of Indian themes and techniques",
    },
    {
      year: "1947",
      event: "Progressive Artists' Group (PAG) formed in Bombay by F.N. Souza, S.H. Raza, M.F. Husain, and others — pioneered modern Indian art",
    },
  ],
  notes: [
    {
      section: "Rock Art & Prehistoric Paintings",
      content:
        "Bhimbetka rock shelters (Raisen district, Madhya Pradesh, UNESCO 2003) hold over 700 shelters with paintings from the Mesolithic through the medieval period. The earliest works (c. 10,000-5,000 BCE) depict hunting scenes with bison, elephants, and rhinoceros in red and white mineral pigments. Later Mesolithic panels show dancing, communal activities, and rituals; Chalcolithic images introduce domestic animals and agriculture. Other key sites include Adamgarh (MP), Lakhudiyar (Uttarakhand), Kupgal (Karnataka), and Edakkal caves (Kerala, petroglyphs). Artists used mineral-based pigments: iron oxide (haematite/geru) for red and brown, lime or kaolin for white, ochre for yellow, chalcedony for green, and manganese for black. These paintings document daily life, belief systems, and the shift from hunting-gathering to settled farming.",
    },
    {
      section: "Mauryan & Early Historic Sculpture",
      content:
        "Mauryan sculptors (c. 322-185 BCE) launched India\\'s great stone-carving tradition with monolithic polished Chunar sandstone pillars bearing a mirror-like finish. The Sarnath Lion Capital (c. 250 BCE) places four Asiatic lions back-to-back atop an abacus showing an elephant, horse, bull, and lion separated by four Dharma wheels; India adopted it as the national emblem. The Didarganj Yakshi (Patna Museum) demonstrates life-size polished sandstone mastery, likely from the Mauryan era. Early Buddhist sculptors avoided depicting the Buddha in human form, relying instead on symbols: the Bodhi tree (Enlightenment), Dharma wheel (First Sermon), lotus (Birth), footprints, stupa (Parinirvana), and empty throne. The Bharhut Stupa railings (c. 2nd century BCE, Shunga period) and Sanchi Stupa gateways (toranas, c. 1st century BCE-1st century CE, Satavahana period) narrate Jataka tales through dense reliefs of human, animal, and vegetal forms.",
    },
    {
      section: "Ajanta & Ellora Cave Paintings",
      content:
        "Ajanta Caves (Aurangabad, Maharashtra) comprise 30 caves (9 chaityas, 21 viharas) painted across two phases: Satavahana (2nd-1st c. BCE, caves 9-10) and Vakataka (5th c. CE, caves 1, 2, 16, 17). Artists applied the fresco-secco technique (painting on dry plaster), not buon fresco. Iconic murals include the Padmapani and Vajrapani Bodhisattvas (Cave 1), the Dying Princess (Cave 16), and numerous Jataka tales. Painters extracted pigments from minerals: lapis lazuli (blue), red ochre (red), lime (white), and lampblack (black). They built each surface in layers: a rough coat of mud mixed with rock grit, hay, and vegetable fibre on the rock face, then a smoother lime-sand-organic layer, and finally the painted image on the dried plaster. Ajanta gained UNESCO World Heritage status in 1983 and stands as the finest surviving body of ancient Indian painting. Ellora holds 34 caves (Buddhist, Hindu, Jain) but preserves far fewer paintings than Ajanta.",
    },
    {
      section: "Gandhara & Mathura Schools of Sculpture",
      content:
    ...
    {
      section: "Gupta Period — Golden Age of Indian Art",
      content:
    ...
    {
      section: "Mughal Miniature Paintings",
      content:
    ...
    {
      section: "Rajasthani & Pahari Schools",
      content:
    ...
    {
      section: "Deccan Painting Schools",
      content:
    ...
    {
      section: "Chola Bronzes & Later Sculpture",
      content:
    ...
    {
      section: "Pala & Western Indian Painting Traditions",
      content:
    ...
    {
      section: "Bengal School & Modern Indian Art",
      content:
    ...
    {
      section: "Company School & British-Period Art",
      content:
    ...
    {
      section: "Indian Sculptural Traditions — Regional Survey",
      content:
    ...
    {
      section: "Terracotta & Folk Art Traditions",
      content:
