...
export const independencePartitionConcept: HistoryConcept = {
  topic: "independence-partition",
  title: "Independence & Partition",
  description:
    "India won independence on 15 August 1947 through a process shaped by the Cabinet Mission Plan, the Mountbatten Plan, and the Indian Independence Act 1947, but Partition split British India into India and Pakistan amid massive communal violence. Exams test Cabinet Mission members and proposals, the grouping clause, Mountbatten Plan provisions, Radcliffe Line controversies, and princely state accessions (Junagadh, Hyderabad, Kashmir). The Two-Nation Theory, Objectives Resolution, and first government formation are commonly tested, and constitutional development questions (Ambedkar\\u2019s role, Drafting Committee) overlap with Polity.",
  ...
  notes: [
    {
      section: "Background: The Road to Partition (1937-1945)",
      content:
        "The 1937 provincial elections (under GoI Act 1935) deepened the Hindu-Muslim divide: Congress won 7 of 11 provinces and refused coalition governments with the Muslim League, leading Jinnah to conclude Muslims could never secure fair representation under Congress rule. The League celebrated \\u2018Deliverance Day\\u2019 (22 December 1939) when Congress ministries resigned over the war issue. The Lahore Resolution (23 March 1940) formalized the demand for separate Muslim states. During WWII, the League cooperated with the British while Congress launched the Quit India Movement (1942), strengthening the League\\u2019s bargaining position. Jinnah told the British: \\u2018Divide and quit.\\u2019 The Desai-Liaquat Pact (1945) proposed equal Congress-League representation but was never implemented. By 1946, Pakistan had become non-negotiable for Jinnah.",
    },
    {
      section: "The Two-Nation Theory",
      content:
        "The Two-Nation Theory held that Hindus and Muslims constituted two distinct nations with fundamentally different social orders, histories, and aspirations, making coexistence in a single state impossible. Sir Syed Ahmad Khan\\u2019s post-1857 writings laid its intellectual foundations by stressing a distinct Muslim identity. Allama Iqbal articulated the idea more formally in his 1930 Allahabad Address, envisioning a consolidated Muslim state in northwest India. Choudhary Rahmat Ali coined the name \\u2018Pakistan\\u2019 (P-Punjab, A-Afghania/NWFP, K-Kashmir, S-Sindh, tan-Baluchistan) in his 1933 pamphlet Now or Never. Jinnah adopted the theory fully by 1940 (Lahore Resolution): \\u2018Hindus and Muslims belong to two different religions, philosophies, social customs, and literatures.\\u2019 Nationalists like Maulana Azad, Khan Abdul Ghaffar Khan, and Congress Muslims contested the theory, insisting on a composite Indian nation.",
    },
    {
      section: "Cabinet Mission Plan (1946)",
      content:
    ...
    {
      section: "Direct Action Day & Communal Violence (1946-47)",
      content:
    ...
    {
      section: "Interim Government & Constituent Assembly (1946)",
      content:
    ...
    {
      section: "The Attlee Declaration & Mountbatten\\'s Arrival",
      content:
    ...
    {
      section: "Mountbatten Plan & Indian Independence Act",
      content:
    ...
    {
      section: "Radcliffe Line & Boundary Commission",
      content:
    ...
    {
      section: "The Great Migration & Violence",
      content:
    ...
    {
      section: "Integration of Princely States",
      content:
    ...
    {
      section: "Transfer of Power & First Government",
      content:
    ...
    {
      section: "Gandhi\\'s Role in Partition & Assassination",
      content:
    ...
    {
      section: "Nehru\\'s Vision: Panchsheel & Non-Alignment",
      content:
    ...
    {
      section: "Refugee Rehabilitation & Long-term Impact",
      content:
    ...
    {
      section: "Constitutional Framework: From Dominion to Republic",
      content:
    ...
    {
      section: "Legacy & Historiographical Debates",
      content:
