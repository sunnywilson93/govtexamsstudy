...
export const mughalEmpireConcept: HistoryConcept = {
  topic: "mughal-empire",
  title: "Mughal Empire",
  description:
    "Babur founded the Mughal Empire in 1526, Akbar consolidated it through the Mansabdari system and religious tolerance, and Aurangzeb expanded it to its territorial peak before decline set in. This is the single most tested topic in Medieval Indian History across all competitive exams. UPSC Prelims consistently targets Akbar\\u2019s reforms, Mughal architecture, and the causes of decline. SSC and RRB papers demand factual recall on battles, monuments, rulers, and ruler-monument matching.",
  ...
  notes: [
    {
      section: "Babur: Foundation of the Empire (1526-1530)",
      content:
        "Zahir-ud-din Muhammad Babur, a Timurid prince from Fergana (modern Uzbekistan), traced his descent from Timur on his father\\u2019s side and Genghis Khan through his mother. After losing Samarkand he captured Kabul (1504) and turned toward India. He won three decisive battles: Panipat (1526, vs. Ibrahim Lodi \\u2014 deployed the Ottoman tactic of carts chained together as field fortifications with matchlockmen behind), Khanwa (1527, vs. Rana Sanga of Mewar \\u2014 declared a jihad to motivate his troops and assumed the title Ghazi), and Chanderi (1528, vs. Medini Rai). He then defeated the Afghans at Ghaghra (1529). Babur introduced gunpowder firearms and field artillery to Indian warfare; his artillery expert was Ustad Ali Quli. His autobiography, the Tuzuk-i-Baburi (Baburnama), written in Chagatai Turkish, stands as a masterpiece for its candid observations on Indian geography, flora, fauna, and people. He died in 1530 and was buried in Kabul as he wished. He also laid out Persian-style Charbagh gardens, including the Aram Bagh at Agra.",
    },
    {
      section: "Humayun and the Suri Interregnum (1530-1556)",
      content:
        "Nasir-ud-din Humayun (1530\\u20131540, 1555\\u20131556) inherited a fragile empire and divided territories among his brothers (Kamran\\u2014Kabul/Kandahar, Hindal\\u2014Mewat, Askari\\u2014Sambhal) following Timurid custom, which weakened central authority. Sher Khan (later Sher Shah Suri) defeated him at Chausa (1539) and Kannauj/Bilgram (1540). Humayun wandered in exile for 15 years \\u2014 first through Sindh and Rajasthan (his son Akbar was born at Amarkot in 1542), then at the Safavid court of Shah Tahmasp in Persia. He recaptured Kabul (1545) and finally Delhi (1555) with Persian military help, importing Persian cultural influences that shaped Mughal court life. He died in January 1556 after falling from the stairs of his library (Sher Mandal, Delhi). The Suri Interregnum (1540\\u20131555) produced lasting reforms: Sher Shah built the Grand Trunk Road (Sadak-e-Azam) from Sonargaon to Peshawar, overhauled land revenue (measured land with the sikandari gaz, fixed revenue at one-third of average produce, issued pattas and qabuliyats), introduced the silver Rupiya and copper Dam, built sarais at regular intervals, and reorganized the postal system \\u2014 all reforms Akbar later adopted. Humayun\\u2019s Tomb in Delhi, built by his widow Haji Begum, pioneered the garden-tomb concept in red sandstone and white marble and foreshadowed the Taj Mahal.",
    },
    {
      section: "Akbar the Great: Administration & Reforms (1556-1605)",
      content:
    ...
    {
      section: "Akbar's Religious & Rajput Policies",
      content:
    ...
    {
      section: "Jahangir: Art, Justice & Nur Jahan (1605-1627)",
      content:
    ...
    {
      section: "Shah Jahan: The Master Builder (1628-1658)",
      content:
    ...
    {
      section: "Aurangzeb: Expansion & Orthodoxy (1658-1707)",
      content:
    ...
    {
      section: "Later Mughals & Causes of Decline (1707-1857)",
      content:
    ...
    {
      section: "Mansabdari System: Structure & Evolution",
      content:
    ...
    {
      section: "Revenue Systems: Zabti, Nasaq, and Others",
      content:
    ...
    {
      section: "Provincial & Local Administration",
      content:
    ...
    {
      section: "Mughal Architecture: Styles & Major Monuments",
      content:
    ...
    {
      section: "Mughal Painting, Literature & Music",
      content:
    ...
    {
      section: "Mughal Society, Economy & Trade",
      content:
    ...
    {
      section: "Religious Movements Under the Mughals",
      content:
    ...
    {
      section: "Exam-Critical: Key Comparisons & Frequently Tested Facts",
      content:
