...
export const prehistoricIndiaConcept: HistoryConcept = {
  topic: "prehistoric-india",
  title: "Prehistoric India — Stone to Iron Age",
  description:
    "UPSC Prelims asks candidates to match prehistoric sites with states and cultural phases, identify the earliest evidence of farming (Mehrgarh, c. 7000 BCE) and iron use (Hallur, c. 1200 BCE), and distinguish tool technologies across Palaeolithic, Mesolithic, Neolithic, and Chalcolithic periods. Bhimbetka (UNESCO 2003), the Narmada skull (only Homo erectus from India), and PGW-Mahabharata / NBPW-second urbanization links are classic exam staples. SSC/RRB tests Robert Bruce Foote\\'s 1863 Pallavaram discovery and basic periodization.",
  period: "Ancient India",
  keyDates: [
    {
      year: "c. 2 million BP",
      event: "Earliest Palaeolithic tools (Acheulian hand-axes) found at Attirampakkam (Tamil Nadu) and Bori (Maharashtra)",
    },
    {
      year: "c. 1863",
      event: "Robert Bruce Foote discovers the first Palaeolithic tool (hand-axe) at Pallavaram near Chennai — 'Father of Indian Prehistory'",
    },
    {
      year: "c. 100,000 BP",
      event: "Middle Palaeolithic phase — flake tools, Levallois technique sites at Bhimbetka, Nevasa, Chirki-Nevasa",
    },
    {
      year: "c. 74,000 BP",
      event: "Toba super-eruption (Sumatra) deposits volcanic ash across India; Jwalapuram (AP) shows human habitation continuity before and after",
    },
    {
      year: "c. 40,000 BP",
      event: "Upper Palaeolithic phase — bone tools, blades, first evidence of art; sites at Bhimbetka, Renigunta, Patne",
    },
    {
      year: "c. 10,000 BP",
      event: "Mesolithic (Microlithic) Age begins — geometric microliths, rock paintings at Bhimbetka (UNESCO 2003), Adamgarh, Bagor",
    },
    {
      year: "c. 7000 BCE",
      event: "Neolithic revolution in the subcontinent — Mehrgarh (Balochistan) shows earliest evidence of farming, animal domestication, and mud-brick houses",
    },
    {
      year: "c. 5500 BCE",
      event: "Earliest known dentistry at Mehrgarh — drilled teeth of living patients; evidence of craft specialization",
    },
    {
      year: "c. 3000-1500 BCE",
      event: "Chalcolithic cultures flourish — Ahar-Banas, Jorwe, Malwa, Kayatha, Savalda in western and central India",
    },
    {
      year: "c. 2500-1800 BCE",
      event: "Burzahom and Gufkral Neolithic sites in Kashmir — distinctive pit-dwellings, polished stone tools, dog burials",
    },
    {
      year: "c. 1800-1000 BCE",
      event: "Megalithic and Iron Age cultures in South India — Hallur, Brahmagiri, Adichanallur; iron tools, distinctive burial practices",
    },
    {
      year: "c. 1200 BCE",
      event: "Painted Grey Ware (PGW) culture begins in the Indo-Gangetic plains; associated with Later Vedic and Mahabharata period",
    },
    {
      year: "c. 600 BCE",
      event: "Northern Black Polished Ware (NBPW) marks the second urbanization; iron technology widespread; overlaps with Buddha's era",
    },
  ],
  notes: [
    {
      section: "Lower Palaeolithic (c. 2 million - 100,000 BP)",
      content:
        "Lower Palaeolithic people made large core tools (hand-axes, cleavers, choppers) from quartzite. Robert Bruce Foote, the father of Indian prehistory, discovered the first Palaeolithic hand-axe at Pallavaram near Chennai in 1863. Attirampakkam (Tamil Nadu) has yielded Acheulian tools dated to around 1.5 million years ago, ranking it among the oldest Acheulian sites outside Africa. Other major sites include Hunsgi and Isampur (Karnataka, workshop sites with abundant debitage), Bhimbetka (Madhya Pradesh), Didwana (Rajasthan), and Bori (Maharashtra). The Sohan culture of Punjab (named after a Jhelum tributary) produced a distinct pebble-tool tradition (choppers and chopping tools) contemporary with the Acheulian. These hunter-gatherers occupied rock shelters and open-air camps, likely using fire in the later phase. Arun Sonakia discovered the only known Homo erectus skull cap from India at Hathnora in the Narmada Valley (MP) in 1982.",
    },
    {
      section: "Middle Palaeolithic (c. 100,000 - 40,000 BP)",
      content:
        "Middle Palaeolithic toolmakers shifted from core tools to flake tools: scrapers, borers, and points produced with the prepared-core (Levallois) technique. Tools grew smaller and more refined than in the Lower Palaeolithic. Key sites include Bhimbetka (Madhya Pradesh), Nevasa and Chirki-Nevasa (Maharashtra, Pravara River), Pushkar (Rajasthan), and locations along the Narmada, Godavari, and Krishna rivers. Craftspeople diversified raw materials, using jasper, chert, and chalcedony alongside quartzite. Rock shelters in the Vindhyan ranges saw increasing use as semi-permanent habitation sites. This phase roughly coincides with Europe\\'s Mousterian tradition. The Toba super-eruption (c. 74,000 BP, Sumatra) deposited volcanic ash across India; Jwalapuram (Andhra Pradesh) preserves habitation layers both before and after the ash, showing population continuity despite the catastrophe.",
    },
    {
      section: "Upper Palaeolithic (c. 40,000 - 10,000 BP)",
      content:
    ...
    {
      section: "Mesolithic / Microlithic Age (c. 10,000 - 4,000 BCE)",
      content:
    ...
    {
      section: "Neolithic Revolution — Mehrgarh & Northwest",
      content:
    ...
    {
      section: "Neolithic Sites Across India",
      content:
    ...
    {
      section: "Chalcolithic Age (c. 3000 - 700 BCE)",
      content:
    ...
    {
      section: "Iron Age & Painted Grey Ware (c. 1200 - 600 BCE)",
      content:
    ...
    {
      section: "South Indian Megalithic Culture (c. 1200 - 300 BCE)",
      content:
    ...
    {
      section: "Transition from Food-Gathering to Food-Producing",
      content:
    ...
    {
      section: "Wootz Steel & Early Metallurgy",
      content:
    ...
    {
      section: "Historiography & Key Scholars",
      content:
    ...
    {
      section: "Burial Practices & Social Organization",
      content:
  ...
  examTags: ["UPSC Prelims", "UPSC Mains", "SSC CGL", "RRB NTPC", "CDS", "UPPSC"],
  examRelevance:
