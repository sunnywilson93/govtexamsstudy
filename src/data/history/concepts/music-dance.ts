...
export const musicDanceConcept: HistoryConcept = {
  topic: "music-dance",
  title: "Music, Dance & Theatre",
  description:
    "Bharata\\u2019s Natyashastra (c. 2nd century BCE) anchors a performing arts tradition that today covers two classical music systems (Hindustani and Carnatic), eight Sangeet Natak Akademi-recognized classical dances, dozens of folk dances, and diverse theatre forms. UPSC Prelims regularly tests dance-state associations, Hindustani vs Carnatic distinctions, and folk dances of specific states. SSC and RRB papers demand quick recall on instruments, artists, and UNESCO Intangible Cultural Heritage inscriptions from India.",
  period: "Art & Culture",
  keyDates: [
    {
  ...
  notes: [
    {
      section: "Ancient Foundations: Natyashastra & Early Music Theory",
      content:
        "Bharata Muni\\u2019s Natyashastra (c. 2nd century BCE \\u2013 2nd century CE) serves as the foundational encyclopedic treatise on Indian performing arts, covering natya (drama), nritya (dance), and sangita (in the ancient sense: vocal music, instrumental music, and dance together). Key concepts: (1) Rasa theory \\u2014 8 rasas (shringara/love, hasya/humour, karuna/compassion, raudra/fury, vira/heroism, bhayanaka/terror, bibhatsa/disgust, adbhuta/wonder) arise from sthayi bhavas (permanent emotions), vyabhichari bhavas (transitory states), and anubhavas (physical expressions); Abhinavagupta later added the 9th rasa, shanta (peace). (2) 108 karanas \\u2014 basic dance units sculpted on temple walls (e.g., Chidambaram Nataraja Temple). (3) Three aspects of dance: nritta (pure rhythmic movement without narrative), nritya (expressive/interpretive dance conveying meaning), and natya (dramatic representation). (4) Svara system \\u2014 Shadja, Rishabha, Gandhara, Madhyama, Panchama, Dhaivata, Nishada (Sa-Ri-Ga-Ma-Pa-Dha-Ni). Other early texts: Dattilam (systematized jatis), Brihaddeshi by Matanga (first to define raga technically), and Naradiya Shiksha (Vedic intonation).",
    },
    {
      section: "Hindustani Music: Traditions & Gharanas",
      content:
        "Hindustani (North Indian classical) music diverged from the common tradition around the 13th\\u201314th century CE under Persian and Central Asian influence. Performance forms: (1) Dhrupad \\u2014 oldest and most austere; four sections: sthayi, antara, sanchari, abhoga; alap (raga exposition without rhythm) followed by composition set to pakhawaj; major gharanas: Dagar, Gwalior; the Dagar brothers revived it in the 20th century. (2) Khayal \\u2014 dominant today; two compositions: vilambit (slow) and drut (fast) set to tabla; major gharanas: Gwalior (oldest \\u2014 Haddu-Hassu Khan), Agra (layakari/rhythm \\u2014 Faiyaz Khan), Jaipur-Atrauli (complex ragas \\u2014 Alladiya Khan), Kirana (sustained notes \\u2014 Abdul Karim Khan, Bhimsen Joshi), Patiala (virtuosic taans \\u2014 Bade Ghulam Ali Khan). (3) Thumri \\u2014 romantic/devotional, semi-classical, tied to Lucknow and Banaras. (4) Tappa \\u2014 fast-paced, Punjab origin. (5) Tarana \\u2014 syllabic virtuoso piece attributed to Amir Khusrau. (6) Qawwali \\u2014 Sufi devotional form developed in Chishti shrines. Instruments by category: string (sitar, sarod, sarangi, santoor, been/rudra veena), wind (bansuri, shehnai), percussion (tabla, pakhawaj). The gharana system \\u2014 hereditary schools of musicianship \\u2014 drives Hindustani music\\u2019s transmission and identity.",
    },
    {
      section: "Carnatic Music: Theory & Composers",
      content:
    ...
    {
      section: "Bharatanatyam, Kathak & Odissi",
      content:
    ...
    {
      section: "Kathakali, Kuchipudi, Manipuri & Mohiniyattam",
      content:
    ...
    {
      section: "Sattriya & Other Semi-Classical/Tribal Dance Forms",
      content:
    ...
    {
      section: "Folk Dances: State-Wise Classification",
      content:
    ...
    {
      section: "Raga System: Hindustani Thaats & Carnatic Melakartas",
      content:
    ...
    {
      section: "Tala System & Rhythmic Structures",
      content:
    ...
    {
      section: "Traditional Theatre & Ritual Performance Forms",
      content:
    ...
    {
      section: "Key Musicians & Dancers: Ancient to Modern",
      content:
    ...
    {
      section: "Musical Instruments: Classification & Exam Facts",
      content:
    ...
    {
      section: "UNESCO Intangible Cultural Heritage from India",
      content:
    ...
    {
      section: "Music & Dance Patronage Through History",
      content:
    ...
    {
      section: "Exam-Critical: Dance-State-Feature Quick Reference",
      content:
