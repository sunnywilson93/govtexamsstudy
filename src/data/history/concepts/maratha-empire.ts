...
export const marathaEmpireConcept: HistoryConcept = {
  topic: "maratha-empire",
  title: "Maratha Empire",
  description:
    "Shivaji Maharaj built the Maratha Empire (1674\\u20131818 CE) from the western Deccan into a confederacy that dominated most of the subcontinent before its fall to the British. Exams focus heavily on the Ashtapradhan system, chauth and sardeshmukhi, Shivaji\\u2019s escape from Agra, and the Treaty of Purandar. The Third Battle of Panipat (1761), the Peshwa succession, and the three Anglo-Maratha Wars form the second high-frequency cluster. SSC and RRB papers target fort names, battles, and confederacy chiefs.",
  ...
  notes: [
    {
      section: "Background — The Deccan and Maratha Society",
      content:
        "The Marathas rose from the rocky Sahyadri (Western Ghats) terrain of the western Deccan, where hill ranges offered natural fortresses. Maratha society centred on agriculture and the patron-deity (Kuldaivat) system, and the Marathi language and identity had been developing since the Yadava dynasty of Devagiri (12th\\u201314th century). Maratha families gained military experience and administrative skill by serving the Deccani sultanates \\u2014 the Bijapur Sultanate (Adil Shahis) and the Ahmadnagar Sultanate (Nizam Shahis). Shahaji Bhonsle, Shivaji\\u2019s father, served both and held a jagir at Pune. Maharashtra\\u2019s Bhakti movement \\u2014 the Varkari tradition of Pandharpur led by Jnaneshwar, Namdev, Eknath, and Tukaram \\u2014 forged a Marathi cultural identity and spiritual egalitarianism that fuelled the political movement. Shivaji converted the Sahyadris\\u2019 scattered forts into a connected network of power projection.",
    },
    {
      section: "Shivaji's Rise & Early Campaigns",
      content:
        "Shivaji Bhonsle (1630\\u20131680) was born at Shivneri Fort; his mother Jijabai and estate manager Dadaji Konddev (his first tutor in administration and warfare) raised him. He captured Torna in 1645 at age 15, funding recruitment of Mavle hillsmen and Maval soldiers from his father\\u2019s jagir. By 1647 he held Raigad, Pratapgad, and Kondana. His ambitions alarmed Bijapur, which dispatched Afzal Khan with a large army. At the Battle of Pratapgad (1659) Shivaji met Afzal Khan under a tent and killed him with concealed weapons (wagh nakh/tiger claws and a bichwa dagger), then routed the Bijapur army and seized Panhala. In 1660, Aurangzeb sent Shaista Khan (his maternal uncle) with a Mughal force that occupied Pune. Shivaji launched a daring night raid on Shaista Khan\\u2019s residence at Lal Mahal, severing several of his fingers; Shaista Khan was recalled in disgrace. The two raids on Surat (1664, 1670) \\u2014 the richest Mughal port \\u2014 yielded enormous wealth and signalled Shivaji as a force the Mughals could no longer ignore.",
    },
    {
      section: "Shivaji's Encounters with the Mughals",
      content:
    ...
    {
      section: "Shivaji's Administration — The Ashtapradhan System",
      content:
    ...
    {
      section: "Shivaji's Fort Network and Navy",
      content:
    ...
    {
      section: "Post-Shivaji Period — Sambhaji to Shahu",
      content:
    ...
    {
      section: "Rise of the Peshwas — Balaji Vishwanath",
      content:
    ...
    {
      section: "Baji Rao I — The Greatest Maratha General",
      content:
    ...
    {
      section: "Maratha Confederacy and Later Peshwas",
      content:
    ...
    {
      section: "Third Battle of Panipat (1761) & Aftermath",
      content:
    ...
    {
      section: "Maratha Revenue System & Economy",
      content:
    ...
    {
      section: "The Anglo-Maratha Wars (1775-1818)",
      content:
    ...
    {
      section: "Maratha Administration — Provincial and Local",
      content:
    ...
    {
      section: "Maratha Culture, Religion and Society",
      content:
    ...
    {
      section: "Legacy and Historical Significance",
      content:
