...
export const britishExpansionConcept: HistoryConcept = {
  ...
  notes: [
    ...
    {
      section: "The Dual System and Plunder of Bengal (1765-1772)",
      content:
    ...
    {
      section: "Warren Hastings — Administration and Controversies",
      content:
    ...
    {
      section: "Cornwallis and the Permanent Settlement",
      content:
    ...
    {
      section: "Anglo-Burmese Wars and Southeast Asian Expansion",
      content:
    ...
    {
      section: "Lord Dalhousie — The Great Annexationist",
      content:
    ...
    {
      section: "Impact of British Expansion on Indian Society",
      content:
