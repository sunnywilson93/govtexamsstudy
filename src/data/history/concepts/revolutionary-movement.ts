...
export const revolutionaryMovementConcept: HistoryConcept = {
  topic: "revolutionary-movement",
  title: "Revolutionary Movement in India",
  description:
    "Indian revolutionaries organized armed struggle against British rule through Bengal\\'s Anushilan Samiti, North America\\'s Ghadar Party, Bhagat Singh\\'s HSRA, and Subhas Bose\\'s INA \\u2014 assassinating officials, raiding armouries, robbing government trains, and fielding an exile army in Burma. UPSC Prelims tests the Ghadar Party founding, Kakori Conspiracy participants, Chittagong Armoury Raid, and INA trial impact. SSC/RRB papers ask direct matching of revolutionaries with their organizations and actions; CDS gives special weight to INA military operations.",
  period: "Modern India",
  keyDates: [
    {
      year: "1897",
  ...
  notes: [
    {
      section: "Early Revolutionary Activities — Bengal Phase (1897-1910)",
      content:
        "Bengal produced India\\'s first revolutionary cells. Curzon\\'s partition of Bengal (1905) catalyzed the movement. Pramathanath Mitra founded the Anushilan Samiti (1902, Calcutta), and the breakaway Jugantar group (1906) formed under Aurobindo Ghosh and Barindra Kumar Ghosh. The Chapekar brothers assassinated Plague Commissioner W.C. Rand in Pune (1897) \\u2014 Damodar and Balkrishna were hanged. Khudiram Bose and Prafulla Chaki targeted Magistrate Kingsford at Muzaffarpur (1908) but the bomb killed two British women (Mrs. and Miss Kennedy); Khudiram was hanged at 18 years, 8 months, 8 days \\u2014 the youngest martyr. In the Alipore Bomb Case (1908), C.R. Das secured Aurobindo Ghosh\\'s acquittal, but Barindra Kumar Ghosh received a death sentence (later commuted to life). Aurobindo then withdrew to Pondicherry as a spiritual philosopher. Police discovered a bomb factory at Manicktolla Garden (Calcutta) and launched a major crackdown. Newspapers like Yugantar (Barindra\\'s), Sandhya (Brahmabandhab Upadhyay), and Kal (Shivaji) spread revolutionary ideas across Bengal.",
    },
    {
      section: "Revolutionary Activities Abroad — London and Europe",
      content:
        "Shyamji Krishna Varma (a wealthy Gujarat Sanskrit scholar) ran India House in London from 1905, published The Indian Sociologist, and funded scholarships to bring Indian students. V.D. Savarkar (1883-1966) dominated the London circle \\u2014 he founded the Abhinav Bharat Society (1904, Nashik), studied law in London, and wrote The Indian War of Independence 1857 (published 1909 \\u2014 the first nationalist interpretation of 1857, banned before publication; copies smuggled into India). Madan Lal Dhingra, a Punjab student in the India House circle, assassinated Sir William Curzon Wyllie (political aide-de-camp to the Secretary of State for India) at a London event on 1 July 1909 and was hanged on 17 August 1909; his trial statement ranks among the most powerful declarations of Indian nationalism. During World War I, Har Dayal, Virendranath Chattopadhyaya (Sarojini Naidu\\'s brother), and Chempakaraman Pillai formed the Berlin Committee to secure German support for an Indian uprising. The Silk Letters Conspiracy (1916) saw Deoband-linked scholar Mahmud-ul-Hasan plan an Afghan-Turkish-German attack on British India.",
    },
    {
      section: "Ghadar Party — The Overseas Revolution",
      content:
        "Lala Har Dayal (a former Oxford scholar and anarchist) and president Sohan Singh Bhakna founded the Ghadar Party in San Francisco in 1913. Punjabi immigrants \\u2014 mostly Sikh farm workers in California, Oregon, and British Columbia \\u2014 formed its base. The party published Ghadar in Urdu, Punjabi, Hindi, Bengali, Gujarati, and other languages, calling for armed revolution. Smugglers carried the newspaper into India and distributed it among soldiers and emigrant communities. When World War I broke out (1914), thousands of Ghadarites sailed home to launch an uprising. They planned to infiltrate the Indian army, coordinate German-Turkish support, and trigger a simultaneous revolt on 21 February 1915 \\u2014 but informers betrayed them. British intelligence crushed the Ghadar Conspiracy, and the Lahore Conspiracy Case (1915) sent many to the gallows or prison. Kartar Singh Sarabha was hanged at 19 (Bhagat Singh kept his photograph); Vishnu Ganesh Pingle was hanged. The Komagata Maru incident (1914) inflamed sentiment further: a Japanese ship carrying 376 Sikh, Muslim, and Hindu passengers was turned away from Vancouver under the \\'continuous journey\\' regulation, and British police fired on the returning passengers at Budge Budge near Calcutta, killing 20.",
    },
    {
      section: "Hindustan Republican Association (HRA) and the Kakori Conspiracy",
      content:
    ...
    {
      section: "Bhagat Singh and HSRA — Ideology and Actions",
      content:
    ...
    {
      section: "Trial, Execution, and Legacy of Bhagat Singh",
      content:
    ...
    {
      section: "Chittagong Armoury Raid and Bengali Revolutionaries (1930s)",
      content:
    ...
    {
      section: "Subhas Chandra Bose — From Congress to INA",
      content:
    ...
    {
      section: "Indian National Army (INA) — Formation and Campaigns",
      content:
    ...
    {
      section: "INA Trials and Their Impact on British Decision to Leave India",
      content:
    ...
    {
      section: "Meerut Conspiracy Case and the Communist Connection",
      content:
    ...
    {
      section: "Delhi Conspiracy Case and the Hardinge Bomb (1912)",
      content:
    ...
    {
      section: "Women in the Revolutionary Movement",
      content:
    ...
    {
      section: "Revolutionary Literature and Ideology",
      content:
    ...
    {
      section: "Assessment — Impact and Significance of the Revolutionary Movement",
      content:
