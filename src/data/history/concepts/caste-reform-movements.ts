...
export const casteReformMovementsConcept: HistoryConcept = {
  topic: "caste-reform-movements",
  title: "Caste Reform Movements",
  description:
    "From the 19th century onward, reformers like Jyotirao Phule, Periyar, Sri Narayana Guru, and B.R. Ambedkar attacked the caste system, untouchability, and Brahmanical hegemony. Exams test reformer-organisation pairs (Phule\\u2014Satyashodhak Samaj, Ambedkar\\u2014Mahad Satyagraha), the Poona Pact provisions (1932), and Constitutional articles on untouchability (Article 17) and reservations (Articles 15, 16, 46). These movements secured education, political representation, and legal protections for oppressed castes and reshaped modern Indian democracy.",
  period: "Modern India",
  keyDates: [
    {
      year: "1848",
      event: "Jyotirao Phule and Savitribai Phule open the first school for untouchable girls at Pune — pioneering caste and gender reform simultaneously",
    },
    {
      year: "1873",
      event: "Jyotirao Phule founds the Satyashodhak Samaj (Truth-Seeking Society) — challenges Brahmanical dominance, promotes Shudra-Ati-Shudra education and self-respect",
    },
    {
      year: "1899",
      event: "Sri Narayana Guru consecrates the Shiva temple at Aruvippuram (Kerala) — a revolutionary act as he was an Ezhava (lower caste); his motto: 'One Caste, One Religion, One God'",
    },
    {
      year: "1925",
      event: "Periyar leads the Vaikom Satyagraha (started 1924) for temple entry in Travancore; later founds the Self-Respect Movement (1925) in Tamil Nadu",
    },
    {
      year: "1927",
      event: "Dr. B.R. Ambedkar leads the Mahad Satyagraha (Chavdar Tale) — lower castes assert their right to draw water from the public tank; Ambedkar burns Manusmriti",
    },
    {
      year: "1932",
      event: "Poona Pact between Gandhi and Ambedkar — replaces separate electorates (from Communal Award) with reserved seats within joint electorates for Depressed Classes",
    },
    {
      year: "1936",
      event: "Ambedkar publishes 'Annihilation of Caste' — radical critique of the caste system; calls for the destruction of caste as a system, not just reform of its abuses",
    },
    {
      year: "1956",
      event: "Ambedkar converts to Buddhism at Deekshabhoomi, Nagpur (October 14, 1956) with approximately 500,000 followers; dies on December 6, 1956",
    },
    {
      year: "1950",
      event: "Indian Constitution (authored by Ambedkar as Chairman of the Drafting Committee) abolishes untouchability (Article 17) and provides for reservations (Articles 15, 16, 46)",
    },
    {
      year: "1893",
      event: "Ayyankali's Villuvandi (Bullock Cart) agitation in Travancore — Pulayas assert their right to use public roads; landmark in Kerala's anti-caste struggle",
    },
    {
      year: "1924",
      event: "Vaikom Satyagraha begins (1924-25) in Travancore for temple road access for lower castes; supported by Periyar, Gandhi, and Sri Narayana Guru",
    },
    {
      year: "1936",
      event: "Temple Entry Proclamation of Travancore — Maharaja of Travancore opens all Hindu temples to all castes; culmination of Kerala Renaissance movements",
    },
    {
      year: "1920",
      event: "Ambedkar starts the Mooknayak newspaper — first of his publications to articulate Dalit concerns and political rights",
    },
    {
      year: "1930",
      event: "First Round Table Conference — Ambedkar represents the Depressed Classes; argues for separate electorates and political safeguards",
    },
    {
      year: "1990",
      event: "V.P. Singh implements Mandal Commission recommendations — 27% reservation for OBCs; triggers massive anti-reservation protests across India",
    },
  ],
  notes: [
    {
      section: "Jyotirao Phule & the Satyashodhak Movement",
      content:
        "Jyotirao Phule (1827-1890), born into the Mali (gardener) caste in Maharashtra, drew inspiration from Thomas Paine\\u2019s \\u2018Rights of Man\\u2019 and the French and American revolutions. With his wife Savitribai Phule (1831-1897, considered India\\u2019s first female teacher), he opened the first school for untouchable girls at Pune in 1848 \\u2014 an act that provoked the Brahmin establishment to ostracise the couple. He founded the Satyashodhak Samaj (Truth-Seeking Society) in 1873 to challenge Brahmanical monopoly over rituals, education, and social status. His thesis held that Aryan invaders imposed the caste system on indigenous Shudras and Ati-Shudras. Key works: Gulamgiri (Slavery, 1873 \\u2014 dedicated to freed Black Americans), Shetkaryacha Asud (on peasant exploitation), and Sarvajanik Satya Dharma. He also set up an orphanage (1863) to prevent infanticide and supported widow remarriage. Mahatma Gandhi later bestowed the title \\u2018Mahatma\\u2019 on Phule posthumously.",
    },
    {
      section: "Periyar E.V. Ramasamy & the Self-Respect Movement",
      content:
        "Periyar E.V. Ramasamy (1879-1973) quit the Congress in 1925 after witnessing caste segregation at V.V.S. Iyer\\u2019s Gurukulam in Cheranmahadevi. He founded the Self-Respect Movement (Suyamariyathai Iyakkam) in 1925, advocating rationalism, atheism, women\\u2019s rights, and complete abolition of the caste system. He organised the Vaikom Satyagraha (1924-25) for lower-caste road access near the Vaikom Mahadeva Temple and led the Anti-Hindi Agitation in Madras Presidency in 1938. He established the Dravidar Kazhagam (DK) in 1944, parent body of the DMK (founded by C.N. Annadurai in 1949). Core ideas: rejection of Brahmanical Hinduism, promotion of Dravidian identity and Tamil culture, women\\u2019s property and divorce rights, and inter-caste marriages. His newspaper Kudi Arasu spread these ideas across Tamil society. UNESCO named him \\u2018The Prophet of the New Age\\u2019 in 1970.",
    },
    {
      section: "Sri Narayana Guru & Kerala Renaissance",
      content:
    ...
    {
      section: "Dr. B.R. Ambedkar — Life & Thought",
      content:
    ...
    {
      section: "Ambedkar — Political Struggles & Constitutional Legacy",
      content:
    ...
    {
      section: "Other Caste Reform Leaders & Movements",
      content:
    ...
    {
      section: "Impact & Constitutional Provisions",
      content:
    ...
    {
      section: "Gandhi vs Ambedkar — The Great Debate on Caste",
      content:
    ...
    {
      section: "The Non-Brahmin Movement in South India",
      content:
    ...
    {
      section: "Dalit Literature and Cultural Assertion",
      content:
    ...
    {
      section: "Women in the Anti-Caste Movement",
      content:
    ...
    {
      section: "The Temple Entry Movement",
      content:
    ...
    {
      section: "Backward Classes Movement and the Mandal Commission",
      content:
    ...
    {
      section: "The Ad Dharm and Adi-Hindu Movements",
      content:
    ...
    {
      section: "Post-Independence Dalit Politics and Contemporary Movements",
      content:
    ...
    {
      section: "Exam Significance & Key Points",
      content:
  ...
  examTags: ["UPSC Prelims", "UPSC Mains", "SSC CGL", "SSC CHSL", "RRB NTPC", "CDS", "UPPSC", "MPSC"],
  examRelevance:
