...
export const britishEconomicPoliciesConcept: HistoryConcept = {
  topic: "british-economic-policies",
  title: "British Economic Policies in India",
  description:
    "British economic policies turned India from a global manufacturing leader into a raw-material supplier and captive market for Manchester goods. Exams test the three land revenue systems (Zamindari, Ryotwari, Mahalwari), the Drain of Wealth theory (Dadabhai Naoroji, R.C. Dutt), de-industrialization mechanics, and famine chronology. The commercialization of agriculture, the opium trade, and the destruction of cottage industries together devastated India\\u2019s economy and drove repeated famines from 1770 to 1943.",
  period: "Modern India",
  keyDates: [
    {
      year: "1765",
  ...
  notes: [
    {
      section: "Drain of Wealth Theory",
      content:
        "Dadabhai Naoroji first articulated the Drain of Wealth theory in an 1867 paper and expanded it in \\u2018Poverty and Un-British Rule in India\\u2019 (1901). He demonstrated that India\\u2019s national wealth flowed to Britain with no adequate return through: (1) Home Charges \\u2014 the Secretary of State\\u2019s office, pensions, and interest on public debt held in Britain; (2) profits and dividends of British companies operating in India; (3) salaries of British officers remitted home; (4) India\\u2019s trade surplus, which could not be reinvested domestically. R.C. Dutt estimated the annual drain at 30-40 million pounds in his \\u2018Economic History of India\\u2019 (1901). William Digby, M.G. Ranade, and G.V. Joshi reinforced this critique.",
    },
    {
      section: "Land Revenue Systems",
      content:
        "The British imposed three land revenue systems. (1) Permanent Settlement / Zamindari System (1793, Lord Cornwallis) \\u2014 applied in Bengal, Bihar, Orissa, and parts of northern Madras; fixed revenue in perpetuity at 89% of rental (Zamindar kept 11%); made Zamindars proprietors responsible for collection; created an absentee landlord class with no incentive to improve agriculture. (2) Ryotwari System (1820, Thomas Munro in Madras; Elphinstone extended it to Bombay) \\u2014 settled directly with the ryot (cultivator) at 50% of gross produce; no intermediary; covered about 51% of British India. (3) Mahalwari System (1822, Holt Mackenzie) \\u2014 applied in NW Provinces, Punjab, and Central Provinces; settled revenue with the village community (mahal) collectively; allowed periodic revision; covered about 30% of British India.",
    },
    {
      section: "De-industrialization",
      content:
        "British policies systematically destroyed India\\u2019s traditional handicraft industries. Before colonialism, Indian textiles \\u2014 muslin, calico, chintz \\u2014 commanded global demand. Three mechanisms wrecked this base: (1) import duties of up to 80% on Indian textiles entering Britain, while British machine-made goods entered India duty-free or at nominal rates; (2) elimination of the artisan class \\u2014 weavers, spinners, and dyers lost their livelihoods; (3) reduction of India to a raw-material exporter (cotton, jute, indigo, opium) and a finished-goods importer. Karl Marx described the process as \\u2018bleeding India white.\\u2019 The legend of Dhaka muslin weavers having their thumbs cut remains debated, but the destruction of Indian handicrafts is well-documented. By 1880, India imported 51% of its cotton cloth from Britain.",
    },
    {
    ...
    {
      section: "Famines Under British Rule",
      content:
    ...
    {
      section: "Economic Critics and Nationalist Response",
      content:
    ...
    {
      section: "Railways, Telegraph and Infrastructure — Dual Character",
      content:
    ...
    {
      section: "Opium Trade and the China Connection",
      content:
    ...
    {
      section: "Indigo, Jute and Plantation Economy",
      content:
    ...
    {
      section: "Monetary Policy and Currency Manipulation",
      content:
    ...
    {
      section: "Cottage Industries and Artisan Displacement",
      content:
    ...
    {
      section: "Peasant Indebtedness and the Moneylender Problem",
      content:
    ...
    {
      section: "India's Share of World Economy — Quantitative Decline",
      content:
    ...
    {
      section: "Forest Policies and Tribal Displacement",
      content:
