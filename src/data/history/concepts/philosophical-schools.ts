...
export const philosophicalSchoolsConcept: HistoryConcept = {
  topic: "philosophical-schools",
  title: "Schools of Indian Philosophy",
  description:
    "UPSC Prelims regularly tests school-founder pairs, the number of pramanas each school accepts, the Astika/Nastika distinction, and the three Vedanta sub-schools (Advaita, Vishishtadvaita, Dvaita). The six orthodox schools (Samkhya, Yoga, Nyaya, Vaisheshika, Mimamsa, Vedanta) accept Vedic authority; the three heterodox schools (Buddhism, Jainism, Charvaka) reject it. SSC CGL/CHSL asks basic matching of schools to founders and key concepts. Mains GS-I and GS-IV draw on these systems for questions on Indian intellectual contributions and ethical frameworks.",
  period: "Ancient India",
  keyDates: [
    {
      year: "c. 800-600 BCE",
      event: "Upanishadic period — foundational metaphysical ideas (Brahman, Atman, Karma, Moksha) developed in Brihadaranyaka, Chandogya, and other early Upanishads",
    },
    {
      year: "c. 600 BCE",
      event: "Rise of Shramana traditions — Buddha (c. 563-483 BCE), Mahavira (c. 540-468 BCE), and materialist Charvaka challenge Vedic orthodoxy",
    },
    {
      year: "c. 500 BCE",
      event: "Kapila traditionally credited as founder of Samkhya — oldest systematic philosophical school; dualism of Purusha (consciousness) and Prakriti (matter)",
    },
    {
      year: "c. 400 BCE",
      event: "Panini's Ashtadhyayi systematizes Sanskrit grammar; Gautama (Akshapada) composes Nyaya Sutras on logic and epistemology",
    },
    {
      year: "c. 200 BCE",
      event: "Patanjali composes Yoga Sutras — codifies the eight limbs of yoga (Ashtanga Yoga); Jaimini's Mimamsa Sutras on Vedic ritual interpretation",
    },
    {
      year: "c. 200 CE",
    ...
    {
      year: "c. 788-820 CE",
      event: "Adi Shankaracharya revives Advaita Vedanta — establishes four mathas at Sringeri, Dwarka, Puri, and Joshimath; commentaries on Brahma Sutras, Upanishads, and Bhagavad Gita",
    },
    {
      year: "c. 1017-1137 CE",
  ...
  notes: [
    {
      section: "Samkhya — Dualistic Metaphysics",
      content:
        "Sage Kapila founded Samkhya, the oldest systematic Indian philosophical school. It posits a fundamental dualism: Purusha (pure consciousness, passive witness) and Prakriti (primordial matter, active creative force). Prakriti holds three gunas in equilibrium: Sattva (purity/knowledge), Rajas (activity/passion), and Tamas (inertia/ignorance). Proximity to Purusha disturbs that equilibrium and triggers evolution (parinama), producing 23 evolutes in sequence: Mahat (cosmic intellect/Buddhi), Ahamkara (ego), Manas (mind) + five Jnanendriyas (sense organs) + five Karmendriyas (action organs) + five Tanmatras (subtle elements), and finally five Mahabhutas (earth, water, fire, air, ether). These 23 evolutes plus Purusha and Prakriti form the 25 tattvas. Samkhya remains atheistic (Nirisvara) and does not posit a creator God. Discriminative knowledge (Viveka) that separates Purusha from Prakriti delivers liberation (Kaivalya). Ishvarakrishna\\'s Samkhya Karika (c. 4th-5th century CE) survives as the earliest text. Samkhya deeply influenced Yoga, Ayurveda, and the Bhagavad Gita.",
    },
    {
      section: "Yoga — Path of Discipline & Meditation",
      content:
        "Patanjali (Yoga Sutras, c. 2nd century BCE) built on Samkhya\\'s metaphysics but added Ishvara (God) as a special Purusha never bound by Prakriti, making Yoga a theistic (Seshvara) system. He defined Yoga as \\'Chitta Vritti Nirodha\\' (cessation of mental modifications) and laid out Ashtanga Yoga (eight limbs): Yama (ahimsa, satya, asteya, brahmacharya, aparigraha), Niyama (saucha, santosha, tapas, svadhyaya, Ishvara pranidhana), Asana, Pranayama, Pratyahara, Dharana, Dhyana, and Samadhi. The 196 sutras divide into four chapters: Samadhi Pada, Sadhana Pada, Vibhuti Pada, and Kaivalya Pada. Patanjali also identified five Kleshas (afflictions): Avidya (ignorance), Asmita (ego), Raga (attachment), Dvesha (aversion), and Abhinivesha (fear of death). UNESCO declared Yoga an Intangible Cultural Heritage on December 1, 2016; June 21 has been observed as International Day of Yoga since 2015, proposed by India at the UN General Assembly.",
    },
    {
      section: "Nyaya — Logic & Epistemology",
      content:
        "Nyaya, founded by Gautama (also called Akshapada), is the Indian school of logic and epistemology. The Nyaya Sutras (c. 4th century BCE) establish four valid means of knowledge (Pramanas): Pratyaksha (perception), Anumana (inference), Upamana (comparison/analogy), and Shabda (verbal testimony from reliable sources). Nyaya developed a sophisticated system of formal logic, including the five-membered syllogism (Panchavayava): Pratijna (proposition), Hetu (reason), Udaharana (example), Upanaya (application), and Nigamana (conclusion). Example: 'The hill has fire (pratijna), because it has smoke (hetu), wherever there is smoke there is fire as in a kitchen (udaharana), the hill has smoke (upanaya), therefore the hill has fire (nigamana).' This five-step inference is more elaborate than the Aristotelian three-step syllogism. Later Nyaya (Navya-Nyaya), developed by Gangesha Upadhyaya of Mithila (c. 13th century CE), became the standard logical method used across all Indian philosophical schools. Nyaya is theistic — it argues for God's existence through the design argument (the universe's order implies an intelligent creator). The school profoundly influenced Indian legal reasoning, debate culture (Vaada), and scientific methodology.",
    },
    {
      section: "Vaisheshika — Atomism & Natural Philosophy",
      content:
        "Vaisheshika, attributed to Kanada (also called Kashyapa), is India's atomistic and natural philosophy school. It categorizes all reality into six (later seven) Padarthas (categories): Dravya (substance), Guna (quality), Karma (action), Samanya (generality), Vishesha (particularity — hence the school's name), Samavaya (inherence), and Abhava (absence, added later). Nine eternal substances are enumerated: earth (prithvi), water (ap), fire (tejas), air (vayu), ether (akasha), time (kala), space (dik), soul (atman), and mind (manas). The school's most distinctive contribution is its atomic theory: all physical objects are composed of indivisible, eternal atoms (paramanu). Two atoms combine to form a dvyanuka (dyad), three dyads form a tryanuka (triad), and so on to create perceptible objects. Creation and destruction are processes of atomic combination and separation, governed by the unseen force of Adrishta (merit/demerit). Vaisheshika's atomism, developed independently of Greek atomism (Democritus), is remarkably modern in its conceptual framework. Prashastapada's Padarthadharmasamgraha (c. 6th century CE) and Udayana's Kiranavali are important later texts. Vaisheshika eventually merged with Nyaya to form the Nyaya-Vaisheshika school.",
    },
    {
      section: "Mimamsa — Vedic Hermeneutics & Ritual",
      content:
        "Mimamsa (Purva Mimamsa), founded by Jaimini (author of Mimamsa Sutras, c. 200 BCE), is the school of Vedic exegesis (interpretation) focused on the Karma Kanda (ritual portion) of the Vedas. It develops elaborate principles for interpreting Vedic injunctions (Vidhis) and resolving apparent contradictions in Vedic texts. Key epistemological contribution: Mimamsa accepts six Pramanas — Pratyaksha, Anumana, Shabda, Upamana, Arthapatti (presumption), and Anupalabdhi (non-apprehension). The school upholds Svataḥ Pramanya (intrinsic validity of knowledge) — all cognitions are valid unless proven otherwise. Kumarila Bhatta (c. 7th century CE) and Prabhakara were the two most important Mimamsa philosophers — Kumarila's critique of Buddhist epistemology was instrumental in the Brahmanical intellectual resurgence. Mimamsa is philosophically realist (the world is real, not illusion) and originally atheistic — it holds that the Vedas are eternal, authorless (Apaurusheya), and self-validating, requiring no divine author. The efficacy of ritual (Yajna) produces results through Apurva (unseen potency). Mimamsa's hermeneutical principles (like Shat-Tarka — six modes of interpretation) deeply influenced Hindu law (Dharmashastra) and were used by legal scholars like Vijnaneshvara (Mitakshara) and Jimutavahana (Dayabhaga) for interpreting legal texts.",
    },
    {
      section: "Vedanta — Culmination of Vedic Thought",
      content:
    ...
    },
    {
      ...
      content:
        "UPSC frequently tests: matching schools with founders (Kapila-Samkhya, Patanjali-Yoga, Gautama/Akshapada-Nyaya, Kanada-Vaisheshika, Jaimini-Mimamsa, Badarayana-Vedanta); identifying the number of Pramanas each school accepts (Charvaka: 1, Vaisheshika and Buddhism: 2, Samkhya: 3, Nyaya: 4, Mimamsa: 6); distinguishing Astika from Nastika; the three sub-schools of Vedanta (Advaita, Vishishtadvaita, Dvaita) and their proponents; Samkhya's 25 tattvas and three gunas; and Patanjali's Ashtanga Yoga. Common traps: Samkhya is atheistic despite being Astika (it accepts Vedic authority but not God); Yoga is Samkhya plus God; Mimamsa is originally atheistic; Vaisheshika's atomism is different from Greek atomism (it includes non-material atoms and divine agency). The concept of Apaurusheya (Vedas being authorless) is distinctive to Mimamsa. Nyaya's five-membered syllogism versus Aristotle's three-membered syllogism is a comparison question. SSC/RRB focus on basic matching — school, founder, key concept. For Mains GS-IV (Ethics), the ethical principles of different schools (Yoga's Yamas, Jainism's non-violence) are relevant.",
    },
  ],
  examTags: ["UPSC Prelims", "UPSC Mains", "SSC CGL", "RRB NTPC", "CDS", "UPPSC", "NDA"],
  examRelevance:
    "High-priority for UPSC Prelims — matching schools with founders, identifying pramanas, distinguishing Astika/Nastika, and Vedanta sub-schools are recurring questions. UPSC Mains GS-I asks about the contribution of Indian philosophical traditions to world thought. SSC CGL/CHSL frequently test basic school-founder pairs and key concepts (Samkhya's gunas, Yoga's eight limbs). Understanding Nyaya logic is relevant for UPSC GS-IV (Ethics paper) and reasoning-based questions.",
}
