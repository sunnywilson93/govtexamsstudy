...
export const nationBuildingConcept: HistoryConcept = {
  topic: "nation-building",
  title: "Nation Building & Economic Development",
  description:
    "India combined democratic governance with planned economic development after independence, moving from Nehru\\u2019s socialist model and Five Year Plans through the Green and White Revolutions to the landmark LPG reforms of 1991. UPSC Prelims draws on Five Year Plan highlights, Green/White Revolution details, and 1991 reform specifics. SSC and banking exams target NITI Aayog vs Planning Commission, revolution-person matching, and key economic policies. The topic overlaps heavily with GS-III (Indian Economy) for UPSC Mains.",
  ...
  notes: [
    {
      section: "Nehruvian Socialism & Mixed Economy (1947-1964)",
      content:
        "Nehru pursued a \\u2018socialistic pattern of society\\u2019 \\u2014 a mixed economy where the public sector commanded strategic industries (\\u2018commanding heights\\u2019) while private enterprise operated elsewhere. The Industrial Policy Resolution 1948 sorted industries into four categories: (1) State monopoly (arms, atomic energy, railways); (2) State-initiated with permitted private participation (coal, iron, aircraft, telephones \\u2014 6 industries); (3) State-regulated private sector; (4) Unrestricted private sector. The Industries (Development and Regulation) Act 1951 created the License Raj \\u2014 private companies needed government licences to set up, expand, or shift production. The IPR 1956 (often called the \\u2018Economic Constitution\\u2019) reserved 17 Schedule A industries exclusively for the state and earmarked 12 Schedule B industries for progressive state entry. Nehru drew on the Soviet model but rejected total state control; the Bombay Plan (1944, by J.R.D. Tata, G.D. Birla, and others) had already envisaged a large role for state planning. Key public sector enterprises launched: Hindustan Steel, Heavy Engineering Corporation, Bharat Heavy Electricals, Indian Oil Corporation. The guiding philosophy combined self-reliance (import substitution), balanced regional development, and prevention of monopoly concentration.",
    },
    {
      section: "Five Year Plans: Key Features & Turning Points",
      content:
        "The Planning Commission (established 1950, PM as chair) formulated Five Year Plans with NDC approval. First Plan (1951\\u201356): used the Harrod-Domar model; targeted agriculture, irrigation (Bhakra-Nangal, Damodar Valley, Hirakud), and post-Partition rehabilitation; aimed at 2.1% growth, achieved 3.6%. Second Plan (1956\\u201361): adopted P.C. Mahalanobis\\u2019s two-sector model; prioritized heavy industry; raised steel plants at Bhilai (USSR), Durgapur (UK), Rourkela (Germany); strained the balance of payments. Third Plan (1961\\u201366): targeted self-reliance at 5.6% growth but achieved only 2.4% after the 1962 China war, 1965 Pakistan war, and severe drought (1965\\u201366). Plan Holidays (1966\\u201369): three Annual Plans replaced the cycle; the rupee was devalued (1966) under US/World Bank pressure. Fourth Plan (1969\\u201374): introduced \\u2018growth with stability\\u2019; Garibi Hatao slogan. Fifth Plan (1974\\u201379): stressed poverty alleviation and self-reliance; launched the Minimum Needs Programme. Sixth Plan (1980\\u201385): technology-driven growth. Seventh Plan (1985\\u201390): most successful (achieved 6% growth), focusing on productivity and food-grain output. Eighth Plan (1992\\u201397): first under the liberalized regime, emphasizing human development. Ninth through Twelfth Plans progressively shifted toward inclusive growth, infrastructure, and sustainability. Twelve plans ran before NITI Aayog\\u2019s three-year Action Agenda replaced the system in 2017.",
    },
    {
      section: "Green Revolution: Transformation & Critique",
      content:
    ...
    {
      section: "White Revolution, Blue Revolution & Other Revolutions",
      content:
    ...
    {
      section: "Bank Nationalization & Financial Inclusion",
      content:
    ...
    {
      section: "LPG Reforms of 1991: Context, Content & Impact",
      content:
    ...
    {
      section: "Land Reforms & Agrarian Policy",
      content:
    ...
    {
      section: "Industrial Policy Evolution: From License Raj to Make in India",
      content:
    ...
    {
      section: "Poverty Alleviation & Social Sector Programmes",
      content:
    ...
    {
      section: "Science, Technology & Space Programme",
      content:
    ...
    {
      section: "NITI Aayog, GST & Recent Economic Reforms",
      content:
    ...
    {
      section: "Integration of Princely States & Linguistic Reorganization",
      content:
    ...
    {
      section: "Foreign Policy: Non-Alignment, Wars & Strategic Autonomy",
      content:
    ...
    {
      section: "Social Reforms: Education, Health & Reservation Policy",
      content:
    ...
    {
      section: "Cooperative Federalism & Decentralization",
      content:
    ...
    {
      section: "Exam-Critical: Quick Facts & Matching Table",
      content:
  ...
  examTags: ["UPSC Prelims", "UPSC Mains", "SSC CGL", "RRB NTPC", "CDS", "IBPS PO"],
  examRelevance:
