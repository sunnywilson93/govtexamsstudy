...
export const bhaktiSufiConcept: HistoryConcept = {
  topic: "bhakti-sufi",
  title: "Bhakti & Sufi Movements",
  description:
    "The Bhakti movement championed personal devotion to God, rejected caste rigidity and empty ritual, and produced literature in regional languages from Tamil to Punjabi. Sufi orders \\u2014 especially the Chishtis \\u2014 brought mystical, devotional Islam to India and drew followers across religious lines. Exams frequently test saint-work-philosophy pairings (Saguna vs Nirguna, Advaita vs Dvaita), Sufi order characteristics, and Guru Granth Sahib contributors. Together these movements built the syncretic culture that still shapes Indian society.",
  ...
  notes: [
    {
      section: "Origins & Features of the Bhakti Movement",
      content:
        "The Alvars (12 Vaishnavite saints) and Nayanars (63 Shaivite saints) launched the Bhakti movement in Tamil Nadu between the 7th and 9th centuries. The Alvars composed the Nalayira Divya Prabandham; the Nayanars composed the Tevaram and Tiruvachakam. The movement spread northward from the 14th to 17th centuries. Core features: (1) direct personal devotion without priestly intermediaries; (2) rejection of caste discrimination \\u2014 saints rose from every social stratum (Ravidas a cobbler, Kabir a weaver, Namdev a tailor); (3) use of regional languages instead of Sanskrit; (4) two streams \\u2014 Saguna (God with form, e.g., Rama or Krishna) and Nirguna (formless God, e.g., Kabir, Nanak); (5) opposition to empty rituals and superstitions.",
    },
    {
      section: "Major Bhakti Saints of North India",
      content:
        "Ramananda (14th-15th century) bridged South and North Indian Bhakti by accepting disciples from every caste \\u2014 Kabir, Ravidas, Sena, and Pipa among them. Kabir (c. 1398-1448), a Muslim weaver in Varanasi, rejected both Hindu and Muslim orthodoxy, denounced caste and idolatry, and left his verses in the Bijak and the Guru Granth Sahib. Ravidas (Raidas), a chamar (cobbler), preached social equality and is revered by the Ravidassia community today. Tulsidas (1532-1623) composed the Ramcharitmanas in Awadhi, bringing Ram bhakti to the masses; he also wrote Vinay Patrika and Kavitavali. Surdas (1478-1583), a blind poet, celebrated Krishna\\u2019s childhood (Bal Leela) in Braj Bhasha through the Sur Sagar. Mirabai (1498-1546), a Rajput princess of Mewar, defied social norms through total devotion to Krishna.",
    },
    {
      section: "Bhakti Movement in Maharashtra & South India",
      content:
        "The Varkari tradition in Maharashtra centred on Vithoba (Vishnu) worship at Pandharpur. Dnyaneshwar (1275-1296) wrote the Dnyaneshwari, a Marathi commentary on the Bhagavad Gita. Namdev (1270-1350), a tailor-saint, contributed verses to the Guru Granth Sahib. Eknath (1533-1599) promoted social equality through the Eknathi Bhagavat, and Tukaram (1608-1649) composed thousands of abhangas, earning recognition as the greatest Marathi Bhakti poet. In Karnataka, Basavanna (12th century) founded the Lingayat (Virashaiva) movement, rejecting caste, Vedic authority, and rebirth; Lingayat saints composed Vachana literature in Kannada. Shankaracharya (Advaita), Ramanujacharya (Vishishtadvaita), and Madhvacharya (Dvaita) laid the philosophical foundations for Bhakti across South India.",
    },
    {
      section: "Sufi Movement — Orders & Saints",
      content:
    ...
    {
      section: "Sufi Beliefs & Practices",
      content:
    ...
    {
      section: "Social Impact & Syncretic Legacy",
      content:
    ...
    {
      section: "Philosophical Schools — Advaita to Dvaita",
      content:
    ...
    {
      section: "Guru Nanak and the Foundations of Sikhism",
      content:
    ...
    {
      section: "Amir Khusrau — The Bridge Between Cultures",
      content:
    ...
    {
      section: "Nizamuddin Auliya and the Golden Age of Chishtis",
      content:
    ...
    {
      section: "Women Saints in the Bhakti-Sufi Tradition",
      content:
    ...
    {
      section: "Regional Variations of the Bhakti Movement",
      content:
    ...
    {
      section: "Sufi Literature and Intellectual Contributions",
      content:
    ...
    {
      section: "Dargahs, Pilgrimage and Composite Culture",
      content:
    ...
    {
      section: "Bhakti Movement and Language Development",
      content:
    ...
    {
      section: "Exam-Critical Distinctions and Common Traps",
      content:
