...
export const heritageSitesConcept: HistoryConcept = {
  topic: "heritage-sites",
  title: "UNESCO World Heritage Sites in India",
  description:
    "India holds 42 UNESCO World Heritage Sites (34 cultural, 7 natural, 1 mixed) and ranks 6th globally. UPSC Prelims asks 1-2 questions nearly every year \\u2014 targeting recently inscribed sites (2021-2024), site-state matching, natural vs cultural classification, and the only mixed site (Khangchendzonga). SSC and RRB exams test site-location pairs and animal-park associations. Knowing the first four inscriptions (1983: Agra Fort, Ajanta, Ellora, Taj Mahal), the Tentative List process, and Intangible Cultural Heritage entries alongside World Heritage Sites covers the full exam spectrum.",
  period: "Art & Culture",
  keyDates: [
    {
      year: "1972",
  ...
  notes: [
    {
      section: "UNESCO World Heritage Convention — Framework",
      content:
        "The World Heritage Convention (1972) identifies and protects sites of Outstanding Universal Value (OUV) \\u2014 heritage so exceptional it transcends national boundaries. A site must satisfy at least one of ten criteria (i-vi for cultural; vii-x for natural). The inscription process runs through four stages: (1) Tentative List submission (prerequisite); (2) formal nomination dossier; (3) evaluation by ICOMOS (cultural) or IUCN (natural); (4) decision by the 21-member World Heritage Committee at its annual session. India\\u2019s Tentative List holds 50+ sites awaiting nomination. Sites may be inscribed, deferred, referred back, or rejected. Endangered sites go on the World Heritage in Danger list, and States Parties must submit periodic conservation reports.",
    },
    {
      section: "Cultural Heritage Sites — Ancient & Archaeological",
      content:
        "India\\u2019s ancient and archaeological sites span the Indus Valley to the early medieval period. Dholavira (2021, Gujarat) ranks among the five largest Harappan cities, with sophisticated water management and a unique Indus-script signboard. Ajanta Caves (1983, Maharashtra) contain 30 Buddhist caves with paintings from the 2nd century BCE to 6th century CE; Caves 1 and 2 hold the finest Gupta-Vakataka paintings (Bodhisattva Padmapani). Ellora Caves (1983, Maharashtra) house 34 caves (12 Buddhist, 17 Hindu, 5 Jain; 6th-11th century CE); Cave 16 is the Kailasa Temple (Rashtrakuta), the world\\u2019s largest monolithic rock-cut structure. Sanchi Stupa (1989, MP) \\u2014 built by Ashoka, enlarged under the Shungas and Satavahanas \\u2014 has gateway toranas with the finest early Buddhist sculpture. Mahabodhi Temple Complex (2002, Bodh Gaya, Bihar) marks where the Buddha attained enlightenment. Nalanda Mahavihara (2016, Bihar) preserves ruins of the ancient Buddhist university (5th-12th century CE).",
    },
    {
      section: "Cultural Heritage Sites — Temple Architecture",
      content:
    ...
    {
      section: "Cultural Heritage Sites — Mughal & Medieval",
      content:
    ...
    {
      section: "Cultural Heritage Sites — Forts & Palaces",
      content:
    ...
    {
      section: "Cultural Heritage Sites — Colonial & Modern",
      content:
    ...
    {
      section: "Natural Heritage Sites",
      content:
    ...
    {
      section: "Mixed Heritage Site — Khangchendzonga",
      content:
    ...
    {
      section: "State-wise Distribution & Statistics",
      content:
    ...
    {
      section: "Tentative List & Nomination Process",
      content:
    ...
    {
      section: "Bhimbetka & Rock Art Heritage",
      content:
    ...
    {
      section: "Elephanta & Buddhist-Jain Cave Heritage",
      content:
    ...
    {
      section: "Comparative Indian Heritage — Living vs Archaeological",
      content:
    ...
    {
      section: "Danger List & Conservation Challenges",
      content:
    ...
    {
      section: "Intangible Cultural Heritage (UNESCO) — Connected Concept",
      content:
    ...
    {
      section: "Key Exam Trends & Pattern Analysis",
      content:
