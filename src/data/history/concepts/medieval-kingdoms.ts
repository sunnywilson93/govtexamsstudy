...
export const medievalKingdomsConcept: HistoryConcept = {
  topic: "medieval-kingdoms",
  title: "Other Medieval Kingdoms",
  description:
    "Rajput clans, the Sikh Gurus through Maharaja Ranjit Singh, and the Ahom kingdom of Assam shaped medieval India alongside the Delhi Sultanate, Vijayanagara, and the Mughals. UPSC Prelims regularly tests the ten Sikh Gurus and their contributions, the Khalsa, Lachit Borphukan\\u2019s victory at Saraighat, and Rajput resistance. SSC papers target the Battles of Tarain, Ranjit Singh\\u2019s empire, the five Ks, and Guru Granth Sahib compilation. State-level exams add detail on regional kingdoms like the Chandellas and Bundelas.",
  ...
  notes: [
    {
      section: "Rajput Kingdoms — Origins and Political Structure",
      content:
        "Rajput warrior clans dominated north-western and central India from the 7th to 12th centuries and remained politically significant throughout the medieval period. Their origin stays debated: the Agnikula (fire-pit) legend holds that Pratiharas, Chauhans, Paramaras, and Solankis emerged from a sacrificial fire on Mount Abu; the foreign-origin theory links some clans to Huns, Scythians, or Gurjaras assimilated into the Kshatriya varna through ritual; a third line argues indigenous tribal descent. Major clans: Gurjara-Pratiharas of Kannauj (who blocked the Arab advance from the west), Chahamanas (Chauhans) of Ajmer and Shakambhari, Solankis (Chalukyas) of Gujarat and Anhilwara, Paramaras of Malwa (Dhara), Chandellas of Bundelkhand (Mahoba and Kalinjar), Gahadavalas of Kannauj and Varanasi (Jayachandra rivalled Prithviraj), Rathores of Marwar (Jodhpur), Sisodias of Mewar (Chittor, later Udaipur), and Kachwahas of Amber (later Jaipur). Rajput polity ran on feudal lines \\u2014 the king granted jagirs to vassal chiefs (thakurs/rana/rawal) who owed military service and loyalty. Succession disputes frequently disrupted the system of primogeniture.",
    },
    {
      section: "Rajput Kingdoms — Military History and Key Battles",
      content:
        "Prithviraj Chauhan III (1178\\u20131192) won the First Battle of Tarain (1191) against Muhammad of Ghor but lost the Second Battle of Tarain (1192), opening North India to Turkish rule. Chand Bardai\\u2019s Prithviraj Raso (epic poem composed partly during and partly after Prithviraj\\u2019s time) glorifies his exploits. Rana Sanga (Sangram Singh) of Mewar united a Rajput confederacy but Babur defeated him at Khanwa (1527), claiming the title \\u2018Ghazi.\\u2019 Maharana Pratap (1540\\u20131597) fought the Battle of Haldighati (June 1576) against Akbar\\u2019s forces under Man Singh I; though defeated, he escaped on his horse Chetak and sustained guerrilla resistance from the Aravallis until his death, never submitting to Mughal authority. He recovered most of Mewar except Chittor and Mandalgarh. Most Rajput states accepted Mughal suzerainty: Amber (Jaipur), Bikaner, and Jaisalmer allied with Akbar through matrimonial alliances; Raja Bharmal of Amber gave his daughter (Harkha Bai/Jodha Bai) to Akbar in 1562. Mewar under Rana Sanga, Maharana Pratap, and later Raj Singh defied this trend. The Marwar succession dispute under Aurangzeb (1678\\u20131680) turned the Rathores against the Mughals.",
    },
    {
      section: "Rajput Culture, Architecture & Society",
      content:
    ...
    {
      section: "Sikhism — Guru Nanak's Teachings and Early Gurus",
      content:
    ...
    {
      section: "Sikh Gurus — Militarization and the Khalsa",
      content:
    ...
    {
      section: "The Khalsa — Institution and Code",
      content:
    ...
    {
      section: "Sikh Empire under Maharaja Ranjit Singh",
      content:
    ...
    {
      section: "Anglo-Sikh Wars and the End of the Sikh Empire",
      content:
    ...
    {
      section: "Ahom Kingdom of Assam (1228-1826)",
      content:
    ...
    {
      section: "Ahom Resistance to Mughal Invasions",
      content:
    ...
    {
      section: "Ahom Society, Culture and Decline",
      content:
    ...
    {
      section: "The Jat Kingdom and Other Regional Powers",
      content:
    ...
    {
      section: "Rajput-Mughal Relations — Alliance and Resistance",
      content:
    ...
    {
      section: "The Guru Granth Sahib — Scripture and Structure",
      content:
    ...
    {
      section: "Chandellas and Khajuraho — Architecture and Power",
      content:
    ...
    {
      section: "Sources and Historiography",
      content:
