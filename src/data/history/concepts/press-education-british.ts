...
export const pressEducationBritishConcept: HistoryConcept = {
  topic: "press-education-british",
  ...
  keyDates: [
    {
      year: "1780",
      event: "James Augustus Hicky starts the Bengal Gazette (Hicky's Gazette) — India's first newspaper; shut down by Warren Hastings in 1782 for its criticism of the government",
    },
    {
      year: "1813",
      event: "Charter Act of 1813 — allocates Rs 1 lakh annually for education in India; first official British commitment to Indian education",
    },
    {
      year: "1823",
      event: "Licensing Regulations (Press Regulation) by Acting Governor-General John Adams — requires licence to operate a press; repealed by Metcalfe in 1835",
    },
    {
      year: "1835",
      event: "Macaulay's Minute on Education (February 2, 1835) — decides in favour of English education; Anglicist-Orientalist controversy resolved; Metcalfe liberates the press",
    },
    {
      year: "1854",
      event: "Wood's Despatch (Charles Wood) — 'Magna Carta of English Education in India'; recommends universities, graded school system, grants-in-aid, vernacular education",
    },
    {
      year: "1857",
      event: "Universities of Calcutta, Bombay, and Madras established (modelled on London University) as affiliating and examining bodies",
    },
    {
      year: "1878",
      event: "Vernacular Press Act by Lord Lytton — targets Indian-language newspapers; exempts English-language press; repealed by Lord Ripon in 1882",
    },
    {
      year: "1882",
      event: "Hunter Commission (Indian Education Commission) — recommends expansion of primary and secondary education, private enterprise in education",
    },
    {
      year: "1904",
      event: "Indian Universities Act by Lord Curzon — centralizes university control; Curzon also convenes Shimla Education Conference (1901)",
    },
  ],
  notes: [
    {
      section: "Early Press in India (1780-1835)",
      content:
    ...
    {
      section: "Anglicist-Orientalist Debate & Macaulay's Minute",
      content:
    ...
    {
      section: "Wood's Despatch (1854) & University System",
      content:
    ...
    {
      section: "Press Controls — Vernacular Press Act & Beyond",
      content:
    ...
    {
      section: "Education Commissions & Reforms (1882-1944)",
      content:
    ...
    {
      section: "National Education Movement & Alternative Institutions",
      content:
    ...
    {
      section: "Role of Press in the National Movement",
      content:
