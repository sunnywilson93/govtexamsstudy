...
export const landRevenueSystemsConcept: HistoryConcept = {
  topic: "land-revenue-systems",
  title: "Land Revenue Systems under British",
  description:
    "Britain imposed three land revenue systems on India \\u2014 Permanent Settlement (1793), Ryotwari (1820), and Mahalwari (1822) \\u2014 each producing distinct landholding patterns and peasant exploitation that triggered major agrarian revolts. UPSC Prelims tests system-introducer-area matching almost every year, while Mains demands analytical essays on agrarian impact and the Drain Theory. SSC and RRB papers target the Sunset Clause, ownership structures, and area coverage percentages.",
  period: "Modern India",
  keyDates: [
    {
      year: "1765",
      event: "Company obtains Diwani (revenue collection rights) of Bengal, Bihar, and Orissa from Mughal Emperor Shah Alam II after the Battle of Buxar (1764)",
    },
    {
      year: "1769-70",
      event: "Great Bengal Famine — one-third of Bengal's population dies; revenue collection continues unabated, exposing the brutality of Company's dual government",
    },
    {
      year: "1772",
      event: "Warren Hastings introduces the Farming System — revenue collection auctioned to highest bidder for 5 years; widespread exploitation results",
    },
    {
      year: "1786",
      event: "Cornwallis arrives as Governor-General with instructions to reform revenue administration; begins preparations for permanent settlement",
    },
    {
      year: "1793",
      event: "Permanent Settlement (Zamindari System) introduced by Cornwallis in Bengal, Bihar, and Orissa — fixes land revenue demand in perpetuity with zamindars as proprietors",
    },
    {
      year: "1812",
      event: "Thomas Munro proposes the Ryotwari System in a report to the Governor of Madras, drawing on Captain Alexander Read's earlier experiments in the Baramahal (1792)",
    },
    {
      year: "1820",
      event: "Ryotwari System formally introduced by Thomas Munro as Governor of Madras Presidency — individual peasant (ryot) directly settles revenue with the state",
    },
    {
      year: "1822",
      event: "Mahalwari System introduced by Holt Mackenzie in the North-Western Provinces (UP, Punjab) — revenue settled with the village community (mahal) collectively",
    },
    {
      year: "1833",
      event: "Regulation VII — Mahalwari system refined by Robert Merttins Bird under Lord William Bentinck; settlement made for 30-year periods with periodic revision",
    },
    {
      year: "1855-1856",
      event: "Santhal Rebellion (Hul) — partly caused by exploitative revenue and money-lending systems; Santhals revolt against zamindars, money-lenders (mahajans), and British",
    },
    {
      year: "1859",
      event: "Bengal Rent Act (Act X of 1859) — first legislative attempt to define and protect ryot (tenant) rights in Bengal's zamindari areas",
    },
    {
      year: "1875",
      event: "Deccan Riots in Maharashtra — peasants attack moneylenders (sahukars) who had dispossessed them; leads to the Deccan Agriculturists' Relief Act (1879)",
    },
    {
      year: "1885",
      event: "Bengal Tenancy Act — gives occupancy ryots (tenants of 12+ years) rights against arbitrary eviction and rent enhancement",
    },
    {
      year: "1900",
      event: "Punjab Land Alienation Act — prevents transfer of agricultural land to non-agricultural classes (moneylenders), a landmark protective legislation",
    },
    {
      year: "1951",
      event: "First Amendment to the Constitution protects zamindari abolition laws through the Ninth Schedule; states begin implementing land ceiling legislation",
    },
  ],
  notes: [
    {
      section: "Pre-British Revenue Systems — Mughal Background",
      content:
        "The Mughal revenue system that the British replaced treated land revenue (mal/kharaj) as the state\\u2019s primary income, theoretically fixed at one-third of gross produce. Akbar\\u2019s Zabti/Dahsala system (designed by Raja Todar Mal) classified land into four categories by cultivation frequency (Polaj, Parauti, Chachar, Banjar) and fixed revenue on 10-year average prices. Zamindars collected revenue as hereditary intermediaries with a commission (nankar), not as owners; the cultivator (ryot) held occupancy rights and could not be arbitrarily evicted. Bengal\\u2019s revenue machinery decayed after Aurangzeb\\u2019s death. When the Company acquired Diwani in 1765, it inherited a crumbling system. The \\u2018dual government\\u2019 (1765\\u20131772) \\u2014 where the Company held revenue power while the Nawab bore administrative responsibility \\u2014 Governor Verelst called \\u2018a government of duplicity.\\u2019 This chaos fed the Great Bengal Famine (1769\\u201370), killing roughly 10 million people \\u2014 one-third of Bengal\\u2019s population.",
    },
    {
      section: "Permanent Settlement / Zamindari System (1793)",
      content:
        "Lord Cornwallis introduced the Permanent Settlement in Bengal, Bihar, and Orissa in 1793; John Shore (later Lord Teignmouth) designed it. Key features: (1) Zamindars gained recognition as land proprietors, not merely revenue collectors as under the Mughals. (2) The revenue demand stayed fixed permanently \\u2014 it could never rise regardless of climbing prices or output. The state took 10/11th of collected revenue; zamindars retained 1/11th. (3) Any zamindar who missed the sunset deadline forfeited his estate at auction (Sunset Clause). Cornwallis drew justification from Physiocratic theory and the British landlord model, expecting secure property rights to motivate estate improvement. In practice, the 1790\\u201391 assessment set an excessively high base (inflated by famine-recovery collections). The Sunset Clause destroyed many old zamindari families and replaced them with commercial buyers who owed nothing to tenants. Cultivators became tenants-at-will with no legal protection \\u2014 rack-renting, arbitrary eviction, and forced labour (begar) spread across the region. The system covered about 19% of British India\\u2019s total area.",
    },
    {
      section: "Consequences of the Permanent Settlement",
      content:
    ...
    {
      section: "Other Revenue Experiments and Minor Systems",
      content:
    ...
    {
      section: "Commercialization of Agriculture",
      content:
    ...
    {
      section: "Impact on Indian Agrarian Society",
      content:
    ...
    {
      section: "The Drain of Wealth & Revenue Burden",
      content:
    ...
    {
      section: "Famines and the Revenue Connection",
      content:
    ...
    {
      section: "Peasant Resistance & Legislative Reforms",
      content:
    ...
    {
      section: "Revenue Systems in Southern and Princely India",
      content:
    ...
    {
      section: "Comparative Analysis of Three Systems",
      content:
    ...
    {
      section: "Post-Independence Land Reforms",
      content:
    ...
    {
      section: "Key Thinkers and Their Critiques",
      content:
    ...
    {
      section: "Exam-Specific Points & Common Questions",
      content:
  ...
  examTags: ["UPSC Prelims", "UPSC Mains", "SSC CGL", "SSC CHSL", "RRB NTPC", "CDS", "UPPSC"],
  examRelevance:
