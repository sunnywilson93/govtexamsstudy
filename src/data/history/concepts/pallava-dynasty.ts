...
export const pallavaDynastyConcept: HistoryConcept = {
  topic: "pallava-dynasty",
  title: "Pallava Dynasty & Architecture",
  description:
    "The Pallavas ruled from Kanchipuram (c. 275-897 CE) and pioneered the Dravidian temple style whose UNESCO-listed monuments at Mamallapuram appear frequently in UPSC Prelims. Exams test the rock-cut vs structural temple distinction (Mahendravarman I vs Narasimhavarman II), the Five Rathas, Shore Temple, and the Pallava-Chalukya rivalry. The Pallava Grantha script gave rise to Southeast Asian scripts (Khmer, Thai, Javanese), making it a staple Mains GS-I question on India\\'s cultural influence abroad.",
  period: "Ancient India",
  keyDates: [
    {
      year: "c. 275 CE",
      event: "Simhavishnu establishes Pallava power in the Tondaimandalam region with capital at Kanchipuram",
    },
    {
      year: "c. 550-600 CE",
      event: "Simhavishnu defeats the Kalabhras and consolidates Pallava imperial power; patron of Bharavi (Kiratarjuniyam)",
    },
    {
      year: "c. 600-630 CE",
      event: "Reign of Mahendravarman I — begins rock-cut architecture tradition; patron of art; authored Mattavilasa Prahasana (Sanskrit farce)",
    },
    {
      year: "c. 630-668 CE",
      event: "Reign of Narasimhavarman I (Mahamalla) — defeats Chalukya Pulakeshin II; commissions the Mamallapuram monuments (Five Rathas, Shore Temple area)",
    },
    {
      year: "642 CE",
      event: "Narasimhavarman I captures Vatapi (Badami) from the Chalukyas — takes the title 'Vatapikonda' (Conqueror of Vatapi)",
    },
    {
      year: "c. 640 CE",
      event: "Xuanzang (Hiuen Tsang) visits Kanchipuram during Narasimhavarman I's reign; describes it as a city of a hundred temples",
    },
    {
      year: "c. 668-680 CE",
      event: "Parameshvaravarman I fights back Chalukya Vikramaditya I; Pallava-Chalukya rivalry intensifies in the second generation",
    },
    {
      year: "c. 700-728 CE",
      event: "Reign of Narasimhavarman II (Rajasimha) — builds the Shore Temple at Mamallapuram and Kailasanatha Temple at Kanchipuram",
    },
    {
      year: "c. 700 CE",
      event: "Kailasanatha Temple at Kanchipuram completed — earliest structural (built-up) Pallava temple; precursor to Dravidian structural temples",
    },
    {
      year: "c. 730 CE",
      event: "Nandivarman II ascends the throne — Pallava power begins to wane; constructs Vaikuntha Perumal Temple at Kanchipuram",
    },
    {
      year: "c. 733 CE",
      event: "Chalukya Vikramaditya II captures Kanchipuram but spares the temples; builds Virupaksha Temple at Pattadakal modelled on Kailasanatha",
    },
    {
      year: "c. 850 CE",
      event: "Nandivarman III increasingly dependent on Chola support; Pallava autonomy declining as Chola and Pandya power rises",
    },
    {
      year: "897 CE",
      event: "Aparajitavarman, last Pallava king, defeated by the Chola ruler Aditya I — end of the Pallava dynasty",
    },
  ],
  notes: [
    {
      section: "Origins & Early History",
      content:
        "Historians debate three origin theories: the Pallavas rose locally from the Tondaimandalam region (northern Tamil Nadu and southern Andhra Pradesh); they branched off from the Satavahanas or their feudatories; or they descended from the Pahlavas (Parthians) who migrated south. The earliest Pallava records are Prakrit charters of the 3rd century CE, later replaced by Sanskrit charters as the dynasty adopted North Indian Brahmanical culture. Their capital Kanchipuram (Kanchi) ranked among the seven sacred cities (Sapta Puri) and grew into a major learning centre; Xuanzang (Hiuen Tsang), visiting in the 7th century, described it as a city of a hundred temples. Early Pallavas served as vassals of, or clashed with, the Satavahanas, Ikshvakus, and Kadambas. Simhavishnu (c. 550-600 CE) launched the imperial phase by crushing the Kalabhras, a shadowy dynasty that had disrupted the traditional Tamil kingdoms.",
    },
    {
      section: "Mahendravarman I — Rock-Cut Architecture Pioneer",
      content:
        "Mahendravarman I (c. 600-630 CE) initiated South India\\'s rock-cut temple tradition by carving mandapas (pillared halls) directly from granite hillsides. He built the first Pallava rock-cut temple at Mandagapattu, where a famous inscription declares it was raised \\'without bricks, timber, metal, or mortar.\\' Other sites include Mahendravadi, Mamandur, Dalavanur, Tiruchirappalli, and Siyamangalam, all featuring the characteristic Pallava lion-base (Simha-karna) pillars. Initially a Jain, Mahendravarman converted to Shaivism under the influence of the saint Appar (Tirunavukkarasar). He authored the Mattavilasa Prahasana, a witty Sanskrit one-act farce satirizing Buddhist, Shaiva, and Kapalika monks and one of the earliest surviving Indian comedies. Pulakeshin II of the Chalukyas defeated him at the Battle of Pullalur, igniting a Pallava-Chalukya rivalry that shaped South Indian politics for over a century.",
    },
    {
      section: "Narasimhavarman I & Mamallapuram",
      content:
        "Narasimhavarman I (c. 630-668 CE), titled Mahamalla (\\'great wrestler\\'), avenged his father by capturing the Chalukya capital Vatapi (Badami) in 642 CE, earning the title Vatapikonda (Conqueror of Vatapi). His general Paranjothi (later the Shaiva saint Siruthondar) led the campaign that killed Pulakeshin II. Narasimhavarman also dispatched two naval expeditions to Sri Lanka to restore King Manavarma to the throne. He commissioned the Mamallapuram monuments (named after his title) south of Chennai, including: the Pancha Rathas (Five Rathas) carved from single granite boulders, each in a distinct architectural style; Arjuna\\'s Penance (or Descent of the Ganga), the world\\'s largest open-air rock relief (27 m x 9 m) depicting elephants, sages, and celestial beings; and numerous cave temples (Varaha, Mahishasuramardini, Trimurti mandapas). Xuanzang visited Kanchipuram during his reign.",
    },
    {
      section: "Shore Temple & Structural Architecture",
      content:
    ...
    {
      section: "Pallava Administration & Society",
      content:
    ...
    {
      section: "Pallava-Chalukya Rivalry",
      content:
    ...
    {
      section: "Art, Literature & Religious Patronage",
      content:
    ...
    {
      section: "Pallava Sculpture & Iconography",
      content:
    ...
    {
      section: "The Five Rathas — Architectural Analysis",
      content:
    ...
    {
      section: "Southeast Asian Influence & Legacy",
      content:
    ...
    {
      section: "Kanchipuram — The City of a Thousand Temples",
      content:
    ...
    {
      section: "Tamil Bhakti Movement under the Pallavas",
      content:
    ...
    {
      section: "Pallava Economy & Maritime Trade",
      content:
  ...
  examTags: ["UPSC Prelims", "UPSC Mains", "SSC CGL", "RRB NTPC", "CDS", "TNPSC"],
  examRelevance:
