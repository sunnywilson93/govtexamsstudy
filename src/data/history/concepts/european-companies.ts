...
export const europeanCompaniesConcept: HistoryConcept = {
  topic: "european-companies",
  title: "European Trading Companies in India",
  description:
    "European trading companies arrived in India seeking spices and textiles but steadily seized political power through military force, diplomacy, and exploitation of rivalries among Indian rulers. The Portuguese (1498), Dutch, English, French, and Danes each built distinct commercial and territorial networks across the subcontinent. Exams test factory-location pairs, the sequence of European arrivals, Carnatic War treaties, and Charter Act provisions. The Battle of Plassey (1757) and Battle of Buxar (1764) remain the most frequently asked turning points in Modern Indian History.",
  period: "Modern India",
  keyDates: [
    {
      year: "1498",
  ...
  notes: [
    {
      section: "Portuguese in India — Early Phase",
      content:
        "Vasco da Gama reached Calicut in 1498, guided by the Arab navigator Abdul Majid (Ibn Majid). The Zamorin of Calicut welcomed him, but Arab traders resisted the Portuguese presence. Da Gama returned in 1502 with a larger fleet and bombarded Calicut. Pedro Alvares Cabral (1500) set up the first Portuguese factory at Calicut, lost it to Arab merchants, and relocated to Cochin. The Portuguese built their first fort at Cochin in 1503 under Alfonso de Albuquerque (then a captain, not yet governor). They fortified the entire Malabar Coast, combined trade with Jesuit missionary work \\u2014 Francis Xavier arrived in Goa in 1542 \\u2014 and imposed the Goa Inquisition (1560) to enforce Catholic orthodoxy through forced conversions.",
    },
    {
      section: "Portuguese Governors — Almeida to Albuquerque",
      content:
        "Francisco de Almeida (1505-09), the first Portuguese Viceroy, pursued the Blue Water Policy (Cartaze system) to dominate the seas rather than acquire territory. He crushed the combined Egyptian-Gujarati fleet at the Battle of Diu (1509). Alfonso de Albuquerque (1509-15) captured Goa from the Sultan of Bijapur in 1510, earning the title \\u2018real founder of the Portuguese empire in India.\\u2019 He shifted strategy from naval supremacy to territorial control, encouraged Portuguese-Indian intermarriage, abolished Sati in Goa, built the Basilica of Bom Jesus, and attempted to seize Aden and Hormuz to lock down the Red Sea and Persian Gulf routes. Nino da Cunha (1529-38) moved the capital from Cochin to Goa in 1530 and annexed Bassein and Diu. Martin Afonso de Sousa (1542-45) brought Jesuit missionaries including Francis Xavier.",
    },
    {
      section: "Portuguese Contributions & Decline",
      content:
        "The Portuguese brought the printing press to India (first press at Goa, 1556; first book: Conclusoes e outras coisas) and introduced tobacco, cashew, potato, chili, papaya, pineapple, guava, and custard apple. They built the first European hospital in India at Goa. The Cartaz system forced every Indian Ocean vessel to buy a Portuguese pass or face confiscation \\u2014 essentially a protection racket. Decline set in after the union of Portuguese and Spanish crowns (1580), which dragged Portugal into Spain\\u2019s wars. The Dutch seized Portuguese spice posts in Southeast Asia (Malacca 1641, Ceylon by 1658). The Marathas under Shivaji and later the Peshwas captured western coastal territories. By the 18th century, Portuguese control shrank to Goa, Daman, and Diu, which India liberated through Operation Vijay (1961).",
    },
    {
      section: "Dutch East India Company (VOC)",
      content:
    ...
    {
      section: "English East India Company — Foundation & Early Expansion",
      content:
    ...
    {
      section: "English Conquest of Bengal — Plassey to Buxar",
      content:
    ...
    {
      section: "French East India Company",
      content:
    ...
    {
      section: "The Three Carnatic Wars",
      content:
    ...
    {
      section: "Danish East India Company",
      content:
    ...
    {
      section: "Reasons for British Success over Other Europeans",
      content:
    ...
    {
      section: "Anglo-Mysore Wars — Contest with Haidar Ali & Tipu Sultan",
      content:
    ...
    {
      section: "Trade Patterns & Economic Impact",
      content:
    ...
    {
      section: "Charter Acts & EIC Governance",
      content:
    ...
    {
      section: "Portuguese Estado da India — Administrative Structure",
      content:
    ...
    {
      section: "Impact on Indian Maritime Trade",
      content:
    ...
    {
      section: "Five French Settlements in India (Post-1763)",
      content:
