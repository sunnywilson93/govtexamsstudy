...
export const mauryaEmpireConcept: HistoryConcept = {
  topic: "maurya-empire",
  title: "Maurya Empire & Ashoka",
  description:
    "Chandragupta Maurya and Kautilya (Chanakya) founded the Maurya Empire (c. 321\\u2013185 BCE), the first state to unify most of the Indian subcontinent under centralized rule. Ashoka\\u2019s Dhamma policy and rock edicts rank among the earliest documented experiments in ethical governance. UPSC Prelims targets edict content, Mauryan administration from the Arthashastra and Indica, and the Kalinga War almost every year. SSC and RRB papers test the Chandragupta\\u2013Seleucus treaty, Megasthenes\\u2019 Indica, and the Sarnath Lion Capital as India\\u2019s national emblem.",
  ...
  notes: [
    {
      section: "Chandragupta Maurya — Rise to Power",
      content:
        "Chandragupta Maurya overthrew the last Nanda ruler Dhana Nanda around 321 BCE, guided by his mentor Chanakya (Kautilya/Vishnugupta). Sources differ on Chandragupta\\u2019s origin: the Puranas place him in the Moriya clan (low-born), while Buddhist texts (Mahavamsa) call the Moriyas Kshatriyas related to the Shakya clan. Chanakya \\u2014 reportedly a Brahmin from Taxila insulted at the Nanda court \\u2014 recruited Chandragupta, trained him, and forged alliances among frontier tribes (possibly including remnants of Alexander\\u2019s garrisons). The strategy conquered frontier regions first and then advanced inward to Pataliputra, reversing an earlier failed direct assault. After toppling the Nandas, Chandragupta expelled the Greek garrisons Alexander left in the northwest (before Alexander\\u2019s death in 323 BCE). Greek sources call him \\u2018Sandrokottos\\u2019 \\u2014 William Jones\\u2019s identification of Sandrokottos with Chandragupta in 1793 anchored Indian chronology to the well-dated Greek timeline.",
    },
    {
      section: "War with Seleucus and Foreign Relations",
      content:
        "Chandragupta defeated Seleucus Nicator around 305 BCE and secured a treaty heavily in his favour: Seleucus ceded Aria (Herat), Arachosia (Kandahar), Gedrosia (Balochistan), and the Paropamisadae (Kabul) \\u2014 effectively all of eastern Afghanistan and parts of modern Pakistan. In return, Chandragupta gave 500 war elephants (Seleucus deployed them to win the Battle of Ipsus in 301 BCE). The two rulers also formed a marriage alliance (likely Seleucus\\u2019s daughter married into the Mauryan family). Seleucus dispatched Megasthenes as ambassador to Pataliputra. Megasthenes wrote \\u2018Indica,\\u2019 describing the capital, administration, and society; though the original is lost, fragments survive in Strabo, Arrian, and Diodorus. He records Pataliputra as a city protected by a wooden palisade with 570 towers and 64 gates, administered by a 30-member committee in 6 boards of 5 each. Later Greek ambassadors included Deimachos (under Bindusara) and Dionysius (under Ashoka, sent by Ptolemy II of Egypt).",
    },
    {
      section: "Chandragupta's Later Life and Bindusara",
      content:
    ...
    {
      section: "Ashoka — Accession and the Kalinga War",
      content:
    ...
    {
      section: "Ashoka's Dhamma — Principles and Policy",
      content:
    ...
    {
      section: "Ashoka's Edicts — Classification and Content",
      content:
    ...
    {
      section: "Ashoka's Missionary Activities",
      content:
    ...
    {
      section: "Mauryan Administration — Central Government",
      content:
    ...
    {
      section: "Mauryan Administration — Provincial and Local",
      content:
    ...
    {
      section: "Mauryan Army and Military Organization",
      content:
    ...
    {
      section: "Mauryan Art and Architecture",
      content:
    ...
    {
      section: "Sources for Mauryan History",
      content:
    ...
    {
      section: "Decline of the Maurya Empire",
      content:
    ...
    {
      section: "Significance of the Maurya Empire",
      content:
    ...
    {
      section: "The Arthashastra — Kautilya's Political Philosophy",
      content:
