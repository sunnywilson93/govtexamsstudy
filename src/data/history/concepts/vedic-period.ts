...
export const vedicPeriodConcept: HistoryConcept = {
  topic: "vedic-period",
  title: "Vedic Period",
  description:
    "Indo-Aryan culture took root during the Vedic Period (c. 1500\\u2013600 BCE), first in the Sapta Sindhu (Punjab) region during the Early/Rig Vedic phase (c. 1500\\u20131000 BCE) and then across the Gangetic plains during the Later Vedic phase (c. 1000\\u2013600 BCE), producing the four Vedas, the Upanishads, the varna system, and the Sabha-Samiti assemblies. UPSC Prelims frequently tests differences between Early and Later Vedic society, Vedic literature hierarchy (Veda \\u2192 Brahmana \\u2192 Aranyaka \\u2192 Upanishad), and varna evolution. SSC/RRB papers ask which Veda is oldest, the Purusha Sukta, names of assemblies, and the Battle of Ten Kings.",
  ...
  notes: [
    {
      section: "Vedic Literature — The Four Vedas",
      content:
        "Four Vedas form the core: Rig Veda (1,028 suktas in 10 mandalas \\u2014 the oldest text in any Indo-European language), Sama Veda (melodies/chants, the \\'Book of Chants,\\' mostly drawn from Rig Veda hymns), Yajur Veda (sacrificial formulae, split into Shukla/White and Krishna/Black recensions), and Atharva Veda (spells, charms, speculative hymns \\u2014 named after Atharvan priests, reflecting folk religion and early medicine). Mandalas II\\u2013VII of the Rig Veda are the oldest (\\'family books\\'), composed by priestly families (Gritsamada, Vishvamitra, Vamadeva, Atri, Bharadvaja, Vasishtha); Mandalas I and X are the latest additions. Mandala X contains the Purusha Sukta (origin of varnas), the Nasadiya Sukta (creation hymn \\u2014 \\'Who really knows? Who will here proclaim it?\\'), and the Devi Sukta. Collectively the Vedas are Shruti (heard \\u2014 divine revelation), distinct from Smriti (remembered \\u2014 human-composed literature).",
    },
    {
      section: "Vedic Literature — Brahmanas, Aranyakas, Upanishads",
      content:
        "Each Veda carries associated prose commentaries. Brahmanas explain rituals in detail: Shatapatha Brahmana (Yajur Veda \\u2014 the most important, containing the Manu-Flood legend, Pururava-Urvashi stories, and Ashvamedha descriptions), Aitareya and Kaushitaki (Rig Veda), Tandya/Panchavimsha (Sama Veda), Gopatha (Atharva Veda). Aranyakas (\\'forest texts\\') were composed for hermits unable to perform elaborate rituals and stress the symbolic meaning of sacrifice. Upanishads (\\'sitting near a teacher\\') culminate each Veda philosophically \\u2014 tradition recognizes 108, of which 13 are principal (mukhya). Core concepts: Brahman (ultimate reality), Atman (individual soul), Tat Tvam Asi (\\'Thou art that\\' \\u2014 Chandogya), Aham Brahmasmi (\\'I am Brahman\\' \\u2014 Brihadaranyaka), Neti-neti (\\'Not this, not this\\'), Karma, Samsara (rebirth cycle), and Moksha (liberation). The Upanishads mark the shift from Karmakanda (ritual action) to Jnanakanda (knowledge/wisdom).",
    },
    {
      section: "Vedangas and Auxiliary Literature",
      content:
    ...
    {
      section: "Early Vedic Society & Polity",
      content:
    ...
    {
      section: "Rivers and Geography of the Rig Vedic Period",
      content:
    ...
    {
      section: "Later Vedic Polity & Administration",
      content:
    ...
    {
      section: "Varna System & Social Structure",
      content:
    ...
    {
      section: "Women in the Vedic Period",
      content:
    ...
    {
      section: "Religion & Philosophy — Early Vedic",
      content:
    ...
    {
      section: "Religion & Philosophy — Later Vedic",
      content:
    ...
    {
      section: "Economy & Material Culture — Early Vedic",
      content:
    ...
    {
      section: "Economy & Material Culture — Later Vedic",
      content:
    ...
    {
      section: "Archaeological Correlations",
      content:
    ...
    {
      section: "The Aryan Question — Debates and Evidence",
      content:
