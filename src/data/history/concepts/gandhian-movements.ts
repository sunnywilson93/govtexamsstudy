...
export const gandhianMovementsConcept: HistoryConcept = {
  topic: "gandhian-movements",
  title: "Gandhian Era & Mass Movements",
  description:
    "Gandhi turned the freedom struggle from an elite political movement into a mass revolution by deploying Satyagraha (truth-force), Ahimsa (non-violence), and Swaraj (self-rule) as organizing principles. Non-Cooperation (1920-22), Civil Disobedience (1930-34), and Quit India (1942) each mobilized millions of peasants, women, workers, and students against British rule. Exams test the chronology of movements, specific triggers (salt law for CDM, Chauri Chaura for NCM withdrawal), the Poona Pact, and Bardoli Satyagraha details. Matching movements with their causes, features, and outcomes is one of the most common question formats across UPSC, SSC, and RRB papers.",
  period: "Modern India",
  keyDates: [
    {
      year: "1893-1914",
  ...
  notes: [
    {
      section: "Gandhi in South Africa (1893-1914)",
      content:
        "Gandhi arrived in South Africa in 1893 as a lawyer for a Muslim merchant firm. Being thrown off a first-class train at Pietermaritzburg radicalized him. He founded the Natal Indian Congress (1894), set up Tolstoy Farm (1910), and led passive resistance against the Asiatic Registration Act (Black Act, 1907) and the poll tax on indentured labourers. He launched the newspaper Indian Opinion (1903) and forged the philosophy of Satyagraha \\u2014 \\u2018truth-force,\\u2019 distinct from passive resistance. Key influences: Tolstoy (The Kingdom of God is Within You), Ruskin (Unto This Last, which he translated into Gujarati as Sarvodaya), Thoreau (Civil Disobedience), the Bhagavad Gita, and the Sermon on the Mount. The Smuts-Gandhi Agreement (1914) partially addressed Indian grievances. Gandhi left South Africa in 1914, transformed from a timid lawyer into a confident political leader.",
    },
    {
      section: "Early Satyagrahas in India (1917-18)",
      content:
        "Champaran Satyagraha (1917) \\u2014 Gandhi\\u2019s first civil disobedience in India. Indigo cultivators in Champaran (Bihar) were forced under the tinkathia system to grow indigo on 3/20th of their land at prices fixed by European planters. Gandhi investigated conditions, defied the government\\u2019s expulsion order, and compelled an inquiry committee that abolished the tinkathia system. Rajendra Prasad, Mazharul Haq, and J.B. Kripalani joined him here. Kheda Satyagraha (1918): peasants in Kheda (Gujarat) demanded revenue remission after crop failure; Gandhi organized a no-revenue campaign and Sardar Patel emerged as a leader; the government eventually told revenue officials to accept payments only from those who could afford them. Ahmedabad Mill Strike (1918): Gandhi intervened in a dispute over the withdrawal of a plague bonus, used his first hunger strike, and secured a 35% wage increase. Anasuya Sarabhai (sister of mill owner Ambalal Sarabhai) backed the workers. These three campaigns established Gandhi\\u2019s credentials and methods before he entered the national stage.",
    },
    {
      section: "Rowlatt Satyagraha & Jallianwala Bagh (1919)",
      content:
        "The Rowlatt Act (March 1919), based on Justice Sidney Rowlatt\\u2019s recommendations, allowed detention without trial and trials without juries \\u2014 Gandhi called it a \\u2018Black Act.\\u2019 He launched the Rowlatt Satyagraha, his first all-India agitation, with a hartal on 6 April 1919. On 13 April 1919 (Baisakhi day) in Amritsar, General Reginald Dyer ordered troops to fire on an unarmed crowd inside Jallianwala Bagh (a walled enclosure with limited exits), killing an officially estimated 379 people (Indian estimates: over 1,000) and wounding over 1,200. Dyer then imposed crawling orders on certain streets and carried out public floggings. The Hunter Committee (1919-20) censured Dyer but took no serious action. Rabindranath Tagore renounced his knighthood in protest; Udham Singh later assassinated Michael O\\u2019Dwyer (the Punjab Lieutenant-Governor who backed Dyer) in London in 1940. The massacre turned Gandhi from a loyalist into a determined opponent of the Raj.",
    },
    {
      section: "Non-Cooperation Movement (1920-22)",
      content:
    ...
    {
      section: "Post-NCM Developments (1922-29)",
      content:
    ...
    {
      section: "Civil Disobedience Movement (1930-34)",
      content:
    ...
    {
      section: "Round Table Conferences & Communal Award",
      content:
    ...
    {
      section: "Quit India Movement (1942)",
      content:
    ...
    {
      section: "Gandhi's Philosophy & Key Concepts",
      content:
    ...
    {
      section: "Gandhi & the Congress Organization",
      content:
    ...
    {
      section: "The Constructive Programme",
      content:
    ...
    {
      section: "Bardoli Satyagraha & Peasant Movements",
      content:
    ...
    {
      section: "Subhas Chandra Bose & the INA",
      content:
    ...
    {
      section: "Gandhi's Role in Partition & Final Days",
      content:
    ...
    {
      section: "Legacy & Historical Assessment",
      content:
    ...
    {
      section: "Key Legislation & Context",
      content:
