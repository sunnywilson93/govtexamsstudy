...
export const postIndependenceConsolidationConcept: HistoryConcept = {
  topic: "post-independence-consolidation",
  title: "Post-Independence Consolidation (1947-64)",
  description:
    "India framed its Constitution (1950), held the world\\'s largest democratic elections (1951-52), launched Five Year Plans under the Mahalanobis model, and reorganized states on linguistic lines during 1947-1964. UPSC Prelims tests matching steel plants with foreign collaborators (Bhilai-USSR, Rourkela-Germany, Durgapur-UK), the Fazl Ali Commission (1953), Panchsheel (1954), and Potti Sreeramulu\\'s sacrifice. Mains GS-I and GS-II draw on Nehruvian economic policy, nation-building challenges after Partition, and the 1962 Sino-Indian War\\'s impact on non-alignment.",
  ...
  keyDates: [
    ...
    {
      year: "1951-1952",
      event: "First General Elections — world's largest democratic exercise; INC wins 364/489 seats; Nehru becomes PM; Sukumar Sen is the first Chief Election Commissioner",
    },
    {
      year: "1951",
    ...
    {
      year: "1964",
      event: "Death of Jawaharlal Nehru (May 27, 1964); Lal Bahadur Shastri succeeds as PM; end of the Nehruvian era",
    },
  ],
  notes: [
    {
      section: "Partition, Violence & Refugee Rehabilitation",
      content:
        "Partition (August 15, 1947) displaced an estimated 12-15 million people across the new India-Pakistan borders and killed between 200,000 and 2 million. Punjab and Bengal bore the heaviest toll: entire villages faced massacre, armed groups abducted an estimated 75,000-100,000 women on both sides, and refugee trains reached destinations with all passengers dead. Gandhi spent partition day fasting in Calcutta to quell Hindu-Muslim violence; his presence is credited with preventing major bloodshed in Bengal. The Rehabilitation Ministry (under K.C. Neogy, later Ajit Prasad Jain) set up refugee camps across northern India, and in Delhi authorities allocated Muslim properties to incoming refugees, permanently reshaping the city\\'s demographics. Nathuram Godse, a Hindu nationalist linked to the Hindu Mahasabha, assassinated Gandhi on January 30, 1948 at Birla House, Delhi, opposing his perceived pro-Muslim stance. The government banned the RSS (later lifted) and hardened its commitment to a secular state.",
    },
    {
      section: "The Constitution & Democratic Foundations",
      content:
        "The Constituent Assembly (elected 1946, 299 members after Partition reduced the original 389) framed the Constitution over 2 years, 11 months, and 18 days. Dr. B.R. Ambedkar chaired the Drafting Committee alongside Alladi Krishnaswamy Ayyar, N. Gopalaswami Ayyangar, K.M. Munshi, and T.T. Krishnamachari. The framers drew from multiple sources: the British Westminster parliamentary model, the US Bill of Rights (Fundamental Rights), Irish Directive Principles, Canadian federal structure with a strong centre, and the Government of India Act 1935 (which supplied most of the administrative framework). The Constitution took effect on January 26, 1950, the date chosen to honour the 1930 Purna Swaraj resolution. Key features include a federal structure with unitary bias, parliamentary system, fundamental rights (Part III), directive principles (Part IV), single citizenship, an independent judiciary, and secularism (the words \\'secular\\' and \\'socialist\\' entered the Preamble via the 42nd Amendment, 1976). Chief Election Commissioner Sukumar Sen oversaw the first general elections (1951-52), the world\\'s largest democratic exercise: 173 million eligible voters, 45% turnout, with ballot boxes bearing party symbols for the largely illiterate electorate.",
    },
    {
    ...
    {
      section: "Nehruvian Economic Model & Five Year Plans",
      content:
    ...
    {
      section: "Institutional Building & Scientific Temper",
      content:
    ...
    {
      section: "Social Legislation & Reforms",
      content:
