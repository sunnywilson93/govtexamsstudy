...
export const fairsFestivalsConcept: HistoryConcept = {
  topic: "fairs-festivals",
  title: "Fairs & Festivals of India",
  description:
    "India\\u2019s fairs and festivals span religious, seasonal, tribal, and commemorative traditions across every region and community. SSC and RRB exams test festival-state matching in almost every paper, while UPSC Prelims targets UNESCO-recognized festivals, Kumbh Mela sites, and harvest-festival regional variants. Tribal and Northeast festivals (Hornbill, Wangala, Chapchar Kut) and GI-tagged craft fairs also appear frequently. Knowing the four Kumbh Mela tirthas, Durga Puja\\u2019s 2021 UNESCO inscription, and Garba\\u2019s 2023 inscription gives a direct scoring edge.",
  period: "Art & Culture",
  keyDates: [
    {
      year: "c. 400 CE",
      event: "Earliest references to Kumbh Mela in the writings of Xuanzang (7th century) and puranic literature; tradition traced to the churning of the ocean (Samudra Manthan) myth",
    },
    {
      year: "1699",
      event: "Guru Gobind Singh founded the Khalsa at Anandpur Sahib on Baisakhi day (April 13) — Baisakhi becomes the most important Sikh festival",
    },
    {
      year: "1893",
      event: "Lokmanya Bal Gangadhar Tilak transformed Ganesh Chaturthi into a public community festival in Pune to foster national unity and bypass the colonial ban on political gatherings",
    },
    {
      year: "1894",
      event: "Pushkar Camel Fair formalized as an annual event in Rajasthan — one of the world's largest camel and livestock fairs; coincides with Kartik Purnima",
    },
    {
      year: "2000",
      event: "Hornbill Festival launched in Nagaland (December 1-10) — 'Festival of Festivals' showcasing Naga tribal culture; held at Kisama Heritage Village near Kohima",
    },
    {
      year: "2001",
      event: "Kutiyattam (Kerala temple theatre) becomes UNESCO's first Masterpiece of Oral and Intangible Heritage — predates the ICH Convention; performed during temple festivals",
    },
    {
      year: "2008",
      event: "Ramlila (traditional performance of the Ramayana) inscribed as UNESCO ICH; Ramnagar Ramlila (Varanasi) spans 31 days across a 10 sq km area",
    },
    {
      year: "2009",
      event: "Navroz (Parsi/Zoroastrian New Year) inscribed as UNESCO ICH — shared heritage of multiple countries; Mysuru Dasara declared Karnataka's 'Nadahabba' (state festival)",
    },
    {
      year: "2014",
      event: "Rann Utsav (Rann of Kutch Festival) becomes internationally known — white desert moonlight festival in Gujarat; promotes handicrafts and folk arts",
    },
    {
      year: "2017",
      event: "Kumbh Mela inscribed as UNESCO Intangible Cultural Heritage of Humanity — recognized as the world's largest peaceful gathering of pilgrims",
    },
    {
      year: "2021",
      event: "Durga Puja of Kolkata inscribed as UNESCO Intangible Cultural Heritage of Humanity — recognizes the artistic and communal significance of the festival",
    },
    {
      year: "2023",
      event: "Garba dance of Gujarat inscribed as UNESCO ICH — traditional circular dance performed during Navaratri; India's 15th entry on the ICH list",
    },
  ],
  notes: [
    {
      section: "Kumbh Mela — The World's Largest Gathering",
      content:
        "The Kumbh Mela draws tens of millions of pilgrims to four sacred river confluences on a 12-year cycle: Prayagraj (Triveni Sangam \\u2014 Ganga, Yamuna, mythical Saraswati; Maha Kumbh every 12 years), Haridwar (Ganga), Ujjain (Shipra), and Nashik-Trimbakeshwar (Godavari). Mythology traces the festival to the Samudra Manthan: drops of amrita (nectar) fell at these four sites during a celestial chase. Pilgrims perform ritual bathing on astrologically fixed dates (Shahi Snan), and 13 recognized Akharas \\u2014 including Juna, Niranjani, and Mahanirvani for Shaivites and Digambar and Nirmohi for Vaishnavites \\u2014 lead processions. The 2019 Prayagraj Kumbh attracted roughly 240 million visitors over 49 days. UNESCO inscribed the Kumbh Mela as Intangible Cultural Heritage of Humanity in 2017. Naga Sadhus leading the Shahi Snan remain the festival\\u2019s most iconic image.",
    },
    {
      section: "Hindu Festivals — Pan-Indian Celebrations",
      content:
        "Diwali (Deepavali) falls on Kartik Amavasya (October-November) and spans five days: Dhanteras, Naraka Chaturdashi, Diwali, Govardhan Puja, and Bhai Dooj. Holi, celebrated on Phalgun Purnima (March), draws on the Krishna-Radha legend and Holika-Prahlad mythology; Lathmar Holi (Barsana, UP) and Rang Panchami (Maharashtra) are regional variations. Navaratri/Durga Puja honours Goddess Durga over nine nights: Kolkata\\u2019s Durga Puja earned UNESCO ICH status in 2021, Gujarat\\u2019s Garba earned it in 2023, and Karnataka celebrates Mysuru Dasara with the Jumbo Savari elephant procession. Makar Sankranti (January 14) marks the harvest \\u2014 Pongal (Tamil Nadu, 4-day), Bihu (Assam, three Bihus: Bohag/spring, Kati/autumn, Magh/harvest), Lohri (Punjab), and Uttarayan (Gujarat kite festival) are its regional variants. Ganesh Chaturthi runs for 10 days; Tilak converted it into a public festival in 1893 to build national unity.",
    },
    {
      section: "Islamic, Christian & Sikh Festivals",
      content:
        "Islamic festivals include Eid-ul-Fitr (end of Ramadan), Eid-ul-Adha/Bakrid (Festival of Sacrifice commemorating Ibrahim\\u2019s willingness to sacrifice Ismail), Muharram (Tazia processions in Lucknow mourn Imam Hussain\\u2019s martyrdom at Karbala), Milad-un-Nabi (Prophet Muhammad\\u2019s birthday), and Shab-e-Barat (night of forgiveness). Christian festivals centre on Christmas (December 25), Easter, and Good Friday; Goa\\u2019s Portuguese-influenced Christmas, Kerala\\u2019s Syrian Christian Midnight Mass, and the Feast of St. Francis Xavier stand out. Sikh Gurpurabs mark Guru birth/death anniversaries \\u2014 Guru Nanak Jayanti (Kartik Purnima), Guru Gobind Singh Jayanti (January), Baisakhi (April 13/14, founding of the Khalsa at Anandpur Sahib in 1699 and rabi harvest), and Lohri (January 13 bonfire, Punjab). Hola Mohalla (day after Holi, Anandpur Sahib) is a Sikh martial arts festival started by Guru Gobind Singh, featuring mock battles, kirtan, and langar.",
    },
    {
      section: "Buddhist, Jain & Parsi Festivals",
      content:
    ...
    {
      section: "Tribal & Northeast Festivals",
      content:
    ...
    {
      section: "Fairs — Pushkar, Sonepur, Tarnetar & Others",
      content:
    ...
    {
      section: "Harvest Festivals Across India",
      content:
    ...
    {
      section: "UNESCO-Recognized Festivals & Cultural Heritage Forms",
      content:
    ...
    {
      section: "Secular & National Festivals",
      content:
    ...
    {
      section: "Unique & Regional Festivals",
      content:
    ...
    {
      section: "GI-Tagged Crafts & Fairs Connection",
      content:
    ...
    {
      section: "Festivals as Political & Social Instruments",
      content:
    ...
    {
      section: "Calendar Systems & Festival Dates",
      content:
  ...
  examTags: ["UPSC Prelims", "UPSC Mains", "SSC CGL", "SSC CHSL", "RRB NTPC", "CDS", "NDA", "State PSCs"],
  examRelevance:
