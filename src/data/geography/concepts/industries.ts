...
export const industriesConcept: SubjectConcept = {
  ...
  description:
    'India\'s industrial sector contributes about 26% to GDP across a diversified base spanning iron & steel, textiles, IT, pharmaceuticals, and automobiles. UPSC tests industrial location factors (Weber\'s theory), steel plant-collaboration pairings, policy evolution (IPR 1956, LPG 1991, PLI), and environmental impacts. SSC/RRB exams target "Manchester of India," "Silicon Valley," "Detroit of India," and first/largest industrial facts. Make in India, PLI schemes, and semiconductor mission drive current affairs questions.',
  ...
  notes: [
    {
      ...
      content:
        'Five classification bases matter for exams. (1) By Raw Material: Agro-based (cotton textiles, jute, sugar, tea), Mineral-based (iron & steel, cement, aluminium), Forest-based (paper, plywood, lac), Marine-based (fish processing, seafood export). (2) By Investment Size: Large-scale (>10 crore — steel, automobiles, petroleum refining), Medium (5-10 crore), Small-scale (<5 crore), Cottage/Household (khadi, handloom, handicrafts). (3) By Ownership: Public Sector (SAIL, BHEL, ONGC, HAL), Private (Tata Steel, Reliance, Infosys), Joint Sector, Cooperative (Amul/GCMMF, sugar cooperatives). (4) By Products: Heavy/Basic (iron & steel, heavy engineering), Consumer/Light (textiles, food processing), Capital Goods (machinery), Intermediate (chemicals, petroleum products). (5) By Weber\'s Location Theory: Weight-losing industries (Material Index > 1) locate near raw materials — steel, sugar, cement; weight-gaining industries (MI < 1) locate near markets — soft drinks, bakery; footloose industries locate anywhere — IT, electronics.',
    },
    {
      section: 'Iron & Steel Industry',
      content:
        'India produces about 125 million tonnes of crude steel annually, ranking 2nd globally after China. Public Sector plants under SAIL: Bhilai (Chhattisgarh — Russian collaboration, largest public sector plant, produces rails for Indian Railways), Rourkela (Odisha — German collaboration, first LD process in Asia), Durgapur (West Bengal — British collaboration), Bokaro (Jharkhand — Russian collaboration, largest by capacity), Salem (Tamil Nadu — stainless steel), Visakhapatnam (AP — shore-based). IISCO at Burnpur, WB (oldest integrated plant, 1918, now under SAIL). Private sector: TISCO/Tata Steel at Jamshedpur (1907, India\'s first integrated steel plant), JSW Steel (Vijayanagar, Bellary, Karnataka — largest private producer), JSPL (Raigarh, Chhattisgarh), Essar Steel (Hazira, Gujarat — now ArcelorMittal Nippon). Plants cluster near iron ore (Odisha, Jharkhand) and coking coal (Jharkhand, WB) in the Chota Nagpur Plateau steel belt. National Steel Policy 2017 targets 300 MT capacity by 2030. Per capita consumption (~75 kg) remains well below the global average (~230 kg).',
    },
    {
