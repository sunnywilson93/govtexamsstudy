...
export const biodiversityConcept: SubjectConcept = {
  topic: 'biodiversity',
  ...
  keyDates: [
    ...
    { year: '4 Hotspots', event: 'Western Ghats, Eastern Himalayas, Indo-Burma, Sundaland (Nicobar Islands)' },
    { year: '1936', event: 'Hailey National Park (now Jim Corbett) established — India\'s first National Park' },
    { year: '1972', event: 'Wildlife Protection Act — framework for protecting wild animals and plants' },
    { year: '1986', event: 'Nilgiri declared India\'s first Biosphere Reserve under UNESCO MAB Programme' },
    { year: '1992', event: 'India signs Convention on Biological Diversity (CBD) at Rio Earth Summit' },
    { year: '2002', event: 'Biological Diversity Act enacted by Indian Parliament; NBA established in Chennai' },
    { year: '2009', event: 'Gangetic River Dolphin declared India\'s National Aquatic Animal' },
    { year: '106 NPs', event: 'India has 106 National Parks and 567 Wildlife Sanctuaries (as of 2023)' },
    { year: 'Endemism', event: 'About 33% of Indian flora is endemic — found nowhere else in the world' },
    { year: 'IUCN India', event: 'India has 172+ species categorized as Critically Endangered by IUCN' },
    { year: '10 Zones', event: 'India divided into 10 biogeographic zones (Rodgers & Panwar classification)' },
    { year: '2022', event: 'India\'s tiger population reported at 3,682 in 4th All India Tiger Estimation' },
    { year: '2023', event: 'India surpasses 75 Ramsar wetland sites; many more added through 2024' },
    { year: 'Genetic', event: 'India is a Vavilov Centre of origin for rice, mango, citrus, sugarcane, pepper, turmeric' },
  ],
  notes: [
    {
    ...
    {
      section: 'Endemic & Threatened Species',
      content:
    ...
    {
      section: 'Biodiversity Conservation Framework',
      content:
    ...
    {
      section: 'Three Levels of Biodiversity',
      content:
    ...
    {
      section: 'Patterns of Biodiversity Distribution',
      content:
    ...
    {
      section: 'Forest Types and Biodiversity',
      content:
    ...
    {
      section: 'Grassland and Savanna Ecosystems',
      content:
    ...
    {
      section: 'Invasive Alien Species',
      content:
    ...
    {
      section: 'Traditional Knowledge and Biodiversity',
      content:
    ...
    {
      section: 'Biodiversity Monitoring and Assessment',
      content:
