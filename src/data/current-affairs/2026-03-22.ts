...
export const digest20260322: DailyDigest = {
  date: '2026-03-22',
  items: [
    {
      id: '2026-03-22-01',
      headline: 'RBI Releases Draft Framework for Unified Lending Interface 2.0',
      summary:
    ...
    {
      id: '2026-03-22-02',
      headline: 'Cabinet Approves National Forest Policy Amendment to Include Agroforestry',
      summary:
    ...
    {
      id: '2026-03-22-03',
      headline: 'DRDO Successfully Tests Hypersonic Cruise Missile from Integrated Test Range',
      summary:
    ...
    {
      id: '2026-03-22-04',
      headline: 'India Signs Digital Trade Agreement with ASEAN under Revised FTA Framework',
      summary:
    ...
    {
      id: '2026-03-22-05',
      headline: 'Election Commission Launches Voter Awareness Campaign — SVEEP 2026',
      summary:
    ...
    {
      id: '2026-03-22-06',
      headline: 'ISRO Launches NovaSAR-3 Earth Observation Satellite in SSO',
      summary:
    ...
    {
      id: '2026-03-22-07',
      headline: 'Ministry of Labour Notifies Revised Wage Ceiling under Employees\' Provident Fund',
      summary:
    ...
    {
      id: '2026-03-22-08',
      headline: 'India\'s Western Ghats Added to UNESCO World Heritage Tentative List Extension',
      summary:
    ...
    {
      id: '2026-03-22-09',
      headline: 'President Appoints Justice Arun Bharadwaj as 52nd Chief Justice of India',
      summary:
    ...
    {
      id: '2026-03-22-10',
      headline: 'Archaeological Survey of India Discovers Iron-Age Settlement at Keezhadi Phase VIII',
      summary:
