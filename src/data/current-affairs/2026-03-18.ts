...
export const digest20260318: DailyDigest = {
  date: '2026-03-18',
  items: [
    {
      id: '2026-03-18-01',
      headline: 'Finance Ministry Tables Interim Fiscal Consolidation Roadmap for FY27–FY30',
      summary:
    ...
    {
      id: '2026-03-18-02',
      headline: 'Supreme Court Delivers Landmark Ruling on Article 370 Abrogation Challenge',
      summary:
    ...
    {
      id: '2026-03-18-03',
      headline: 'DRDO and IIT Madras Develop Indigenous Carbon Fibre for Aerospace Applications',
      summary:
    ...
    {
      id: '2026-03-18-04',
      headline: 'India Launches Mission LiFE Phase II — Lifestyle for Environment Campaign',
      summary:
    ...
    {
      id: '2026-03-18-05',
      headline: 'INS Vikrant Completes First Overseas Deployment to Gulf of Aden',
      summary:
    ...
    {
      id: '2026-03-18-06',
      headline: 'India and EU Conclude Seventh Round of FTA Negotiations',
      summary:
    ...
    {
      id: '2026-03-18-07',
      headline: 'National Commission for Scheduled Tribes Recommends Including Meitei in ST List',
      summary:
    ...
    {
      id: '2026-03-18-08',
      headline: 'Glacial Lake Outburst Flood Risk Assessment Completed for Uttarakhand and Sikkim',
      summary:
    ...
    {
      id: '2026-03-18-09',
      headline: 'PM Awas Yojana Grameen Surpasses 3.5 Crore House Completion Target',
      summary:
    ...
    {
      id: '2026-03-18-10',
      headline: 'Smt. Preeti Sudan Appointed Chairperson of Union Public Service Commission',
      summary:
