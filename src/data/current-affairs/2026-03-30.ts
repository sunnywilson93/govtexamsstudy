...
export const digest20260330: DailyDigest = {
  date: '2026-03-30',
  items: [
    {
      id: '2026-03-30-01',
      headline: 'Reserve Bank of India Keeps Repo Rate Unchanged at 6.25% in MPC Meet',
      summary:
    ...
    {
      id: '2026-03-30-02',
      headline: 'Supreme Court Constitution Bench Delivers Verdict on Sub-Classification within SC/ST',
      summary:
    ...
    {
      id: '2026-03-30-03',
      headline: 'India\'s First Dark Sky Reserve Inaugurated at Hanle, Ladakh',
      summary:
    ...
    {
      id: '2026-03-30-04',
      headline: 'India Signs Trade in Services Agreement with Gulf Cooperation Council',
      summary:
    ...
    {
      id: '2026-03-30-05',
      headline: 'INS Nilgiri Commissioned as Lead Ship of Project-17A Frigates',
      summary:
    ...
    {
      id: '2026-03-30-06',
      headline: 'Western Ghats Receives 13 New Eco-Sensitive Zone Notifications',
      summary:
    ...
    {
      id: '2026-03-30-07',
      headline: 'PM Jan Dhan Yojana Crosses 55 Crore Account Milestone',
      summary:
    ...
    {
      id: '2026-03-30-08',
      headline: 'Brahmaputra River Declared as India\'s First Riverine Ramsar Site',
      summary:
    ...
    {
      id: '2026-03-30-09',
      headline: 'Numismatic Exhibition on Chola Bronze Icons Opens at National Museum',
      summary:
    ...
    {
      id: '2026-03-30-10',
      headline: 'Dr. Sanjay Malhotra Completes First 100 Days as RBI Governor',
      summary:
