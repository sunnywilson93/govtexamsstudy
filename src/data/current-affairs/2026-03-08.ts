...
export const digest20260308: DailyDigest = {
  date: '2026-03-08',
  items: [
    {
      id: '2026-03-08-01',
      headline: 'International Women\'s Day: Government Launches Mission Shakti 2.0 with ₹25,000 Crore Budget',
      summary:
      ...
      category: 'schemes',
      sourceUrl: 'https://wcd.nic.in/pressrelease',
      sourceName: 'Ministry of Women and Child Development',
      examRelevance: 'Prelims: Schemes – Mission Shakti, Women Empowerment | Mains: GS2 – Social Justice; GS1 – Society',
    },
    {
      id: '2026-03-08-02',
      headline: 'RBI Launches UPI Lite X for Offline Near-Field Communication Payments',
      summary:
      ...
      category: 'economics',
      sourceUrl: 'https://rbi.org.in/Scripts/BS_PressReleaseDisplayNew.aspx',
      sourceName: 'Reserve Bank of India',
      examRelevance: 'Prelims: Economy – UPI, Digital Payments, Financial Inclusion | Mains: GS3 – Fintech, Economy',
    },
    {
      id: '2026-03-08-03',
      headline: 'India and United Kingdom Sign Comprehensive Strategic Partnership Agreement',
      summary:
      ...
      examRelevance: 'Prelims: International – India-UK, FTA | Mains: GS2 – India\'s Foreign Policy',
    },
    {
      id: '2026-03-08-04',
      headline: 'NITI Aayog Releases India Innovation Index 2025: Karnataka Retains Top Position',
      summary:
      ...
      category: 'economics',
      sourceUrl: 'https://niti.gov.in/pressreleases',
      sourceName: 'NITI Aayog',
      examRelevance: 'Prelims: Economy – Innovation Index, NITI Aayog | Mains: GS3 – Technology, Economy',
    },
    {
      id: '2026-03-08-05',
      headline: 'Ministry of Coal Reports Total Coking Coal Production Crosses 75 Million Tonnes in FY26',
      summary:
      ...
      category: 'economics',
      sourceUrl: 'https://coal.nic.in/content/press-releases',
      sourceName: 'Ministry of Coal',
      examRelevance: 'Prelims: Economy – Coal, Steel, Minerals | Mains: GS3 – Industry, Natural Resources',
    },
    {
      id: '2026-03-08-06',
      headline: 'CPCB Issues Revised Ambient Air Quality Standards for PM1 and Ultrafine Particles',
      summary:
      ...
      sourceUrl: 'https://cpcb.nic.in/press-release',
      sourceName: 'Central Pollution Control Board',
      examRelevance: 'Prelims: Environment – Air Quality, CPCB | Mains: GS3 – Environment, Pollution',
    },
    {
      id: '2026-03-08-07',
      headline: 'Parliament\'s Public Accounts Committee Submits Report on MGNREGS Expenditure Efficiency',
      summary:
      ...
      examRelevance: 'Prelims: Polity – PAC, Parliamentary Committees | Mains: GS2 – Parliament, MGNREGS',
    },
    {
      id: '2026-03-08-08',
      headline: 'India Discovers Major Lithium Deposits in Rajasthan\'s Barmer District',
      summary:
      ...
      category: 'geography',
      sourceUrl: 'https://gsi.gov.in/wps/portal/OIGSI/gsi',
      sourceName: 'Geological Survey of India',
      examRelevance: 'Prelims: Geography – Minerals, Lithium | Mains: GS1 – Economic Geography; GS3 – Energy, EV',
    },
    {
      id: '2026-03-08-09',
      headline: 'Appointment: Dr. Sanjay Malhotra Reappointed as RBI Governor for Second Term',
      summary:
      ...
      sourceUrl: 'https://rbi.org.in/Scripts/BS_PressReleaseDisplayNew.aspx',
      sourceName: 'Reserve Bank of India',
      examRelevance: 'Prelims: Appointments – RBI Governor | Mains: GS3 – Monetary Policy',
    },
    {
      id: '2026-03-08-10',
      headline: 'National Commission for Backward Classes Recommends OBC Sub-Categorisation Framework',
      summary:
      ...
      category: 'polity',
      sourceUrl: 'https://ncbc.nic.in',
      sourceName: 'National Commission for Backward Classes',
      examRelevance: 'Prelims: Polity – OBC, Reservation, NCBC | Mains: GS2 – Social Justice',
    },
  ],
}
