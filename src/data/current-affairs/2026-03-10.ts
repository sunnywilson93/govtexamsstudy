...
export const digest20260310: DailyDigest = {
  date: '2026-03-10',
  items: [
    {
      id: '2026-03-10-01',
      headline: 'India\'s Wholesale Price Index Inflation Falls to 1.8% in February 2026',
      summary:
    ...
    {
      id: '2026-03-10-02',
      headline: 'India Launches Polar Satellite Launch Vehicle PSLV-C61 Carrying EOS-09 Earth Observation Satellite',
      summary:
    ...
    {
      id: '2026-03-10-03',
      headline: 'India Ratifies Minamata Convention on Mercury with Updated National Action Plan',
      summary:
    ...
    {
      id: '2026-03-10-04',
      headline: 'India and France Sign Agreement to Co-Produce 26 Rafale Marine Fighters for Indian Navy',
      summary:
    ...
    {
      id: '2026-03-10-05',
      headline: 'Delimitation Commission Releases Draft Report for 5 States Including J&K and Assam',
      summary:
    ...
    {
      id: '2026-03-10-06',
      headline: 'UIDAI Reports Aadhaar Authentication Crosses 100 Billion Transactions Milestone',
      summary:
    ...
    {
      id: '2026-03-10-07',
      headline: 'Archaeological Survey of India Unearths 2,200-Year-Old Mauryan Township in Odisha',
      summary:
    ...
    {
      id: '2026-03-10-08',
      headline: 'India and SCO Sign Digital Connectivity Protocol for Secure Cross-Border Data Exchange',
      summary:
    ...
    {
      id: '2026-03-10-09',
      headline: 'National Commission for Scheduled Castes Recommends Inclusion of 3 New Communities in SC List',
      summary:
    ...
    {
      id: '2026-03-10-10',
      headline: 'Cyclone Preparedness: Odisha Receives BIS Certification for World\'s First Zero-Casualty Evacuation Model',
      summary:
