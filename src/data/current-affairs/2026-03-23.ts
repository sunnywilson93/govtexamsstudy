...
export const digest20260323: DailyDigest = {
  date: '2026-03-23',
  items: [
    {
      id: '2026-03-23-01',
      headline: 'SEBI Mandates T+0 Settlement Across All NSE & BSE Stocks by April 2026',
      summary:
      ...
      category: 'economics',
      sourceUrl: 'https://sebi.gov.in/media/press-releases',
      sourceName: 'Securities and Exchange Board of India',
      examRelevance: 'Prelims: Economy – SEBI, Capital Markets, T+0 | Mains: GS3 – Capital Markets, Financial Regulation',
    },
    {
      id: '2026-03-23-02',
      headline: 'Bhagat Singh, Rajguru and Sukhdev — Shaheed Diwas Observed on March 23',
      summary:
      ...
      examRelevance: 'Prelims: History – Freedom Struggle, Revolutionary Movement | Mains: GS1 – Modern Indian History',
    },
    {
      id: '2026-03-23-03',
      headline: 'Cabinet Approves India\'s NDC Update Ahead of UNFCCC COP31',
      summary:
      ...
      examRelevance: 'Prelims: Environment – NDC, Paris Agreement, UNFCCC | Mains: GS3 – Climate Change, Environment',
    },
    {
      id: '2026-03-23-04',
      headline: 'GSAT-24 Satellite Launched by Ariane-6 Boosts Direct-to-Home TV Coverage',
      summary:
      ...
      sourceName: 'ISRO',
      examRelevance: 'Prelims: Science – ISRO, Communication Satellites | Mains: GS3 – Space Technology, Commercialisation',
    },
    {
      id: '2026-03-23-05',
      headline: 'India Becomes World\'s 4th Largest Economy by Nominal GDP: IMF Update',
      summary:
      ...
      sourceUrl: 'https://finmin.nic.in/mofsmedium/pressrelease',
      sourceName: 'Ministry of Finance',
      examRelevance: 'Prelims: International – IMF, GDP Rankings | Mains: GS2 – International Organisations; GS3 – Indian Economy',
    },
    {
      id: '2026-03-23-06',
      headline: 'Indian Coast Guard Commissions Fourth Advanced Offshore Patrol Vessel ICGS Saksham',
      summary:
      ...
      category: 'defence',
      sourceUrl: 'https://indiancoastguard.gov.in/content/1390/press-release',
      sourceName: 'Indian Coast Guard',
      examRelevance: 'Prelims: Defence – Coast Guard, Indigenisation | Mains: GS3 – Maritime Security, Make in India',
    },
    {
      id: '2026-03-23-07',
      headline: 'PM Vishwakarma Scheme Reaches 30 Lakh Artisans in 18 Months of Operation',
      summary:
      ...
      category: 'schemes',
      sourceUrl: 'https://pmvishwakarma.gov.in/Home/PressRelease',
      sourceName: 'Ministry of Micro, Small and Medium Enterprises',
      examRelevance: 'Prelims: Schemes – MSME, Artisans, Skill | Mains: GS3 – MSME, Employment; GS2 – Social Welfare',
    },
    {
      id: '2026-03-23-08',
      headline: 'Kaziranga National Park Records Highest-Ever One-Horned Rhino Population at 3,102',
      summary:
      ...
      sourceUrl: 'https://moef.gov.in/notifications/',
      sourceName: 'Ministry of Environment, Forest and Climate Change',
      examRelevance: 'Prelims: Geography – Kaziranga, Assam, Rhino | Mains: GS3 – Biodiversity Conservation; GS1 – Geography',
    },
    {
      id: '2026-03-23-09',
      headline: 'Cabinet Approves National Policy on Women 2026: Replaces 2001 Policy',
      summary:
      ...
      examRelevance: 'Prelims: Polity – Women\'s Policy, Governance | Mains: GS1 – Women; GS2 – Governance, Social Policy',
    },
    {
      id: '2026-03-23-10',
      headline: 'Smt. Soma Roy Burman Appointed as Comptroller and Auditor General of India',
      summary:
      ...
      sourceUrl: 'https://cag.gov.in/en/press-release',
      sourceName: 'Comptroller and Auditor General of India',
      examRelevance: 'Prelims: Appointments – CAG, Constitutional | Mains: GS2 – Constitutional Bodies, Accountability',
    },
  ],
}
