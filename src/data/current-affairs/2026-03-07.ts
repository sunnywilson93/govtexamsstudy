...
export const digest20260307: DailyDigest = {
  date: '2026-03-07',
  items: [
    {
      id: '2026-03-07-01',
      headline: 'India\'s GST Collection Crosses ₹2.5 Lakh Crore for the First Time in February 2026',
      summary:
      ...
      examRelevance: 'Prelims: Economy – GST, Indirect Taxes | Mains: GS3 – Fiscal Policy, Indian Economy',
    },
    {
      id: '2026-03-07-02',
      headline: 'ISRO\'s Aditya-L1 Solar Observatory Releases First Peer-Reviewed Findings on Solar Flares',
      summary:
      ...
      examRelevance: 'Prelims: Science – Aditya-L1, Solar Missions | Mains: GS3 – Space Technology',
    },
    {
      id: '2026-03-07-03',
      headline: 'India Assumes Presidency of International Solar Alliance for Third Consecutive Term',
      summary:
      ...
      examRelevance: 'Prelims: International – ISA, Solar Energy | Mains: GS2 – International Bodies; GS3 – Energy',
    },
    {
      id: '2026-03-07-04',
      headline: 'Supreme Court Rules Live-In Relationships Entitled to Domestic Violence Protection',
      summary:
      ...
      examRelevance: 'Prelims: Polity – Fundamental Rights, Judiciary | Mains: GS2 – Social Justice; GS1 – Society',
    },
    {
      id: '2026-03-07-05',
      headline: 'Ministry of Environment Releases Draft Ecomark Regulations 2026 for Public Consultation',
      summary:
      ...
      examRelevance: 'Prelims: Environment – Ecomark, Labelling | Mains: GS3 – Environment, Consumer Policy',
    },
    {
      id: '2026-03-07-06',
      headline: 'India Commissions BrahMos NG (Next Generation) for IAF\'s Tejas MK-2 Integration',
      summary:
      ...
      sourceUrl: 'https://pib.gov.in',
      sourceName: 'Press Information Bureau',
      examRelevance: 'Prelims: Defence – BrahMos, IAF, Indigenisation | Mains: GS3 – Defence Technology',
    },
    {
      id: '2026-03-07-07',
      headline: 'NITI Aayog SDG India Index 2025: India\'s National Score Improves to 72',
      summary:
      ...
      examRelevance: 'Prelims: Economy – SDG, NITI Aayog | Mains: GS3 – Development, Sustainable Goals',
    },
    {
      id: '2026-03-07-08',
      headline: 'Ladakh Wetlands Gain Ramsar Site Status: Tsomoriri and Pangong Now Protected',
      summary:
      ...
      sourceUrl: 'https://moef.gov.in',
      sourceName: 'Ministry of Environment, Forest and Climate Change',
      examRelevance: 'Prelims: Geography – Ladakh, Ramsar, Wetlands | Mains: GS1 – Indian Geography; GS3 – Environment',
    },
    {
      id: '2026-03-07-09',
      headline: 'Ministry of Culture Launches Digital Archiving of 50,000 Manuscripts Under NAMAMI Mission',
      summary:
      ...
      sourceUrl: 'https://pib.gov.in',
      sourceName: 'Press Information Bureau',
      examRelevance: 'Prelims: History – Culture, Manuscripts, NMM | Mains: GS1 – Indian Culture; GS2 – Governance',
    },
    {
      id: '2026-03-07-10',
      headline: 'Appointment: Justice K. V. Viswanathan Elevated as Chief Justice of India',
      summary:
      ...
      sourceUrl: 'https://pib.gov.in',
      sourceName: 'Press Information Bureau',
      examRelevance: 'Prelims: Appointments – CJI, Supreme Court | Mains: GS2 – Judiciary',
    },
  ],
}
