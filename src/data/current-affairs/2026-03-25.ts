...
export const digest20260325: DailyDigest = {
  date: '2026-03-25',
  items: [
    {
      id: '2026-03-25-01',
      headline: 'India\'s Direct Tax Collections Exceed ₹22 Lakh Crore in FY2025-26',
      summary:
      ...
      category: 'economics',
      sourceUrl: 'https://incometaxindia.gov.in/Pages/press-releases.aspx',
      sourceName: 'Income Tax Department',
      examRelevance: 'Prelims: Economy – Direct Taxes, CBDT | Mains: GS3 – Fiscal Policy, Taxation',
    },
    {
      id: '2026-03-25-02',
      headline: 'Cabinet Approves New Ports, Shipping & Waterways Bill 2025 Replacing Outdated Colonial Laws',
      summary:
      ...
      examRelevance: 'Prelims: Polity – Legislation, Maritime Law | Mains: GS3 – Ports, Waterways, Infrastructure',
    },
    {
      id: '2026-03-25-03',
      headline: 'CSIR Develops Bio-Degradable Thermal Insulation Using Jute Nanofibers',
      summary:
      ...
      category: 'science',
      sourceUrl: 'https://www.csir.res.in/news',
      sourceName: 'Council of Scientific and Industrial Research',
      examRelevance: 'Prelims: Science – Materials Science, CSIR | Mains: GS3 – Science & Technology, Agriculture',
    },
    {
      id: '2026-03-25-04',
      headline: 'India and African Union Sign Framework Agreement on Climate-Resilient Agriculture',
      summary:
      ...
      sourceUrl: 'https://icar.gov.in/index.php/press-releases',
      sourceName: 'Indian Council of Agricultural Research',
      examRelevance: 'Prelims: International – India-Africa, Climate | Mains: GS2 – India\'s Foreign Policy; GS3 – Agriculture',
    },
    {
      id: '2026-03-25-05',
      headline: 'Army Successfully Tests Loitering Munition System "Nagastra-II" in High Altitude',
      summary:
      ...
      sourceUrl: 'https://pib.gov.in/PressReleasePage.aspx',
      sourceName: 'Press Information Bureau',
      examRelevance: 'Prelims: Defence – Drones, Make in India | Mains: GS3 – Internal Security, Defence Technology',
    },
    {
      id: '2026-03-25-06',
      headline: 'Holi Festival and India\'s Water Stress: Central Ground Water Board Issues Advisory',
      summary:
      ...
      sourceUrl: 'https://cgwb.gov.in/CGWB/index.html',
      sourceName: 'Central Ground Water Board',
      examRelevance: 'Prelims: Environment – Groundwater, Water Conservation | Mains: GS3 – Water Resources',
    },
    {
      id: '2026-03-25-07',
      headline: 'UIDAI Issues 140 Crore Aadhaar Numbers; Mobile Seeding Reaches 93%',
      summary:
      ...
      category: 'schemes',
      sourceUrl: 'https://uidai.gov.in/1/media/1/news',
      sourceName: 'Unique Identification Authority of India',
      examRelevance: 'Prelims: Schemes – Aadhaar, Digital Identity | Mains: GS2 – Governance, e-Governance; GS3 – Technology',
    },
    {
      id: '2026-03-25-08',
      headline: 'Survey Finds Sundarban Mangroves Have Grown by 4.4% Since 2019: FSI Report',
      summary:
      ...
      category: 'geography',
      sourceUrl: 'https://fsi.nic.in/forest-report-2025',
      sourceName: 'Forest Survey of India',
      examRelevance: 'Prelims: Geography – Sundarbans, Mangroves | Mains: GS1 – Physical Geography; GS3 – Biodiversity',
    },
    {
      id: '2026-03-25-09',
      headline: 'India Completes Repatriation of 297 Antique Objects from USA Under Project Pari',
      summary:
      ...
      examRelevance: 'Prelims: History – Cultural Heritage, Antiquities | Mains: GS1 – Indian Heritage; GS2 – International Agreements',
    },
    {
      id: '2026-03-25-10',
      headline: 'Padma Awards 2026 Announced; 139 Awardees Including 7 Padma Vibhushan',
      summary:
      ...
      sourceUrl: 'https://mha.gov.in/en/commoncontent/padma-awards',
      sourceName: 'Ministry of Home Affairs',
      examRelevance: 'Prelims: Awards – Padma, National Honours | Mains: GS1 – Art & Culture; GS2 – Governance',
    },
  ],
}
