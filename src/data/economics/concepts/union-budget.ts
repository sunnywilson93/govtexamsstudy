...
export const unionBudgetConcept: SubjectConcept = {
  ...
  description:
    'Article 112 requires the President to lay the Annual Financial Statement (Union Budget) before Parliament. No money can leave the Consolidated Fund of India without Parliament passing an Appropriation Act under Article 113. The budget tracks three funds: CFI, Public Account, and Contingency Fund (Rs 500 crore at the President\'s disposal). Exams test the fiscal deficit vs revenue deficit vs primary deficit formulae, how the FRBM escape clause enabled 9.2% fiscal deficit during COVID, and the near-tripling of capital expenditure from Rs 4.39 lakh crore in FY21 to Rs 11.11 lakh crore in FY25. Master Demands for Grants and the Guillotine mechanism, the Finance Bill vs Money Bill distinction under Article 110, and the 2017 reforms that merged the Railway Budget and abolished Plan/Non-Plan classification.',
  ...
  notes: [
    {
      ...
      content:
        'Article 112 directs the President to lay before Parliament an Annual Financial Statement showing estimated receipts and expenditure. Article 113 bars any withdrawal from the Consolidated Fund of India without Parliament\'s approval through an Appropriation Bill. Article 114 prescribes the Appropriation Bill procedure. Article 115 authorises Supplementary and Excess Grants. Article 116 enables Votes on Account, Votes of Credit, and Exceptional Grants. Article 265 prohibits any tax levy or collection except by authority of law. Article 266 establishes the Consolidated Fund of India and the Public Account. Article 267 creates the Contingency Fund of India at Rs 500 crore, placed at the President\'s disposal for urgent unforeseen expenditure. Three funds underpin government finances. The CFI receives all revenues and loans. The Public Account holds deposits and provident funds — Parliament does not vote on it. The Contingency Fund covers emergencies pending parliamentary authorisation.',
    },
    {
      section: 'Budget Structure — Revenue & Capital',
      content:
        'The Revenue Account captures day-to-day income and spending. Revenue Receipts combine Tax Revenue (income tax, corporation tax, GST, customs, excise) with Non-Tax Revenue (PSU dividends, interest receipts, spectrum auction fees, RBI surplus). Revenue Expenditure covers salaries, pensions, interest payments, subsidies, and grants to states. Revenue Deficit equals Revenue Expenditure minus Revenue Receipts. A positive number signals the government is borrowing to fund consumption. The Capital Account tracks asset creation and long-term borrowing. Capital Receipts include market loans, external debt, disinvestment proceeds, and loan recoveries. Capital Expenditure builds assets (roads, bridges, defence equipment) and provides loans to states and PSUs. Fiscal Deficit equals Total Expenditure minus Total Receipts excluding borrowings. It measures the government\'s total annual borrowing requirement. Primary Deficit equals Fiscal Deficit minus Interest Payments. It isolates borrowing needed for current spending from inherited debt servicing.',
    },
    {
